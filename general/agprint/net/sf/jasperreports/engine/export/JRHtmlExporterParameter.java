...
public class JRHtmlExporterParameter extends JRExporterParameter
{
	 ...
	 * save to db
	 */
	public static final JRHtmlExporterParameter IS_OUTPUT_IMAGES_TO_DB = new JRHtmlExporterParameter("Is Output Images to DB Flag");

	public static final JRHtmlExporterParameter WEB_BASE_URL_PATH = new JRHtmlExporterParameter("Web base uri path");
	 ...
	 * wrap before page 
	 */
	public static final JRHtmlExporterParameter WRAP_BEFORE_PAGE_HTML = new JRHtmlExporterParameter("Wrap Before Page HTML");
	/**
	 * wrap after page 
	 */
	public static final JRHtmlExporterParameter WRAP_AFTER_PAGE_HTML = new JRHtmlExporterParameter("Wrap After Page HTML");
	/**修改结束**/
