 ...
 * @version $Id: JRHtmlExporter.java 6967 2014-03-11 17:19:59Z teodord $
 */
			...
			if (pages != null && pages.size() > 0)
			{
				...
				for(pageIndex = startPageIndex; pageIndex <= endPageIndex; pageIndex++)
				{
					...
					if(null!=wrapBeforePageHtml && !"".equals(wrapBeforePageHtml)){
						...
						String agprintParamsDatahtml = getPropertiesUtil().getProperty("agprint_params_datahtml");
						if(null!=agprintParamsDatahtml && !"".equals(agprintParamsDatahtml.trim())){
							if(agprintParamsDatahtml.contains("\"")){
								agprintParamsDatahtml=agprintParamsDatahtml.replaceAll("\"", "\\\"");
							}
							writer.write("<input type=\"hidden\" myattr=\"agprintparamsdatahtml\" jsondata=\""+agprintParamsDatahtml+"\" />");
						}

						writer.write("<input type=\"hidden\" myattr=\"showprintpage\" current=\""+(startPageIndex+1)+"\" total=\""+endPageIndex+"\" />");
