 ...
 * @author panxiaoxiao
 */
public class RealBuySaleReportDayResetJob extends BaseJob{
    @Override
    protected void executeInternal(JobExecutionContext jobExecutionContext)
        ...
        try {
            ...
            flag = storageReportService.clearResetRealBuySaleReportData(today);

        } catch (Exception e) {
            logger.error("定时器执行异常 每日进销存数据清空重新生成失败", e);
        }
