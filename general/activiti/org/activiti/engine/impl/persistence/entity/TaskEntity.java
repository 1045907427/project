...
//    }
  ...
  public void complete(String taskKey){
	  ...
	  boolean customDTask = (taskKey != null && !taskKey.equals(""));
	  String dtaskName = null;
	  try{
		  dtaskName = customDTask && execution != null ?(String)execution.getActivity().getProcessDefinition().findActivity(taskKey).getProperty("name"):null;
	  }catch (Exception e) {
	  ...
	  if(!customDTask){
		  ...
		  if(dtaskName != null){
			  deleteReason = "转到节点["+ dtaskName+ "-"+ taskKey+ "]";
		  }
		  else{
			  deleteReason = "转到节点["+ taskKey+ "]";
		  }
	  }
	  if(this.taskKey != null){
		  ...
		  if(taskName != null){
			  deleteReason = "[" +taskName +"-"+ this.taskKey+ "]" +deleteReason;
		  }
		  else{
			  deleteReason = "["+this.taskKey+ "]" +deleteReason;
		  }
	  }
	  Context
	  .getCommandContext()
	  ...
	  if(execution != null){
		  ...
		  if(taskKey == null || "".equals(taskKey)){
			  ...
			  execution.signal(null, null, taskKey);
		  }
	  }
  }
