...
public class TaskServiceImpl extends ServiceImpl implements TaskService {
  ...
  public void backTask(String taskid, Map<String, Object> variables) {
      ...
      String taskkey = processMapper.getPrevTaskKey(taskid);
      if(taskkey == null) {
          throw new ActivitiException("驳回任务失败：taskid="+taskid +" 之前的任务不存在.");
      }
      this.complete(taskid, variables, taskkey);
  }

  public void backTask(String taskId) {
	backTask(taskId, (Map<String, Object>)null);
  }
   ...
   * @date Oct 30, 2013
   */
  public void complete(String taskId, Map<String, Object> variables, String taskDefinitionKey) {
	  commandExecutor.execute(new CompleteTaskCmd(taskId, variables, taskDefinitionKey));
  }
