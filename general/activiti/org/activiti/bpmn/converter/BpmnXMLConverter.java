...
protected boolean didWriteExtensionStartElement = false;
  ...
  private static void addConverter(String elementName, Class<? extends BaseElement> elementClass, 
    ...
    try {
      ...
      try {
    	  List<ActivitiListener> listenerList = process.getExecutionListeners();
    	    ...
    	    if (listenerList != null) {
    	      ...
    	      for (ActivitiListener listener : listenerList) {
    	        ...
    	        if (StringUtils.isNotEmpty(listener.getEvent())) {
    	          ...
    	          xtw.writeStartElement(ACTIVITI_EXTENSIONS_PREFIX, ELEMENT_EXECUTION_LISTENER, ACTIVITI_EXTENSIONS_NAMESPACE);
  ...
  private void writeDefaultAttribute(String attributeName, String value, XMLStreamWriter xtw) throws Exception {
