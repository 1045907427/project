...
public class CollectionOrder implements Serializable {
    ...
    public void setCollectiondept(String collectiondept) {
        this.collectiondept = collectiondept == null ? null : collectiondept.trim();
    }
	...
	public String getBankdeptname() {
		return bankdeptname;
	}

	public void setBankdeptname(String bankdeptname) {
		this.bankdeptname = bankdeptname;
	}
	 /**
     * @return 来源，默认0，1交款单
     */
