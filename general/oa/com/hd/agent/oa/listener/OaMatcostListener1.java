...
/**
 * 代垫费用申请单生成代垫费用（取工厂投入的合计金额）
 */
public class OaMatcostListener1 extends TaskListenerImpl {
    ...
    public void notify(DelegateTask task) throws Exception {
        ...
        int ret = payService.addMatcostByOaMatcost(matcost, list);
