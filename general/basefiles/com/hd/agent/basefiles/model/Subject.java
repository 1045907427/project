...
public class Subject implements Serializable {
     ...
     * 是否所属分类名
     */
    private String istypehead;
    /**
     * 是否所属分类名
     */
    private String istypeheadname;
    /**
     * 导入错误提示信息
     */
	...
	public String getIstypehead() {
		return istypehead;
	}

	public void setIstypehead(String istypehead) {
        this.istypehead = istypehead == null ? null : istypehead.trim();
	}
	...
	public void setLeafname(String leafname) {
        this.leafname = leafname == null ? null : leafname.trim();
	}

	public String getIstypeheadname() {
		return istypeheadname;
	}

	public void setIstypeheadname(String istypeheadname) {
        this.istypeheadname = istypeheadname == null ? null : istypeheadname.trim();
	}
