...
public class SaleMode implements Serializable {
	...
	public String getDetailDels() {
		return detailDels;
	}

	public void setDetailDels(String detailDels) {
		this.detailDels = detailDels;
	}
