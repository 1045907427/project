/**
 * @(#)GoodsNewsaledateUpdateJob.java
 *
 * @author zhengziyong
 *
 * 版本历史
 ...
 * @author zhengziyong
 */
public class GoodsNewsaledateUpdateJob extends BaseJob {

	@Override
	protected void executeInternal(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		IBaseFilesService baseFilesService = (IBaseFilesService)SpringContextUtils.getBean("baseFilesService");
		try {
			baseFilesService.doAutoUpdateGoodsNewsaledate();
			flag = true;
		} catch (Exception e) {
			logger.error("定时器执行异常 商品最新销售日期更新失败", e);
		}
