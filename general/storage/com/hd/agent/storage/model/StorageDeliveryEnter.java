 ...
 *
 */
public class StorageDeliveryEnter implements Serializable {
    ...
    /**
     * 单据类型1供应商到货入库单2客户配送退货入库单
     */
    private String billtype;

    /**
     * 来源类型0无来源1供应商代配送到货订单2供应商代配送客户退货通知单
     */
	...
	private List<StorageDeliveryEnterDetail> detailList;
    
    
    
    
	public List<StorageDeliveryEnterDetail> getDetailList() {
		return detailList;
	}

	public void setDetailList(List<StorageDeliveryEnterDetail> detailList) {
    ...
    /**
     * @return 单据类型1供应商到货入库单2客户配送退货入库单
     */
    ...
    /**
     * @return 来源类型0无来源1供应商代配送到货订单2供应商代配送客户退货通知单
     */
	...
	public String toString() {
		return "StorageDeliveryEnter [id=" + id + ", businessdate=" + businessdate + ", status=" + status + ", remark=" + remark + ", adduserid=" + adduserid + ", addusername=" + addusername
				...
				+ ischeck + ", checkuserid=" + checkuserid + ", checkname=" + checkname + ", checktime=" + checktime + ", suppliername=" + suppliername + ", customername=" + customername
