/**
 * @(#)StorageDeliveryEnterForJob.java
 *
 * @author huangzhiqian
 *
 * 版本历史
 ...
 * @author huangzhiqian
 */
public class StorageDeliveryEnterForJob implements Serializable{
...
//		private String  overnum; //主单位余数
        ...
        private BigDecimal addcostprice;//入库时成本价
		private int seq;
		...
		public void setConcactIds(String concactIds) {
			this.concactIds = concactIds;
		}
		...
		public String toString() {
			return "StorageDeliveryEnterForJob [pid=" + pid + ", businessdate=" + businessdate + ", premark=" + premark + ", adduserid=" + adduserid + ", addusername=" + addusername + ", adddeptid="
					...
					+ ", audituserid=" + audituserid + ", auditusername=" + auditusername + ", audittime=" + audittime + ", stopuserid=" + stopuserid + ", stopusername=" + stopusername
					+ ", stoptime=" + stoptime + ", closetime=" + closetime + ", checktime=" + checktime + ", billtype=" + billtype + ", sourcetype=" + sourcetype + ", sourceid=" + sourceid
					+ ", supplierid=" + supplierid + ", id=" + id + ", goodsid=" + goodsid + ", brandid=" + brandid + ", unitid=" + unitid + ", unitname=" + unitname + ", unitnum=" + unitnum
					+ ", auxunitid=" + auxunitid + ", auxunitname=" + auxunitname + ", totalbox=" + totalbox + ", seq=" + seq + ", remark=" + remark + "]";
		}
