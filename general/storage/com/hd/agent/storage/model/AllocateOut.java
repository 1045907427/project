 ...
 * @author chenwei
 */
public class AllocateOut implements Serializable {
     ...
     * 调拨出库单明细
     */
    private List<AllocateOutDetail> allocateOutDetailList;
	...
	public List<AllocateOutDetail> getAllocateOutDetailList() {
		return allocateOutDetailList;
	}

	public void setAllocateOutDetailList(
			List<AllocateOutDetail> allocateOutDetailList) {
		this.allocateOutDetailList = allocateOutDetailList;
	}
