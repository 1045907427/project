 ...
 * @author chenwei
 */
public class PurchaseEnter implements Serializable {
     ...
     * 明细列表
     */
    private List<PurchaseEnterDetail> purchaseEnterDetailList;
	...
	public List<PurchaseEnterDetail> getPurchaseEnterDetailList() {
		return purchaseEnterDetailList;
	}

	public void setPurchaseEnterDetailList(
			List<PurchaseEnterDetail> purchaseEnterDetailList) {
		this.purchaseEnterDetailList = purchaseEnterDetailList;
	}
