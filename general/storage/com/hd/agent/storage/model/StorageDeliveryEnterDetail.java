...
public class StorageDeliveryEnterDetail implements Serializable {
    ...
    public StorageDeliveryEnterDetail() {
		super();
	}
    /**
     * 基准单价
	...
	public String toString() {
		return "StorageDeliveryEnterDetail [id=" + id + ", billid=" + billid + ", summarybatchid=" + summarybatchid + ", sourcebillid=" + sourcebillid + ", sourcebilldetailid=" + sourcebilldetailid
				...
				+ taxamount + ", seq=" + seq + ", buyprice=" + buyprice + ", goodsInfo=" + goodsInfo + ", basesaleprice=" + basesaleprice + ", remark=" + remark + ", boxprice=" + boxprice
				+ ", volumn=" + volumn + ", weight=" + weight + ", goodsname=" + goodsname + "]";
	}
