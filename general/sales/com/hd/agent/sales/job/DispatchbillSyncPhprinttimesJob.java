/**
 * @(#)DispatchbillSyncFhprinttimesJob.java
 *
 * @author zhanghonghui
 *
 * 版本历史
...
/**
 * 定时器 调用 根据仓库发货单配货打印次数同步配货打印次数
 * 
 * @author zhanghonghui
 */
public class DispatchbillSyncPhprinttimesJob extends BaseJob {
	@Override
	protected void executeInternal(JobExecutionContext jobExecutionContext)
		...
		try {
			...
			dispatchBillService.updateBillSyncPhprinttimesProc();
			flag = true;
		} catch (Exception e) {
