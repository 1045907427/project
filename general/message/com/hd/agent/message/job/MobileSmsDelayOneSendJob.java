 ...
 * @author zhanghonghui
 */
public class MobileSmsDelayOneSendJob  extends BaseJob {
	...
	protected void executeInternal(JobExecutionContext jobExecutionContext)
		...
		try{
			if(map!=null
					&& null!=map.get("serialno")
					&& StringUtils.isNotEmpty(map.get("serialno").toString())
					&& null!=map.get("senduserid")
					&& StringUtils.isNotEmpty(map.get("senduserid").toString())	){
						Map<String,Object> queryMap=new HashMap<String, Object>();
						queryMap.put("serialno", map.get("serialno").toString());
						queryMap.put("adduserid", map.get("senduserid").toString());
