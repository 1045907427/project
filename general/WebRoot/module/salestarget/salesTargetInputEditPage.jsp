		...
		<form action="" id="salesTargetInput-form-detailAdd" method="post">
			<table>
				<tr>
					...
					<td class="len140"><input class="len150 Wdate" type="text" id="salesTargetInput-form-detail-yearmonth" class="easyui-validatebox Wdate" onfocus="WdatePicker({'dateFmt':'yyyy-MM'})" required="required" name="salesTargetInput.yearmonth" value="${salesTargetInput.yearmonth}" /></td>
					...
					<td class="len150">
						...
						<input type="hidden" id="salesTargetInput-form-detail-yearmonth-status-hidden" name="salesTargetInput.status" value="${salesTargetInput.status}" />
					</td>
				</tr>
				<tr>
					<td class="right">门店：</td>
					<td colspan="3">
						<input type="text" id="salesTargetInput-form-detail-customerid" name="salesTargetInput.customerid" value="${salesTargetInput.customerid}"/>
					</td>
					<td class="right">品牌：</td>
					<td>
						<input class="len150" type="text" id="salesTargetInput-form-detail-brandid" name="salesTargetInput.brandid"  value="${salesTargetInput.brandid}"/>
					</td>
				</tr>
				<tr>
					<td class="right">第一销售目标：</td>
					<td>
						<input type="text" id="salesTargetInput-form-detail-firstsalestarget" name="salesTargetInput.firstsalestarget" value="${salesTargetInput.firstsalestarget}" class="len150 easyui-validatebox" required="true" validType="intOrFloat"/>
					</td>
					<td class="right">第一目标毛利：</td>
					<td>
						<input type="text" id="salesTargetInput-form-detail-firstgrossprofit" name="salesTargetInput.firstgrossprofit" value="${salesTargetInput.firstgrossprofit}" autocomplete="off" class="len150 easyui-validatebox" required="true" validType="intOrFloat"/>
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" id="salesTargetInput-form-detail-secondsalestarget" name="salesTargetInput.secondsalestarget" value="${salesTargetInput.secondsalestarget}" autocomplete="off" class="len150 easyui-validatebox" required="true" validType="intOrFloat"/>
					</td>
					<td class="right">第二目标毛利：</td>
					<td>
						<input type="text" id="salesTargetInput-form-detail-secondgrossprofit" name="salesTargetInput.secondgrossprofit" value="${salesTargetInput.secondgrossprofit}" autocomplete="off" class="len150 easyui-validatebox" required="true" validType="intOrFloat"/>
					</td>
				...
				<tr>
					...
					<td colspan="3" rowspan="2">
						<textarea id="salesTargetInput-form-detail-remark" style="width: 410px;height: 50px;" name="salesTargetInput.remark" class="easyui-validatebox" validType="maxByteLength[500]" >${salesTargetInput.remark}</textarea>
...
<script type="text/javascript">
	$(function(){
		...
		$("#salesTargetInput-form-detail-addbutton").click(function(){
			$.messager.confirm("提醒","是否要修改当前销售目标？",function(r) {
				if(r) {
					$("#salesTargetInput-form-detail-addtype").val("save");
					$("#salesTargetInput-form-detailAdd").attr("action", "module/salestargetinput/editSalesTargetInput.do");
