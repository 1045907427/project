...
<html>
  ...
  <body>
  	...
  	<div id="buySupplier-layout-detail" class="easyui-layout" data-options="fit:true,border:false">  		
  		<form action="basefiles/editBuySupplier.do" id="buy-form-buySupplierAddPage" method="post">	    	
	    		...
	    		<table style="border-collapse:collapse;" border="0" cellpadding="5" cellspacing="5">
			    	<tr>
			    		...
			    		<td style="width:165px;">
			    			<input type="text" class="easyui-validatebox" name="buySupplier.id" validType="validUsed[20]" id="buy-id-buySupplierAddPage" value="<c:out value="${buySupplier.id }"></c:out>" <c:if test="${editFlag == false }">readonly="readonly"</c:if> data-options="required:true"  style="width:130px;"/>
			    		...
			    		<td style="width:165px;"><input class="easyui-validatebox" name="buySupplier.name" value="<c:out value="${buySupplier.name}"></c:out>" style="width:130px;" data-options="required:true" /></td>
			    		<td style="width:120px;text-align: right;">状态：</td>
			    		<td><select class="len130 easyui-combobox"  disabled="disabled">
		    		...
		    		<div class="tagsDiv_item" style="display:block;">
	    				<table style="border-collapse:collapse;" border="0" cellpadding="5" cellspacing="5">
	    					<tr>
	    						...
	    						<td style=""><input type="text" name="buySupplier.shortname" value="<c:out value="${buySupplier.shortname }"></c:out>" style="width:130px;"/></td>
	    						<td style="text-align: right;">名称拼音:</td>
								<td><input type="text" name="buySupplier.pinyin" style="width:130px;" maxlength="20" value="<c:out value="${buySupplier.pinyin}"></c:out>"/></td>
	    						<td style="text-align: right;">助记码：</td>
	    						<td style=""><input type="text" name="buySupplier.spell" value="<c:out value="${buySupplier.spell }"></c:out>" style="width:130px;"/></td>
	    					</tr>
	    					<tr>
	    						<td style="text-align: right;">税号：</td>
	    						<td><input type="text" name="buySupplier.taxno" value="<c:out value="${buySupplier.taxno }"></c:out>" style="width:130px;"/></td>
	    					...
	    					<tr>
	    						...
	    						<td><input type="text" style="width: 130px;" id="buy-buySupplierAddPage-contacterName" name="buySupplier.contactname" value="<c:out value="${buySupplier.contactname }"></c:out>" maxlength="20"/>
	    							<input type="hidden" id="buy-buySupplierAddPage-contacterId" name="buySupplier.contact" value="<c:out value="${buySupplier.contact}"></c:out>"/>
	    						</td>
	    					</tr>
	    					<tr>
	    						<td style="text-align: right;">业务联系电话:</td>
		    					<td><input type="text" name="buySupplier.contactmobile" value="<c:out value="${buySupplier.contactmobile }"></c:out>" id="buy-buySupplierAddPage-contacterMobile" style="width:130px;" /></td>
	    				...
	    				<div>
		    				<table style="border-collapse:collapse;" border="0" cellpadding="5px" cellspacing="5px">
		    					...
		    					<tr>
		    						...
		    						<td colspan="3">
		    							<select id="" name="buySupplier.orderappend" class="len130 easyui-combobox">
	...
	<script type="text/javascript">
	    	...
	    	function selectTags(index){ //选择第index个选项
	   		...
	   		function changeContacterDefault(obj, id, name){ //设置默认联系人
	    		if($(obj).val() == "1"){
	    			...
	    			$(obj).val("1");
	    			$("#buy-buySupplierAddPage-contacterName").val(name);
	    			$("#buy-buySupplierAddPage-contacterId").val(id);
	    			var row = $("#buy-buySupplierAddPage-contactor").datagrid('getSelected');
	    			$("#buy-buySupplierAddPage-contacterMobile").val(row.mobile);
	    		}
	    		else{
	    			$("#buy-buySupplierAddPage-contacterName").val("");
	    			$("#buy-buySupplierAddPage-contacterId").val("");
	    			$("#buy-buySupplierAddPage-contacterMobile").val("");
	    		}
	    	};
	    	...
	    	$(document).ready(function(){
	    		...
	    		$("#buy-buttons-buySupplierPage").buttonWidget("setDataID", {id:$("#buySupplier-oldid").val(),state:'${buySupplier.state}',type:'edit'});
		    	
				$("#buy-buySupplierAddPage-sortName").dblclick(function(){
	    			$("#buy-buySupplierAddPage-tabs").tabs("select","对应分类");
	    		});
    			validUsed("basefiles/isBuySupplierIdExist.do", '', $("#buySupplier-oldid").val(), "该编号已被使用，请另输入编号！");
				$("#buy-id-buySupplierAddPage").change(function(){
	    			validUsed("basefiles/isBuySupplierIdExist.do", $(this).val(), $("#buySupplier-oldid").val(), "该编号已被使用，请另输入编号！");
	    		});
	    		...
	    		buyuserReferWindow($("#buySupplier-buydeptid").val());
	    		...
	    		filialeReferWindow($("#buySupplier-filiale").val());
	    		
				$("#buy-buySupplierAddPage-buyuserid").widget('setValue',$("#buySupplier-buyuserid").val());
