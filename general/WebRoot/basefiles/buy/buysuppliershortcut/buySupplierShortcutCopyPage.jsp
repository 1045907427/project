	   		...
	   		<form action="basefiles/addBuySupplierShortcut.do" method="post" id="buy-add-buySupplierShortcut">
	    		...
	    		<table cellpadding="1" cellspacing="1" border="0" >
		    		<tr>
		    			...
		    			<td align="left"><select style="width: 134px;" disabled="disabled" class="easyui-combobox">
		    				<option value="4" selected="selected">新增</option>
		    			</select></td>
		    		</tr>
		    		<tr>
		    			<td align="right">名称:</td>
		    			<td align="left" colspan="3"><input id="buy-name-buySupplierShortcut" name="buySupplier.name" type="text" style="width: 377px" maxlength="100" class="easyui-validatebox" validType="validName[100]" data-options="required:true" /><font color="red">*</font></td>
		    		...
		    		<tr>
  					...
  					<tr>
		    			...
		    			<td align="right">ABC等级:</td>
   						<td align="left"><select name="buySupplier.abclevel" class="easyui-combobox" style="width: 134px">
   								<option></option>
		    		...
		    		<tr>
                        ...
                        <td align="left">
                            <select name="buySupplier.orderappend" class="easyui-combobox" <c:if test="${colMap.orderappend == 'orderappend' }">data-options="required:true"</c:if> style="width: 134px">
		    		...
		    		<tr>
		    			...
		    			<td align="left" colspan="3"><input type="text" name="buySupplier.address" style="width: 377px" maxlength="200" <c:if test="${colMap.address == 'address' }">class="easyui-validatebox" data-options="required:true"</c:if>/><c:if test="${colMap.address == 'address' }"><font color="red">*</font></c:if></td>
		    		</tr>
		    		<tr>
		    			<td align="right">备注:</td>
			    		<td align="left" colspan="3"><input style="width: 377px;" rows="1" name="buySupplier.remark" /></td>
