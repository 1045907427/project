...
<html>
  ...
  <body>
  	<input type="hidden" id="buySupplierSort-pid" value="<c:out value="${buySupplierSort.pid }"></c:out>"/>
    <form action="basefiles/addBuySupplierSort.do" id="buy-form-buySupplierSortAddPage" method="post">
  		...
  		<table cellpadding="2" cellspacing="2" border="0">
  			...
  			<tr>
  				<td>编号：</td>
  				<td><input type="text" style="width: 200px;" class="easyui-validatebox" readonly="readonly" value="<c:out value="${buySupplierSort.pid }"></c:out>" name="buySupplierSort.id" id="buy-id-buySupplierSortAddPage" /></td>
  			</tr>
  			<tr>
  				<td>本级名称：</td>
  			...
  			<tr>
  				<td>名称：</td>
  				<td><input type="text" style="width: 200px;" class="easyui-validatebox" readonly="readonly" value="<c:out value="${parentName }"></c:out>" name="buySupplierSort.name" id="buy-name-buySupplierSortAddPage" /></td>
  			</tr>
  			<tr>
  				<td>上级分类：</td>
  				<td><input type="text" id="buy-parent-buySupplierSortAddPage" value="<c:out value="${buySupplierSort.pid }"></c:out>" name="buySupplierSort.pid" /></td>
  			</tr>
  			<tr>
  				<td>备注：</td>
    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		$("#buy-thisId-buySupplierSort").val($("#buySupplierSort-pid").val());
