...
<html>
  ...
  <body>
    <form action="basefiles/addBuyArea.do" id="buy-form-buyAreaAddPage" method="post">
  		...
  		<input type="hidden" id="buyArea-oldpid" value="${buyArea.pid }"/>
	    <div class="pageContent" style="width:500px;">
	    	...
	    	<p>
	    		<label>编号：</label>
	    		<input type="text" class="easyui-validatebox" readonly="readonly" value="<c:out value="${buyArea.pid }"></c:out>" name="buyArea.id" id="buy-id-buyAreaAddPage" />
	    	</p>
	    	<p>
	    		<label>本级名称：</label>
	    	...
	    	<p>
	    		<label>名称：</label>
	    		<input type="text" class="easyui-validatebox" readonly="readonly" value="<c:out value="${parentName }"></c:out>" name="buyArea.name" id="buy-name-buyAreaAddPage" />
	    	</p>
	    	<p>
	    		<label>上级分类：</label>
	    		<input type="text" id="buy-parent-buyAreaAddPage" value="<c:out value="${buyArea.pid }"></c:out>" name="buyArea.pid" />
	    	</p>
    ...
    <script type="text/javascript">
    	$(function(){
    		...
    		$("#buy-thisId-buyArea").val($("#buyArea-oldpid").val());
