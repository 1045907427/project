    ...
    <Fpxx>
        ...
        <Fpsj>
            <Fp>
                ...
                <Gfmc>${cutStringFunc(customerInfo.name,100,"[&]")}</Gfmc>
                <Gfsh>${customerInfo.taxno!}</Gfsh>
                <Gfyhzh>${customerInfo.cardno!}</Gfyhzh>
...
<#list detailList as detailItem>
                    <Sph>
                        ...
                        <Ggxh>${cutStringFunc(detailItem.goodsInfo.model,40,"[&]")}</Ggxh>
                        <Jldw>${cutStringFunc(detailItem.unitname,32,"[&]")}</Jldw>
                        <Spbm>${paddingStringFunc(detailItem.goodsInfo.jstaxsortid,"2",19,"0")}</Spbm>
