...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center',border:false">
        <div align="center" style="padding: 10px;">
            <form action="basefiles/htgoldtax/editJsTaxTypeCode.do" method="post" id="htgoldtax-form-editJsTaxTypeCode">
                <table cellpadding="3" cellspacing="3" border="0">
                    <tr>
                        <td width="100px" align="right">编码:</td>
                        <td align="left">
                            <input type="text" value="${jsTaxTypeCode.id}"  style="width:200px;" readonly="readonly"/>
                            <input type="hidden" name="jsTaxTypeCode.id" value="${jsTaxTypeCode.id}" />
                        </td>
                    </tr>
                    <tr>
...
<script type="text/javascript">
    $(function(){
        ...
        $("#htgoldtax-save-editJsTaxTypeCode").click(function(){
            $.messager.confirm("提醒","是否编辑金税税收分类信息?",function(r){
                if(r){
