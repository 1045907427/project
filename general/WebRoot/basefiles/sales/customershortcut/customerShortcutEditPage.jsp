...
<html>
  ...
  <body>
    		...
    		<div data-options="region:'center'">
		    	 ...
		    	 <table cellpadding="1" cellspacing="1" border="0">
		    		...
		    		<tr>
	    				...
	    				<td align="left"><input class="easyui-validatebox" value="<c:out value="${customer.id }"></c:out>" readonly="readonly" name="customer.id" id="sales-id-customerAddPage" style="width: 130px;"/></td>
		    			<td align="right">名称：</td>
	    				<td align="left" colspan="3"><input id="sales-name-customershortcut" class="easyui-validatebox" required="required" value="<c:out value="${customer.name }"></c:out>" style="width:400px;" name="customer.name" maxlength="50" /><font color="red">*</font></td>
		    		</tr>
		    		<tr>
		    			<td align="right">简称：</td>
		    			<td align="left"><input type="text" name="customer.shortname" value="<c:out value="${customer.shortname }"></c:out>" style="width: 130px" maxlength="50" class="easyui-validatebox" required="required"/><font color="red">*</font></td>
		    			<td align="right">名称拼音：</td>
						<td align="left"><input type="text" name="customer.pinyin" value="<c:out value="${customer.pinyin }"></c:out>" maxlength="20" style="width: 130px;"/></td>
		    			<td align="right">助记符：</td>
		    			<td align="left"><input name="customer.shortcode" value="<c:out value="${customer.shortcode }"></c:out>" type="text" style="width: 130px" maxlength="20" class="easyui-validatebox" required="required"/><font color="red">*</font></td>
		    		</tr>
		    		<tr>
		    		...
		    		<tr>
				    	...
				    	<td align="left"><input type="text" name="customer.contactname" value="<c:out value="${customer.contactname }"></c:out>" maxlength="20" style="width: 130px;"/><font color="red">*</font>
				    		<input type="hidden" name="customer.contact" maxlength="20" value="<c:out value="${customer.contact }"></c:out>"/>
				    	</td>
		    		</tr>
		    		<tr>
				    	<td align="right">联系人电话:</td>
				    	<td align="left"><input type="text" name="customer.mobile" value="<c:out value="${customer.mobile }"></c:out>" style="width: 130px"/><font color="red">*</font></td>
		    			<td align="right">传真：</td>
				    	<td align="left"><input type="text" name="customer.faxno" value="${customer.faxno }" class="easyui-validatebox" maxlength="20" validType="faxno" style="width: 130px"/></td>
		    		...
		    		<tr>
				    	...
				    	<td align="left" colspan="3"><input type="text" name="customer.address" value="<c:out value="${customer.address }"></c:out>" maxlength="100" style="width: 400px"/><font color="red">*</font></td>
		    		</tr>
		    		<tr>
     ...
     <script type="text/javascript">
     	$(function(){
     		$("#sales-buttons-customershortcut").buttonWidget("setDataID", {id:$("#customer-oldid").val(),state:'${customer.state}',type:'edit'});
			...
			$.extend($.fn.validatebox.defaults.rules, {
     		...
     		$("#sales-save-customerShortcut").click(function(){
     			...
     			$.messager.confirm("提醒","是否修改客户?",function(r){
					if(r){
						var clicktype = $("#sales-button-clicktype").val();
						if("0" == clicktype){
							$("#sales-state-customerAddPage").val("${customer.state}");
						}else if("1" == clicktype){
							$("#sales-state-customerAddPage").val("1");
						}
						loading("提交中..");
 						var ret = customerShortcut_AjaxConn($("#sales-add-customerShortcut").serializeJSON(),'basefiles/editCustomerShortcut.do');
    					var retJson = $.parseJSON(ret);
    					if(retJson.flag){
