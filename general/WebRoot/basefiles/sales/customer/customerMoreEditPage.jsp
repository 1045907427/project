...
<html>
  ...
  <body>
    ...
    <script type="text/javascript">
    	var customer_title1 = tabsWindowTitle('/basefiles/customerListPage.do');
    	var customer_title2 = tabsWindowTitle('/basefiles/showCustomerShortcutPage.do');
    	...
    	$("#sales-form-editMoreCustomer").form({  
		    ...
		    success:function(data){
		    	...
		    	if (top.$('#tt').tabs('exists',customer_title1)){
    				tabsWindowURL('/basefiles/customerListPage.do').$("#sales-datagrid-customerListPage").datagrid('reload');
    			}
    			if (top.$('#tt').tabs('exists',customer_title2)){
    				tabsWindowURL('/basefiles/showCustomerShortcutPage.do').$("#sales-datagrid-customerShortcut").datagrid('reload');
    			}
		    }  
		});
