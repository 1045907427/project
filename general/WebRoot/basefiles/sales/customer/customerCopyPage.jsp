  ...
  <body>
  	<div id="customer-layout-detail" class="easyui-layout" data-options="fit:true,border:false">
	  	<form action="basefiles/addCustomer.do" id="sales-form-customerAddPage" method="post">
	  		...
	  		<input type="hidden" id="customer-oldid" name="customer.oldid" value="<c:out value="${customer.oldid }"></c:out>"/>
	    	...
	    	<div id="customer-layout-detail-north" data-options="region:'north',border:false" style="height:84px">
	    		<table style="border-collapse:collapse;" border="0" cellpadding="2px" cellspacing="2px">
	    			<tr>
	    				...
	    				<td class="len165">
	    					<select disabled="disabled" class="len130"><option>新增</option></select>
	    				</td>
	    			</tr>
	    			<tr>
	    			...
	    			<div class="tagsDiv_item" style="display:block;">
	    				<table style="border-collapse:collapse;" border="0" cellpadding="2px" cellspacing="2px">
	    					...
	    					<tr>
	    						...
	    						<td align="left"><input type="text" name="customer.contactname" value="<c:out value="${customer.contactname }"></c:out>" maxlength="20" style="width: 130px"/></td>
	    			...
	    			<div class="tagsDiv_item">
	    				<table style="border-collapse:collapse;" border="0" cellpadding="2px" cellspacing="2px">
	    					<tr>
	    						...
	    						<td align="left"><input type="text" name="customer.creditdate" value="<c:out value=""></c:out>${customer.creditdate }" style="width: 130px;" /></td>
	    					</tr>
	    					<tr>
	    					...
	    					<tr>
	    						...
	    						<td align="left"><input type="text" id="customerShortcut-input-overgracedate" <c:if test="${customer.overcontrol == '0'}">disabled="disabled"</c:if> value="${customer.overgracedate }" class="easyui-validatebox" maxlength="3" validType="integer" onchange="changeValue(this.value)" style="width: 130px"/>
	    					...
	    					<tr>
	    						...
	    						<td><input name="customer.indoorstaff" value="<c:out value="${customer.indoorstaff }"></c:out>" id="sales-indoorstaff-customerAddPage" /></td>
	    					</tr>
	    					<tr>
	    					...
	    					<div class="easyui-panel" title="最新动态" style="height:160px;width:800px;">
		    					<table style="border-collapse:collapse;" border="0" cellpadding="2px" cellspacing="2px">
		    						...
		    						<tr>
		    							...
		    							<td align="left"><input type="text" readonly="readonly" value="${customer.duefromsum }" /></td>
		    						</tr>
		    						<tr>
   	...
   	<script type="text/javascript">
   		$(function(){
			...
			$("#sales-buttons-customer").buttonWidget("initButtonType", 'add'); //按钮的添加风格
					...
					if(!$("#sales-contacter-customerAddPage").hasClass("create-datagrid")){
						$("#sales-contacter-customerAddPage").datagrid({ //联系人列表
							...
							idField:'id',
					 		...
					 		rownumbers:true,
					 		border:false,
					 		url:"basefiles/getContacterListCustomer.do?type=1"
						});
