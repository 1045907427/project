...
<div class="easyui-layout" data-options="fit:true,border:false">
            ...
            <form id="sales-form-distributionRuleEditPage" action="basefiles/distribution/editDistributionRule.do" method="post">
                ...
                <table>
                    <tr>
                        ...
                        <td class="left" style="width: 220px;"><input type="text" class="len150 easyui-validatebox Wdate" id="sales-businessdate-distributionRuleEditPage" name="distributionRule.businessdate" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" autocomplete="off" value="${distributionRule.businessdate }"/></td>
                    ...
                    <tr>
                        <td>客 户 群：</td>
                        <td>
                            <select class="len150" id="sales-customertype-distributionRuleEditPage" name="distributionRule.customertype">
                        ...
                        <td>商品规则：</td>
                        <td>
                            <select id="sales-goodsruletype-distributionRuleEditPage" name="distributionRule.goodsruletype" class="len150">
                    ...
                    <tr>
                        ...
                        <td>备注：</td>
                        <td colspan="3">
                            <input type="text" id="sales-remark-distributionRuleEditPage" name="distributionRule.remark" value="<c:out value='${distributionRule.remark }'/>" style="width: 438px;" autocomplete="off"/>
                        </td>
                    </tr>
                </table>
            </form>
    ...
    <div data-options="region:'center'">
        <table id="sales-datagrid-distributionRuleEditPage" ></table>
    </div>
</div>
