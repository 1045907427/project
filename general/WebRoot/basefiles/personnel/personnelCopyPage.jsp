  ...
  <body>
  			...
  			<form id="personnel-form-head" action="" method="post" style="padding: 5px;">
				...
				<table border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td style="width: 15px"></td>
						<td><input type="text" id="basefiles-id-personnel"  class="easyui-validatebox" name="personnel.id" validType="isExistPerId[20]" required="true" style="width: 200px;"/></td>
						<td style="width: 15px"></td>
						<td style="width: 40px">姓名:</td>
						<td style="width: 15px"></td>
						<td><input type="text" id="personnel-input-personnel_name" class="easyui-validatebox" name="personnel.name" value="" required="true" maxlength="20" style="width: 200px;"/></td>
						<td style="width: 15px"></td>
						<td style="width: 40px">状态:</td>
						<td style="width: 15px"></td>
						<td><input id="personnel-widget-state" name="personnel.state" value="4" disabled="disabled" />
						</td>
					</tr>
				</table>
			</form>
			    	...
			    	<form action="" method="post" id="personnel-form-addPersonnelBaseInfo">
						<table cellpadding="5px" cellspacing="5px" style="padding-top: 5px;padding-left: 5px;">
							<tr>
								...
								<td><input type="text" name="personnel.namepinyin" value="<c:out value="${personnel.namepinyin }"></c:out>" maxlength="20" style="width: 120px"/>
									<input id="basefiles-hdid-personnel" type="hidden" name="personnel.oldId" value="<c:out value="${personnel.id }"></c:out>"/>
									<input id="personnel-hidden-throughName" type="hidden" name="personnel.name" />
									<input id="personnel-hidden-throughState" type="hidden" name="personnel.state" />
									<input type="hidden" id="personnel-hidden-hdBirthday" value="${birthday }"/>
									...
									<!-- <input id="personnel-hidden-hdCustomerListDelId" type="hidden" name ="personnel.customerListDelId"/> -->
									<!-- <input id="personnel-hidden-hdBrandListDelId" type="hidden" name ="personnel.brandListDelId"/> -->
								...
								<td><input type="text" name="personnel.datesemployed" value="${dateSemployed }" class="easyui-validatebox" style="width: 120px" onclick="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd',minDate:'1958-01-01',maxDate:'%y-%M-%ld'})"/></td>
							...
							<tr>
								...
								<td><input id="personnel-widget-personnelstyle" name="personnel.personnelstyle" value="${personnel.personnelstyle }"/>
								</td>
								<td align="right">最高学历：</td>
								<td><input id="personnel-widget-highestdegree" name="personnel.highestdegree" value="${personnel.highestdegree }"/>
								</td>
							</tr>
							<tr>
								<td align="right">所属部门：</td>
								<td>
					    			<input id="personnel-widget-personnelDept" required="true" name="personnel.belongdeptid" value="<c:out value="${personnel.belongdeptid }"></c:out>"/>
					    		</td>
								<td align="right">所属岗位：</td>
								<td><input type="text" id="personnel-widget-personnelPost" style="width: 120px" value="<c:out value="${personnel.belongpost }"></c:out>" name="personnel.belongpost"/></td>
							</tr>
							<tr>
								<td align="right">上级领导：</td>
								<td><input type="text" id="personnel-widget-leadid" name="personnel.leadid" value="${personnel.leadid }"/></td>
								<td align="right">性别：</td>
								<td><input type="text" id="personnel-widget-sex" name="personnel.sex" value="${personnel.sex }" />
								</td>
							</tr>
							<tr>
								<td align="right">婚姻状态：</td>
								<td><input id="personnel-widget-maritalstatus" name="personnel.maritalstatus" value="${personnel.maritalstatus }" /></td>
								<td align="right">身份证号码：</td>
								<td><input id="personnel-input-idCard" type="text" name="personnel.idcard" value="${personnel.idcard }" oninput="getAgeForeign(this.value)" class="easyui-validatebox" validType="valididcard" style="width: 120px"/></td>
							</tr>
							<tr>
								<td align="right">出生日期：</td>
								<td><input id="personnel-input-birthday" name="personnel.birthday" value="${birthday }" class="easyui-validatebox" validType="validBirthday" style="width: 120px" onclick="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd',minDate:'1958-01-01',maxDate:'%y-%M-%d',onpicked:getAgeFunc})"/></td>
								<td align="right">年龄：</td>
								<td><input id="personnel-input-age" value="${personnel.age }" type="text" name="personnel.age" style="width: 120px" readonly="readonly"/></td>
							</tr>
							<tr>
								<td align="right">民族：</td>
								<td><input type="text" id="personnel-widget-nation" name="personnel.nation" value="${personnel.nation }"/></td>
								<td align="right">籍贯：</td>
								<td><input id="personnel-input-NPlace" type="text" name="personnel.nativeplace" value="${personnel.nativeplace }" style="width: 120px"/></td>
							</tr>
							<tr>
								<td align="right">政治面貌：</td>
								<td><input id="personnel-widget-polstatus" name="personnel.polstatus" value="${personnel.polstatus }" /></td>
								<td align="right">电话：</td>
								<td><input type="text" class="easyui-validatebox" value="${personnel.tel }" validType="phone" name="personnel.tel" style="width: 120px"/></td>
								<td align="right">传真：</td>
								<td><input type="text" class="easyui-validatebox" value="${personnel.fax }" validType="phone" name="personnel.fax" style="width: 120px"/></td>
							</tr>
							<tr>
								<td align="right">手机号码：</td>
								<td><input type="text" value="<c:out value="${personnel.telphone }"></c:out>" name="personnel.telphone" style="width: 120px"/></td>
								<td align="right">公司短号：</td>
								<td><input type="text" name="personnel.compcornet" value="${personnel.compcornet }" class="easyui-validatebox" validType="compcornet[6]" style="width: 120px"/></td>
								<td align="right">邮箱：</td>
								<td><input type="text" class="easyui-validatebox" value="${personnel.email }" validType="email" name="personnel.email" style="width: 120px"/></td>
							</tr>
							<tr>
								...
								<td><input type="text" id="personnel-widget-salaryscheme" name="personnel.salaryscheme" value="<c:out value="${personnel.salaryscheme }"></c:out>"/></td>
							</tr>
							<tr>
								<td align="right">居住地址：</td>
								<td colspan="3"><input type="text" value="<c:out value="${personnel.address }"></c:out>" maxlength="100" name="personnel.address" style="width: 400px"/></td>
								<td align="right">居住地邮编：</td>
								<td><input name="personnel.addrpostcode" value="${personnel.addrpostcode }" class="easyui-validatebox" validType="zip" style="width: 120px"/></td>
							</tr>
							<tr>
								<td align="right">户籍地址：</td>
								<td colspan="3"><input type="text" value="<c:out value="${personnel.householdaddr }"></c:out>" maxlength="100" name="personnel.householdaddr" style="width: 400px"/></td>
								<td align="right">户籍地邮编：</td>
								<td><input name="personnel.householdcode" value="${personnel.householdcode }" class="easyui-validatebox" validType="zip" style="width: 120px"/></td>
							</tr>
							<tr>
								<td align="right">备注：</td>
								<td colspan="5">
									<textarea rows="" cols="" class="easyui-validatebox" validType="remark[200]" style="width: 700px;height: 30px" name="personnel.remark" style="overflow-y:scroll"><c:out value="${personnel.remark }"></c:out></textarea>
								</td>
							</tr>
						</table>
					</form>
					...
					<form action="" method="post" id="personnel-form-addPersonnelDefineInfo">
						<table border="0" cellpadding="2px" cellspacing="2px">
							<tr>
								...
								<td><input name="personnel.field01" maxlength="100" value="<c:out value="${personnel.field01 }"></c:out>" type="text" style="width: 120px"/></td>
								<td align="right"><label>
								<c:choose>
								...
								<td><input name="personnel.field02" maxlength="100" value="<c:out value="${personnel.field02 }"></c:out>" type="text" style="width: 120px"/></td>
								<td align="right"><label>
								<c:choose>
								...
								<td><input name="personnel.field03" maxlength="100" value="<c:out value="${personnel.field03 }"></c:out>" type="text" style="width: 120px"/></td>
							</tr>
							<tr>
								<td align="right"><label>
								<c:choose>
								...
								<td><input name="personnel.field04" maxlength="100" value="<c:out value="${personnel.field04 }"></c:out>" type="text" style="width: 120px"/></td>
								<td align="right"><label>
								<c:choose>
								...
								<td><input name="personnel.field05" maxlength="100" value="<c:out value="${personnel.field05 }"></c:out>" type="text" style="width: 120px"/></td>
								<td align="right"><label>
								<c:choose>
								...
								<td><input name="personnel.field06" maxlength="100" value="<c:out value="${personnel.field06 }"></c:out>" type="text" style="width: 120px"/></td>
							</tr>
							<tr>
								<td align="right"><label>
								<c:choose>
								...
								<td><input name="personnel.field07" maxlength="100" value="<c:out value="${personnel.field07 }"></c:out>" type="text" style="width: 120px"/></td>
								<td align="right"><label>
								<c:choose>
								...
								<td><input name="personnel.field08" maxlength="100" value="<c:out value="${personnel.field08 }"></c:out>" type="text" style="width: 120px"/></td>
								<td align="right"><label>
								<c:choose>
								...
								<td><input name="personnel.field09" maxlength="100" value="<c:out value="${personnel.field09 }"></c:out>" type="text" style="width: 120px"/></td>
							</tr>
							<tr>
								<td align="right"><label>
								<c:choose>
								...
								<td colspan="5"><input type="text" name="personnel.field10" value="<c:out value="${personnel.field10 }"></c:out>" style="width: 625px"/></td>
							</tr>
							<tr>
								<td align="right"><label>
								<c:choose>
								...
								<td colspan="5"><input type="text" name="personnel.field11" value="<c:out value="${personnel.field11 }"></c:out>" style="width: 625px"/></td>
							</tr>
							<tr>
								<td align="right"><label>
								<c:choose>
								...
								<td colspan="5"><input type="text" name="personnel.field12" value="<c:out value="${personnel.field12 }"></c:out>" style="width: 625px"/></td>
							</tr>
                            <!-- 该行没有意义，保证页面对齐设置-->
                            <tr>
                                <td><label></label> </td>
	...
	<script type="text/javascript">
		...
		$(function(){
			...
			//对应客户，对应品牌,教育经历，工作经历，岗位变更经历为修改状态
			$("#personnel-beginedit").val("1");
			$("#personnel-beginCustomeredit").val("1");
			$("#personnel-beginedu").val("1");
			$("#personnel-beginpost").val("1");
			$("#personnel-beginwork").val("1");
			
			clickEmployeType("copy","${personnel.employetype}");
