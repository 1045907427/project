  ...
  <body>
  	<form action="" id="storageLocation-form-add" method="post">
	    ...
	    <div class="pageContent" style="width:500px;">
	    	...
	    	<p>
	    		...
	    		<input type="text" class="easyui-validatebox" readonly="readonly" name="storageLocation.id" id="storageLocation-id" />
	    	</p>
	    	<p>
	    	...
	    	<p>
	    		...
	    		<input type="text" class="easyui-validatebox" readonly="readonly" name="storageLocation.name" id="storageLocation-name" />
	    	</p>
	    	<p>
	    		<label style="text-align: right;">上级库位：</label>
	    		<input type="text" id="storageLocation-parent" value="${storageLocation.pid }" name="storageLocation.pid" />
	    	</p>
	    	<p>
	    	...
	    	<p style="height:auto;width:auto;">
	    		...
	    		<textarea name="storageLocation.remark" style="height: 100px;width: 200px;"><c:out value="${storageLocation.remark }"></c:out></textarea>
	    	</p>
	    	<p>
	    		<label style="text-align: right;">状态：</label>
	    		<select class="easyui-combobox" disabled="disabled" style="width:206px;"  name="storageLocation.state">
    ...
    <script type="text/javascript">
    	...
    	$(function(){
            ...
            $("#storageLocation-viewid").val("${storageLocation.pid}");
			    ...
			    success:function(data){
			    	...
			    	if(json.flag){
                        ...
                        refreshLayout('库位档案【详情】', 'basefiles/showStorageLocationInfoPage.do?id='+json.id);
		  		      	$("#storageLocation-button").buttonWidget("setDataID", {id:json.node.id, state:json.node.state});
			    	}else{
