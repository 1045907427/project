...
<html>
						...
						<tbody>
							<tr>
								...
								<td>
									...
									<input id="lineInfo-oldid-baseInfo" type="hidden"
										name="lineInfo.oldid" value="<c:out value="${lineid}"></c:out>" />
									...
									<input id="logistics-linecustomer" type="hidden" value="${customerids }"/>
								</td>
								<td width="80px">
									<div align="right">
										名称:
    ...
    //检验输入值的最大长度
    	...
    	var id = $("#lineInfo-oldid-baseInfo").val();
								...
								toolbar : [ {
					                ...
					                handler : function() {
				                		...
				                		$('#line-dialog-customer').dialog({  
										    ...
										    closed: false,
										    cache: false,
										    href: 'basefiles/showCustomerToLineAddPage.do?insertcustomerid='+insertcustomerid,
										    modal: true
										});
					                }
					            },{
