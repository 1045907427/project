...
<html>
	...
	<body>
		<form action="" method="post" id="logistics-form-carAdd">
			<table cellpadding="2" cellspacing="2" border="0">
				<tr>
					...
					<td>
						<input id="logistics-input-carId" name="car.id" type="text"
							...
							validType="validID" value="<c:out value="${car.id}"></c:out>" style="width: 200px;" />
				...
				<tr>
					...
					<td>
						<input name="car.name" required="true" value="<c:out value="${car.name}"></c:out>"
							class="easyui-validatebox" validType="validName[20]"
							style="width: 200px;" />
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<input name="car.boxnum" data-options="min:0,max:99999,precision:0" class="easyui-numberbox"
				...
				<tr>
					...
					<td>
						<input name="car.truck1" required="true" value="0" data-options="min:0,max:99999,precision:2" class="easyui-numberbox"
				...
				<tr>
					...
					<td>
						<input name="car.truck2" value="0" data-options="min:0,max:99999,precision:2" class="easyui-numberbox"
				...
				<tr>
					...
					<td>
						<input name="car.truck3" value="0" data-options="min:0,max:99999,precision:2" class="easyui-numberbox"
				...
				<tr>
					...
					<td>
						<input name="car.truck4" value="0" data-options="min:0,max:99999,precision:2" class="easyui-numberbox"
				...
				<tr>
					...
					<td>
						<input name="car.truck5" value="0" data-options="min:0,max:99999,precision:2" class="easyui-numberbox"
		...
		function addCar(type){
			...
			//if(type == "save"){
				if(!$("#logistics-form-carAdd").form('validate')){
					return false;
				}
			//}
			var ret = car_AjaxConn($("#logistics-form-carAdd").serializeJSON(),'basefiles/addCar.do');
			var retJson = $.parseJSON(ret);
			if(retJson.flag){
		...
		$(function(){
			...
			$("#car-button-layout").buttonWidget("initButtonType", 'add');
    	});
    </script>
	</body>
</html>
