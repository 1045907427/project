...
<html>
	<head>
		<title>车辆档案复制页面</title>
	</head>

	<body>
		<form action="" method="post" id="logistics-form-carCopy">
			<table cellpadding="2" cellspacing="2" border="0">
				<tr>
					...
					<td>
						<input id="logistics-input-carId" name="car.id" type="text"
							...
							validType="validID" value="" style="width: 200px;" />
				...
				<tr>
					...
					<td>
						<input name="car.name" required="true" value=""
		...
		function addCar(type){
			...
			//if(type == "save"){
				if(!$("#logistics-form-carCopy").form('validate')){
					return false;
				}
			//}
			var ret = car_AjaxConn($("#logistics-form-carCopy").serializeJSON(),'basefiles/addCar.do');
			var retJson = $.parseJSON(ret);
			if(retJson.flag){
