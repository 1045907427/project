...
<html>
	...
	<body>
							...
							<tr>
								...
								<td>
									<input id="lineInfo-id-baseInfo" type="text"
										style="width: 120px;" name="lineInfo.id"
										class="easyui-validatebox" required="true"  validType="validID"/>
									...
									<input id="logistics-linecustomer" type="hidden" />
								</td>
								<td width="80px">
									<div align="right">
										名称:
								...
								<td style="width: 5px"></td>
								<td>
									<input id="lineInfo-widget-state" value="4" disabled="disabled"
										style="width: 200px" />
								</td>
							...
							<table cellspacing="5px" cellpadding="5px" border="0">
								<tbody>
									<tr>
										...
										<td style="width: 5px"></td>
										<td>
											<input type="text" name="lineInfo.salesarea" value="<c:out value="${lineInfo.salesarea}"></c:out>" style="width: 120px" class="easyui-validatebox" id="line-customer-sortarea" />
										</td>
										<td width="120px">
											<div align="right">
												区域客户家数:
										...
										<td style="width: 5px"></td>
										<td>
											<input type="text" id="lineInfo-input-totalcustomers" name="lineInfo.totalcustomers" readonly="readonly" style="width: 120px" />
										</td>
										<td width="120px">
											<div align="right">
												默认车辆:
										...
										<td style="width: 5px"></td>
										<td>
											<select type="text" id="lineInfo-select-car" name="lineInfo.carid" value="<c:out value="${lineInfo.carname}"></c:out>" style="width: 120px">
									...
									<tr>
										...
										<td style="width: 5px"></td>
										<td>
											<input id="infoInfo-widget-distance" type="text" style="width: 120px" name="lineInfo.distance" value="<c:out value="${lineInfo.distance}"></c:out>" class="easyui-validatebox" />
										</td>
										<td width="120px">
											<div align="right">
												路程复杂度:
										...
										<td style="width: 5px"></td>
										<td>
											<select id="infoInfo-widget-linetype" type="text" style="width: 120px" name="lineInfo.linetype" value="${lineInfo.linetype}" class="easyui-validatebox">
												<option>简单</option>
												<option>普通</option>
												<option>复杂</option>
											</select>
									...
									<table cellspacing="5px" cellpadding="5px" border="0">
										<tbody>
											<tr>
												...
												<td style="width: 5px"></td>
												<td>
													<input type="text" style="width: 120px" name="lineInfo.basecustomers" value="0" class="easyui-validatebox" validType="number" required="true"<c:if test="${showMap.basecustomers!='basecustomers'}"> readonly="readonly"  </c:if> />
												</td>
												<td width="120px">
													<div align="right">
														基本补贴:
												...
												<td>
													<input type="text" style="width: 120px"
														...
														value="0" class="easyui-numberbox" data-options="min:0,max:999,precision:2"
														required="true"<c:if test="${showMap.baseallowance!='baseallowance'}">
												...
												<td>
													<input type="text" style="width: 120px"
														...
														value="0"
														class="easyui-numberbox" data-options="min:0,max:999,precision:2"
														required="true" <c:if test="${showMap.singleallowance!='singleallowance'}">
													 readonly="readonly"  </c:if>/>
												</td>
											</tr>
											<tr>
												...
												<td>
													<input id="infoInfo-widget-bstype" name="lineInfo.carsubsidy"
														...
														class="easyui-numberbox" data-options="min:0,max:999,precision:2"
														required="true" <c:if test="${showMap.carsubsidy!='carsubsidy'}">
													 readonly="readonly"  </c:if>/>
												</td>
												<td width="120px">
													<div align="right">
												...
												<td>
													<input type="text" style="width: 120px"
														...
														value="0" class="easyui-numberbox" required="true" data-options="min:0,max:999,precision:2"<c:if test="${showMap.carallowance!='carallowance'}">
													 readonly="readonly"  </c:if>/>
												</td>
											</tr>
                                            <tr>
                                                ...
                                                <td style="width: 5px"></td>
                                                <td colspan="7">
                                                    <textarea name="lineInfo.remark" cols="" rows="2"
									...
									<table cellspacing="5px" cellpadding="5px" border="0">
										<tbody>
											<tr>
												...
												<td></td>
												<td width="120px">
													<input type="text" style="width: 120px" class="easyui-numberbox" 
													name="lineInfo.totalcars"	value="${lineInfo.totalcars}" readonly="readonly"/>
												</td>
												<td width="120px">
													<div align="right">
														出车家数总计:
												...
												<td>
													<input type="text" style="width: 120px" class="easyui-numberbox" 
													name="lineInfo.totalcarcustomers" 	value="${lineInfo.totalcarcustomers}" readonly="readonly"/>
												</td>
											</tr>
											<tr>
												<td>
												...
												<td style="width: 5px"></td>
												<td>
													<input type="text" style="width: 120px" data-options="min:0,max:999,precision:2" class="easyui-numberbox" 
														name="lineInfo.newamount" value="${lineInfo.newamount}" readonly="readonly"/>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<%--<form action="" method="post" id="line-form-define">--%>
							<%--<table border="0" cellpadding="2px" cellspacing="2px">--%>
								...
								<%--<tr>--%>
									...
									<%--</td>--%>
									<%--<td colspan="5">--%>
										<%--<input type="text" name="lineInfo.field10" style="width: 650px"--%>
											<%--<c:choose>--%>
								...
								<%--<tr>--%>
									...
									<%--</td>--%>
									<%--<td colspan="5">--%>
										<%--<input type="text" name="lineInfo.field11" style="width: 650px"--%>
											<%--<c:choose>--%>
								...
								<%--<tr>--%>
									...
									<%--</td>--%>
									<%--<td colspan="5">--%>
										<%--<input type="text" name="lineInfo.field12" style="width: 650px"--%>
											<%--<c:choose>--%>
                                ...
                                <%--<tr>--%>
                                    <%--<td><label></label> </td>--%>
                                    <%--<td colspan="5">--%>
                                        <%--<input type="text" name="lineInfo.field12" style="width: 675px;border: 2px solid snow;"--%>
                                                <%--<c:choose>--%>
                                                    <%--<c:when test="${showMap.field12==null}"> value=""</c:when>--%>
    	...
    	function addLineInfo(type){
    		var ret = lineInfo_AjaxConn(lineInfo_JSONs(),'basefiles/addLineInfo.do');
    		var retJson = $.parseJSON(ret);
    		loaded();
    		if(retJson.flag){
    	...
    	var id = $("#infoInfo-id-baseInfo").val();
		...
		function lineInfo_editEditSeq(){
   		...
   		function sortLineCustomerList(customerid,editseq,oldseq){
   			...
   			$.ajax({   
	            ...
	            type:'post',
	            dataType:'json',
	            data:{lineid:lineid,customerid:customerid,editseq:editseq,oldseq:oldseq},
    	...
    	$(function(){
    		...
    		$("#lineInfo-div-button").buttonWidget('initButtonType','add');
    		loadDropdown();
    		carNameSelect();
					  		...
					  		pagination:true,
				   			...
				   			toolbar : [ {
					                ...
					                handler : function() {
					                	...
					                	$.messager.confirm("警告","若删除,将真实清除数据,是否删除该车辆,?",function(r){
					                		if(r){
						                		for(var i=0;i<rows.length;i++){
						                			var index=$dgInfoCar.datagrid('getRowIndex',rows[i]);
						                			$dgInfoCar.datagrid('deleteRow',index);
						                		}
					                		}
					                	});
