    	...
    	<div id="goodsInfo-layout-detail-north" data-options="region:'north',border:false" style="height:102px">
    		<form id="goodsInfo-form-head" action="" method="post" style="padding: 3px">
				<table cellspacing="3px" cellpadding="3px" border="0">
					 <tbody>
					 	<tr>
							<td width="80px"><div align="right">商品编码:</div></td>
							<td style="width: 5px"></td>
						    <td><input id="goodsInfo-id-baseInfo" type="text" style="width: 120px;" name="goodsInfo.id" <c:if test="${editFlag==false}">readonly="readonly"</c:if> value="<c:out value="${goodsInfo.id}"></c:out>" class="easyui-validatebox" validType="validId[20]" required="true"/>
						    	...
						    	<input id="goodsInfo-dblclick-hdwaresClassid" type="hidden" name="goodsInfo.defaultsort" value="<c:out value="${goodsInfo.defaultsort}"></c:out>"/>
						   		...
						   		<input type="hidden" id="goodsInfo-barcode" value="<c:out value="${goodsInfo.barcode }"></c:out>"/>
						   		<input type="hidden" id="goodsInfo-boxbarcode" value="<c:out value="${goodsInfo.boxbarcode }"></c:out>"/>
							...
							<td style="width: 5px"></td>
						    <td><input type="text" id="goodsInfo-name-baseInfo" style="width: 200px;" name="goodsInfo.name" value="<c:out value="${goodsInfo.name}"></c:out>" class="easyui-validatebox" validType="validName[100]" required="true"/></td>
							<td width="80px"><div align="right">状态:</div></td>
							<td style="width: 5px"></td>
						    <td><input id="goodsInfo-widget-state" value="${goodsInfo.state}" disabled="disabled" style="width: 120px" /></td>
						</tr>
						<tr>
						...
						<table cellspacing="5px" cellpadding="5px" border="0">
						 	<tbody>
						 		<tr>
									...
									<td style="width: 5px"></td>
									<td><input type="text" name="goodsInfo.pinyin" value="<c:out value="${goodsInfo.pinyin }"></c:out>" style="width: 120px"/></td>
						  		...
						  		<tr>
									...
									<td style="width: 5px"></td>
								    <td><input id="goodsInfo-dblclick-waresClass" type="text" style="width: 120px;" value="<c:out value="${goodsInfo.defaultsortName}"></c:out>" readonly="readonly" class="easyui-validatebox" required="true"/></td>
						 		</tr>
								<tr>
									<td width="80px"><div align="right">条形码:</div></td>
									<td style="width: 5px"></td>
								    <td><input id="goodsInfo-name-barcode" type="text" style="width: 120px;" name="goodsInfo.barcode" value="<c:out value="${goodsInfo.barcode}"></c:out>" class="easyui-validatebox" required="true"/></td>
									<td width="80px"><div align="right">箱装条码:</div></td>
									<td style="width: 5px"></td>
								    <td><input id="goodsInfo-name-boxbarcode" type="text" style="width: 120px;" name="goodsInfo.boxbarcode" value="<c:out value="${goodsInfo.boxbarcode}"></c:out>" /></td>
									<td width="80px"><div align="right">商品货位:</div></td>
									<td style="width: 5px"></td>
								    <td><input id="goodsInfo-name-itemno" type="text" style="width: 120px;" name="goodsInfo.itemno" value="<c:out value="${goodsInfo.itemno}"></c:out>" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td style="width: 5px"></td>
								    <td><input id="goodsInfo-dblclick-storage" type="text" style="width: 120px;" value="<c:out value="${goodsInfo.storageName}"></c:out>" class="easyui-validatebox" required="true" readonly="readonly"/></td>
									<td width="80px"><div align="right">默认库位:</div></td>
									<td style="width: 5px"></td>
								    <td><input id="goodsInfo-dblclick-storagelocation" type="text" style="width: 120px;" value="<c:out value="${goodsInfo.storagelocationName}"></c:out>"/></td>
						 		</tr>
						  		<tr>
						...
						<table cellspacing="5px" cellpadding="5px" border="0">
						 	<tbody>
						 		<tr>
									...
									<td style="width: 5px"></td>
								    <td><input type="text" id="goodsInfo-numberbox-highestbuyprice"  style="width: 120px;" name="goodsInfo.highestbuyprice" class="easyui-numberbox" data-options="required:true,min:0,max:99999999,precision:6,groupSeparator:','" value="${goodsInfo.highestbuyprice}"/></td>
									<td width="100px"><div align="right">最低销售价:</div></td>
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.lowestsaleprice" class="easyui-numberbox" data-options="min:0,max:99999999,precision:6,groupSeparator:','" value="${goodsInfo.lowestsaleprice}"/>
								    </td>
									<td width="110px"><div align="right">基准销售价:</div></td>
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.basesaleprice" class="easyui-numberbox" data-options="required:true,min:0,max:99999999,precision:6,groupSeparator:','" value="${goodsInfo.basesaleprice}"/>
								    </td>
						  		</tr>
						  		<tr>
								...
								<tr>
									...
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.normalprice" class="easyui-numberbox" data-options="min:0,max:99999999,precision:6,groupSeparator:','" value="${goodsInfo.normalprice}"/>
								    </td>
								    ...
								    <td>
								    <span style="float: left;">
								    <input type="text" name="goodsInfo.checkdate" style="width:80px; float:left;" data-options="min:0,max:9999999999,groupSeparator:','">
								...
								<tr>
									...
									<td style="width: 5px"></td>
								    <td><input id="goodsInfo-widget-defaulttaxtype" type="text" style="width: 120px;" value="<c:out value="${goodsInfo.defaulttaxtype }"></c:out>" name="goodsInfo.defaulttaxtype"
								    	<c:choose>
											<c:when test="${showMap.defaulttaxtype==null}">disabled="disabled"</c:when>
										</c:choose>/>
								    </td>
									<td><div align="right">计划毛利率%:</div></td>
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" class="easyui-numberbox" value="${goodsInfo.planmargin}" name="goodsInfo.planmargin" data-options="min:0,max:999,precision:2"
								    	<c:choose>
											<c:when test="${showMap.planmargin==null}">readonly="readonly"</c:when>
										</c:choose>/>
								    </td>
									<td><div align="right">核算成本价:</div></td>
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" class="easyui-numberbox" value="${goodsInfo.costaccountprice}" name="goodsInfo.costaccountprice" data-options="min:0,max:99999999,precision:6,groupSeparator:','" value="${goodsInfo.costaccountprice}"/>
								    </td>
							  	</tr>
							  	<tr>
                                    ...
                                    <td style="width: 5px"></td>
                                    <td><input type="text" style="width: 120px;" value="${goodsInfo.field12 }" readonly="readonly" class="easyui-numberbox" data-options="precision:6,groupSeparator:','" /></td>
                                </tr>
						  </tbody>
						</table>
						...
						<table cellspacing="5px" cellpadding="5px" border="0">
							 <tbody>
								...
								<tr>
									...
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.gmlength" value="${goodsInfo.gmlength }" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:4,groupSeparator:','"></td>
								</tr>
								<tr>
									...
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.gmwidth" value="${goodsInfo.gmwidth }" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:4,groupSeparator:','"></td>
								</tr>
								<tr>
									...
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.gmhight" value="${goodsInfo.gmhight }" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:4,groupSeparator:','"></td>
								</tr>
								<tr>
								 	<td><div align="right">直径（m）:</div></td>
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.gdiameter" value="${goodsInfo.gdiameter }" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:4,groupSeparator:','"></td>
									<td><div align="right">直径转换因子（m）:</div></td>
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.gmdiameter" value="${goodsInfo.gmdiameter }" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:4,groupSeparator:','"></td>
								</tr>
								<tr>
									...
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.kgweight" value="${goodsInfo.kgweight}" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:4,groupSeparator:','"></td>
								</tr>
								<tr>
								 	<td><div align="right">净重（kg）:</div></td>
									<td style="width: 5px"></td>
								    <td><input type="text" style="width: 120px;" name="goodsInfo.netweight" value="${goodsInfo.netweight}" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:4,groupSeparator:','"></td>
								...
								<tr>
									<td width="80px"><div align="right">备注:</div></td>
									<td style="width: 5px"></td>
								    <td colspan="7"><textarea name="goodsInfo.physicsremark" cols="" rows="5" style="width:650px;"><c:out value="${goodsInfo.physicsremark}"></c:out></textarea></td>
								</tr> 
							</tbody>
						</table>
					</form>
					...
					<form action="" method="post" id="wares-form-goodsInfoDefineInfo" >
						<table border="0" cellpadding="2px" cellspacing="2px">
							...
							<tr>
								...
								<td colspan="5"><input type="text" name="goodsInfo.field10" style="width: 625px" class="easyui-validatebox"
									<c:choose>
							...
							<tr>
								...
								<td colspan="5"><input type="text" name="goodsInfo.field11" style="width: 625px" class="easyui-validatebox"
									<c:choose>
							...
							<tr>
								...
								<td colspan="5"><input type="text" name="goodsInfo.field12" style="width: 625px" class="easyui-validatebox"
									<c:choose>
    ...
    <script type="text/javascript">
		...
		$.extend($.fn.validatebox.defaults.rules, {
   			validId:{//编号唯一性,最大长度
   				validator:function(value,param){
   					if(value.length <= param[0]){
   						if($("#goodsInfo-hidden-oldId").val() == $("#goodsInfo-id-baseInfo").val()){
   							return true;
   						}
   			...
   			validName:{//名称唯一性,最大长度
   				validator:function(value,param){
   					if(value.length <= param[0]){
   						if($("#goodsInfo-name").val() == $("#goodsInfo-name-baseInfo").val()){
   							return true;
   						}
   			...
   			isRepeatBarcode:{//唯一性,最大长度
   				validator:function(value,param){
   					if(value.length <= param[0]){
   						if($("#goodsInfo-barcode").val() == $("#goodsInfo-name-barcode").val()){
   							return true;
   						}
   			...
   			isRepeatBoxbarcode:{//唯一性,最大长度
   				validator:function(value,param){
   					if(value.length <= param[0]){
   						if($("#goodsInfo-boxbarcode").val() == $("#goodsInfo-name-boxbarcode").val()){
   							return true;
   						}
   			...
   			priceInfoCode:{//唯一性,最大长度
   				validator:function(value,param){
   					return true;
   				},
   				message:''
   			},
   			priceInfoName:{//唯一性,最大长度
   				validator:function(value,param){
   					return true;
   				},
   				message:''
    	...
    	function editGoodsInfo(type){
    		$("#goodsInfo-hidden-addType").val(type);
    		var ret = goodsInfo_AjaxConn(goodsInfo_JSONs(),'basefiles/editGoodsInfo.do');
    		var retJson = $.parseJSON(ret);
    		if(!retJson.lockFlag){
    			$.messager.alert("提醒","该数据被其他人操作,暂不能修改!");
    			return false;
    		}
    		else if(!retJson.unEditFlag){
    			$.messager.alert("提醒","该数据不允许修改!");
    			return false;
    		}
    		else if(retJson.retFlag){
    	...
    	$(function(){
    		...
    		$("#goodsInfo-div-button").buttonWidget("setDataID",{id:$("#goodsInfo-hidden-oldId").val(),state:"${goodsInfo.state}",type:"edit"});
    		
    		$("#goodsInfo-div-button").buttonWidget("enableMenu","printMenuButton");
    		
    		var WCstr = $("#goodsInfo-dblclick-waresClass").val();//对应分类
    		var Storastr = $("#goodsInfo-dblclick-storage").val();//对应仓库
    		var SLStr = $("#goodsInfo-dblclick-storagelocation").val();//对应库位
    		if(WCstr == "" || WCstr == null){
    			$("#goodsInfo-dblclick-waresClass").val("请双击跳转对应分类标签!");
    		}
    		if(Storastr == "" || Storastr == null){
    			$("#goodsInfo-dblclick-storage").val("请双击跳转对应仓库标签!");
    		}
    		if(SLStr == "" || SLStr == null){
    			$("#goodsInfo-dblclick-storagelocation").val("请双击跳转对应库位标签!");
    		}
    		getTabs("edit");
    	});
    </script></em>
