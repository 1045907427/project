...
<body>
	    	...
	    	<div data-options="region:'north',border:false" style="height: 100px;">
	    		<table style="border-collapse:collapse;" border="0" cellpadding="5px" cellspacing="5px">
	    			...
	    			<tr>
	    			    <td>调价单名称：</td>
	    				<td>
	    					<input type="text" id="goods-adjustPrice-name" name="adjustPrice.name" value="${adjustPrice.name }"  style="width:160px;" />
	    				</td>
	    				<td class="len80 right">调价类型：</td>
	    				<td class="len165"><select id="goods-adjustPrice-type-select" name="adjustPrice.type"   disabled="disabled"  style="width:160px;">
	    		    ...
	    		    <tr>
	    				...
	    				<td colspan="3" style="text-align: left">
	    					<input type="text"  id="goods-adjustPrice-remark" name="adjustPrice.remark" value="${adjustPrice.remark}" style="width: 425px;" onfocus="frm_focus('adjustPrice.remark');" onblur="frm_blur('adjustPrice.remark');"/>
	    				</td>
	    			</tr>
	    			<tr>
	    		</table>
    ...
    <script type="text/javascript">
    	...
    	//控制按钮状态
    	$("#goods-buttons-adjustPricePage").buttonWidget("setDataID",{id:'${adjustPrice.id}',state:'${adjustPrice.status}',type:'edit'});
    </script>
</body>
