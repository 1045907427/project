  			...
  			<form action="basefiles/addGoodsInfoShortcut.do" method="post" id="goodssimplify-form-add">
		    	...
		    	<table cellpadding="1" cellspacing="1" border="0" >
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input id="goodsSimplify-widget-defaultsort" style="width: 135px" value="<c:out value="${goodsInfo.defaultsort }"></c:out>" type="text" name="goodsInfo.defaultsort"/><c:if test="${colMap.defaultsort == 'defaultsort' }"><font color="red">*</font></c:if></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input id="goodsSimplify-supplierWidget" type="text" name="goodsInfo.defaultsupplier" value="${goodsInfo.defaultsupplier }" text="${goodsInfo.defaultsupplierName }" style="width: 135px;"/><c:if test="${colMap.defaultsupplier == 'defaultsupplier' }"><font color="red">*</font></c:if></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input id="goodsSimplify-widget-storage" type="text" name="goodsInfo.storageid" value="${goodsInfo.storageid }"/><c:if test="${colMap.storageid == 'storageid' }"><font color="red">*</font></c:if></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><span style="float: left;">
									    ...
									    <select name="goodsInfo.shelflifeunit" class="easyui-combobox" style="width:60px; float:left;">
		    		...
		    		<div>
		   				<c:forEach var="list" items="${priceList}" varStatus="status">
							...
							<td align="left"><input id="goodsSimplify-numberbox-taxprice-${status.index}" name="priceInfoList[${status.index}].taxprice" type="text" style="width: 65px;"/>-<input id="goodsSimplify-numberbox-boxprice-${status.index}" name="priceInfoList[${status.index}].boxprice" type="text" style="width: 65px;"/><c:if test="${status.index == 0 || status.index == 1 || status.index == 2}"><font color="red">*</font></c:if>
