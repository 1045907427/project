	    	...
	    	<form action="" method="post" id="wares-add-goodsShortcut">
		    	...
		    	<table cellpadding="1" cellspacing="1" border="0">
		    		<tr>
		    			...
		    			<td align="left"><input id="wares-id-goodsShortcut" name="goodsInfo.id" type="text" <c:if test="${editFlag==false}">readonly="readonly"</c:if> style="width: 130px" maxlength="20" class="easyui-validatebox" validType="validId[20]" value="<c:out value="${goodsInfo.id }"></c:out>"/><font color="red">*</font></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left" colspan="3"><input id="wares-name-goodsShortcut" name="goodsInfo.name" type="text" style="width: 356px" maxlength="100" value="<c:out value="${goodsInfo.name }"></c:out>"/><font color="red">*</font></td>
		    		...
		    		<tr>
						...
						<td align="left"><input type="text" name="goodsInfo.pinyin" style="width: 130px" value="<c:out value="${goodsInfo.pinyin }"></c:out>"/></td>
		    		...
		    		<tr>
						...
						<td align="left"><input id="goodsInfo-name-itemno" type="text" style="width: 130px;" name="goodsInfo.itemno" value="<c:out value="${goodsInfo.itemno }"></c:out>"/></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><select name="goodsInfo.goodstype" style="width: 136px;" class="easyui-validatebox" required="true">
		    				<option></option>
		    		...
		    		<tr>
    					...
    					<td align="left"><input type="text" id="goodsInfo-numberbox-glength" style="width: 130px;" name="goodsInfo.glength" value="${goodsInfo.glength }"></td>
		    			<td align="right">高度(m):</td>
		    			<td align="left"><input type="text" id="goodsInfo-numberbox-ghight" style="width: 130px;" name="goodsInfo.ghight" value="${goodsInfo.ghight }"></td>
		    			<td align="right">宽度(m):</td>
		    			<td align="left"><input type="text" id="goodsInfo-numberbox-gwidth" style="width: 130px;" name="goodsInfo.gwidth" value="${goodsInfo.gwidth }"></td>
		    		</tr>
		    		<tr>
		    			<td align="right">箱重(kg):</td>
		    			<td align="left"><input type="text" style="width: 130px;" name="goodsInfo.totalweight" value="${goodsInfo.totalweight }" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:6,groupSeparator:','"></td>
		    			<td align="right">箱体积(m<sup>3</sup>):</td>
		    			<td align="left"><input type="text" id="goodsInfo-numberbox-totalvolume" style="width: 130px;" name="goodsInfo.totalvolume" value="${goodsInfo.totalvolume }" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:6,groupSeparator:','"></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><select name="goodsInfo.bstype" style="width: 136px;">
		    				<option></option>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input type="text" id="goodsInfo-numberbox-newbuyprice" class="easyui-numberbox no_input" data-options="min:0,max:999999999999,precision:6,groupSeparator:','" name="goodsInfo.newbuyprice" style="width: 130px" readonly="readonly" value="${goodsInfo.newbuyprice}"/></td>
		    			<td align="right">最新销售价:</td>
		    			<td align="left"><input type="text" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:6,groupSeparator:','" name="goodsInfo.newsaleprice" style="width: 130px" disabled="disabled" value="${goodsInfo.newsaleprice}"/></td>
		    		</tr>
		    		<tr>
     	...
     	$(function(){
			...
			$.extend($.fn.validatebox.defaults.rules, {
	   			validId:{//编号唯一性,最大长度
	   				validator:function(value,param){
	   					if(value.length <= param[0]){
	   						if($("#goodsInfo-oldid").val() == $("#wares-id-goodsShortcut").val()){
	   							return true;
	   						}
	   			...
	   			validName:{//名称唯一性,最大长度
	   				validator:function(value,param){
	   					if(value.length <= param[0]){
	   						if($("#goodsInfo-name").val() == $("#wares-name-goodsShortcut").val()){
	   							return true;
	   						}
     		...
     		$("#goodsShortcut-save-brandtogoods").click(function(){
     			...
     			$.messager.confirm("提醒","是否修改商品?",function(r){
					if(r){
						loading("提交中..");
 						var ret = goodsShortcut_AjaxConn($("#wares-add-goodsShortcut").serializeJSON(),'basefiles/editGoodsInfoShortcut.do');
    					var retJson = $.parseJSON(ret);
    					if(retJson.flag){
