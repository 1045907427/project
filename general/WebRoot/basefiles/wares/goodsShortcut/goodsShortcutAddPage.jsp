	    	...
	    	<form action="" method="post" id="wares-add-goodsShortcut">
		    	<table cellpadding="1" cellspacing="1" border="0">
		    		<tr>
		    			...
		    			<td align="left"><input name="goodsInfo.id" type="text" style="width: 130px" maxlength="20" class="easyui-validatebox" validType="validId[20]" required="true"/><font color="red">*</font></td>
		    			<td width="80px" align="right">助记符:</td>
		    			<td align="left"><input name="goodsInfo.spell" type="text" style="width: 130px" maxlength="20"/><font color="red">*</font></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left" colspan="3"><input name="goodsInfo.name" type="text" style="width: 356px" class="easyui-validatebox" validType="validName[100]" required="true" maxlength="100"/><font color="red">*</font></td>
		    			<td align="right">默认分类:</td>
		    			<td align="left"><input id="goodsShortcut-widget-defaultsort" type="text" name="goodsInfo.defaultsort" style="width: 130px"/><font color="red">*</font></td>
		    		</tr>
		    		<tr>
		    			<td align="right">名称拼音:</td>
						<td align="left"><input type="text" name="goodsInfo.pinyin" style="width: 130px"/></td>
		    			<td align="right">规格型号:</td>
		    			<td align="left"><input name="goodsInfo.model" type="text" style="width: 130px" maxlength="200"/></td>
		    			<td align="right">条形码:</td>
		    			<td align="left"><input name="goodsInfo.barcode" type="text" style="width: 130px" maxlength="50" class="easyui-validatebox" required="true"/><font color="red">*</font></td>
		    		</tr>
		    		<tr>
		    			<td align="right">箱装条形码:</td>
						<td align="left"><input type="text" style="width: 130px;" name="goodsInfo.boxbarcode" maxlength="50"/></td>
		    			<td align="right">商品货位:</td>
						<td align="left"><input type="text" style="width: 130px;" name="goodsInfo.itemno" /></td>
		    			<td align="right">辅单位:</td>
		    			<td align="left"><input id="goodsShortcut-widget-meteringunitid" type="text" name="goodsMUInfo.meteringunitid" style="width: 130px"/></td>
		    		</tr>
		    		<tr>
		    			<td align="right">箱装量:</td>
		    			<td align="left"><input id="goodsInfo-numberbox-rate" name="goodsMUInfo.rate" type="text" style="width: 130px"/><font color="red">*</font></td>
		    			<td align="right">单位:</td>
		    			<td align="left"><input id="goodsShortcut-widget-mainunit" type="text" name="goodsInfo.mainunit" style="width: 130px"/><font color="red">*</font></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input id="goodsShortcut-widget-defaulttaxtype" type="text" style="width: 130px;" name="goodsInfo.defaulttaxtype" value="${defaulttaxtype }"/></td>
		    		</tr>
		    		<tr>
		    			<td align="right">商品品牌:</td>
		    			<td align="left"><input id="goodsShortcut-widget-brand" type="text" style="width: 130px;" name="goodsInfo.brand"/><font color="red">*</font></td>
		    			<td align="right">所属部门:</td>
		    			<td align="left"><input id="goodsShortcut-widget-deptid" type="text" style="width: 130px;" name="goodsInfo.deptid"/><font color="red">*</font></td>
		    			<td align="right">默认供应商:</td>
		    			<td align="left"><input id="goodsShortcut-supplierWidget-defaultsupplier" type="text" name="goodsInfo.defaultsupplier" style="width: 130px"/><font color="red">*</font></td>
		    		</tr>
		    		<tr>
		    			<td align="right">采购价:</td>
		    			<td align="left"><input type="text" id="goodsInfo-numberbox-highestbuyprice" name="goodsInfo.highestbuyprice" style="width: 130px"/><font color="red">*</font></td>
		    			<td align="right">基准销售价:</td>
		    			<td align="left"><input type="text" class="easyui-numberbox" data-options="required:true,min:0,max:999999999999,precision:6,groupSeparator:','" name="goodsInfo.basesaleprice" style="width: 130px"/></td>
		    			<td align="right">计划毛利率%:</td>
		    			<td align="left"><input type="text" class="easyui-numberbox" data-options="min:0,max:999,precision:2,groupSeparator:','" name="goodsInfo.planmargin" style="width: 130px"/></td>
		    		</tr>
		    		<tr>
		    			<td align="right">采购箱价:</td>
		    			<td align="left"><input type="text" id="goodsInfo-numberbox-buyboxprice" name="goodsInfo.buyboxprice" style="width: 130px"/></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input id="goodsShortcut-widget-storage" type="text" style="width: 130px;" name="goodsInfo.storageid"/><font color="red">*</font></td>
		    			<td align="right">默认库位:</td>
		    			<td align="left"><input id="goodsShortcut-widget-storagelocation" type="text" style="width: 130px;" name="goodsInfo.storagelocation"/></td>
		    			...
		    			<td align="left"><div id="goodsShortcut-div-boxnum" style="visibility: hidden;">
		    				<input id="goodsShortcut-numberbox-boxnum" type="text" style="width: 130px;" name="goodsInfo.slboxnum"/>
		    			</div></td>
		    		</tr>
		    		<tr>
		    			<td align="right">保质期管理:</td>
		    			<td align="left"><select name="goodsInfo.isshelflife" style="width: 130px;">
		    				<option></option>
		    			...
		    			<td align="left"><span style="float: left;">
						    	<input type="text" name="goodsInfo.shelflife" style="width:85px; float:left;" class="easyui-numberbox" data-options="min:0,max:9999999999,groupSeparator:','"/>
		    		...
		    		<tr>
		    			...
		    			<td align="left"><input type="text" class="easyui-numberbox" data-options="min:0,max:999999999999,precision:6,groupSeparator:','" name="goodsInfo.normalprice" style="width: 130px"/></td>
		    		...
		    		<tr>
		    			...
		    			<td align="left" colspan="5"><input name="goodsInfo.remark" type="text" style="width: 590px" maxlength="200"/><font color="red">*</font></td>
		    		</tr>
	    			<c:forEach var="list" items="${priceList}" varStatus="status">
	    				<c:if test="${(status.index)%3==0}">
							...
							<td align="left"><input name="priceInfoList[${status.index}].taxprice" type="text" class="easyui-numberbox" data-options="<c:if test="${status.index == 0 || status.index == 1 || status.index == 2}">required:true,</c:if>min:0,max:999999999999,precision:4,groupSeparator:','" style="width: 130px"/><c:if test="${status.index == 0 || status.index == 1 || status.index == 2}"><font color="red">*</font></c:if>
