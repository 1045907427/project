...
<body>
<%--<div id="sales-queryDiv-goodsToOrderPage" style="height:auto;padding:0px">--%>
    <%--<div class="buttonBG" id="sales-buttons-goodsToOrderPage"></div>--%>
    <%--<form id="sales-queryForm-goodsToOrderPage" method="post">--%>
       <%----%>
    <%--</form>--%>
<%--</div>--%>
<div id="sales-goodsToOrderPage-layout" class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center'">
        <table id="sales-datagrid-goodsToOrderPage" data-options="border:false"></table>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var $goodslist = $('#sales-datagrid-goodsToOrderPage');
    function endEditing(){
...
//        }
    ...
    var initQueryJSON = $("#sales-queryForm-goodsToOrderPage").serializeJSON();
    $(function () {
        $("#sales-datagrid-goodsToOrderPage").datagrid({
            fit: true,
            method: 'post',
            rownumbers: true,
            pagination: false,
...
//                {field: 'notorderbox', title: '未生成订单箱数', width: 35, align: 'left',hidden:true},
    ...
    function addOrder(){
        var rows = $("#sales-datagrid-goodsToOrderPage").datagrid('getChecked');
        if(rows.length==0){
        ...
        $.ajax({
            ...
            async:false,
            data:{
                id:$("#sales-id-orderGoodsAddPage").val(),
            ...
            success:function(json){
                if(json.flag){
                    ...
                    $('#sales-addorder-orderGoodsPage-content').dialog("close");
                }else{
