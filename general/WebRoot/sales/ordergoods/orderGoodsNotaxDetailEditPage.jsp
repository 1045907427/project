...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center',border:false">
        <form id="sales-form-orderGoodsDetailEditPage">
            <table cellpadding="5" cellspacing="2">
                <tr>
                    <td class="len80">选择商品：</td>
                    <td>
                        <input type="text" id="sales-goodsId-orderGoodsDetailAddPage" class="len150" />
                        <input type="hidden" name="goodsid" id="goodsid" />
                        <input type="hidden" name="brandid" />
                        <input id="sales-usablenum-orderGoodsDetailAddPage" type="hidden" name="usablenum"/>
                ...
                <tr>
                    <td>数量：</td>
                    <td><input type="text" class="formaterNum easyui-validatebox len150" value="0" name="unitnum" onfocus="this.select();frm_focus('unitnum');" onblur="frm_blur('unitnum');" data-options="required:true,validType:'intOrFloatNum[${decimallen}]'" /></td>
                    <td>辅数量：</td>
                    <td><input type="text" name="auxnum" class="formaterNum easyui-validatebox" value="0" style="width:60px;" onfocus="this.select();frm_focus('auxnum');" onblur="frm_blur('auxnum');" data-options="validType:'integer'" /><span id="sales-auxunitname-orderGoodsDetailAddPage"></span>
                        <input type="text" name="overnum" class="formaterNum easyui-validatebox" value="0" style="width:60px;" onfocus="this.select();frm_focus('overnum');" onblur="frm_blur('overnum');" data-options="validType:'intOrFloatNum[${decimallen}]'" /><span id="sales-unitname-orderGoodsDetailAddPage"></span>
                    </td>
                </tr>
                <%--<tr>--%>
                    <%--<td>原价：</td>--%>
                    <%--<td><input type="text" class="len150 easyui-validatebox" name="oldtaxprice"  id="sales-oldtaxprice-orderGoodsDetailAddPage" required="required" validType="intOrFloat" readonly="readonly" /> </td>--%>
                <%--</tr>--%>
                <tr>
                    <td colspan="2">原价：
                        <input type="text" style="width: 55px;" class="easyui-validatebox" name="oldtaxprice"  id="sales-oldtaxprice-orderGoodsDetailAddPage" required="required" validType="intOrFloat" readonly="readonly" />
                        含税单价：
                        <input type="text" style="width: 65px;" class="easyui-validatebox <c:if test="${colMap.taxprice == null }">readonly</c:if>" name="taxprice" onfocus="this.select();frm_focus('taxprice');" onblur="frm_blur('taxprice');" id="sales-taxprice-orderGoodsDetailAddPage" required="required" validType="intOrFloat" <c:if test="${colMap.taxprice == null }">readonly="readonly"</c:if> />
                    </td>
                    <%--<td><input type="text" class="len50 easyui-validatebox" name="oldtaxprice"  id="sales-oldtaxprice-orderGoodsDetailAddPage" required="required" validType="intOrFloat" readonly="readonly" /> </td>--%>
                    <%--<td>含税单价：</td>--%>
                    <%--<td><input type="text" class="len50 easyui-validatebox <c:if test="${colMap.taxprice == null }">readonly</c:if>" name="taxprice" onfocus="this.select();frm_focus('taxprice');" onblur="frm_blur('taxprice');" id="sales-taxprice-orderGoodsDetailAddPage" required="required" validType="intOrFloat" <c:if test="${colMap.taxprice == null }">readonly="readonly"</c:if> /> </td>--%>
                    <td>含税金额：</td>
                ...
                <tr>
                    <td>税种：</td>
                    <td><input type="text" class="len150 readonly" name="taxtypename" readonly="readonly" /><input type="hidden" name="taxtype" /> </td>
                    <td>税额：</td>
                    <td><input type="text" class="len150 readonly no_input easyui-numberbox" id="sales-tax-orderGoodsDetailAddPage" readonly="readonly" name="tax" data-options="precision:6,groupSeparator:','" /></td>
                </tr>
                <tr>
                    <td>单位：</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="sales-storageid-orderGoodsDetailAddPage" type="text" name="storageid" />
                        <input id="sales-storagename-orderGoodsDetailAddPage" type="hidden" name="storagename" />
                ...
                <tr>
                    ...
                    <td>备注：</td>
                    <td><input id="remark" type="text" style="width: 150px;" name="remark" onfocus="frm_focus('remark');" onblur="frm_blur('remark');"  /></td>
                </tr>
            </table>
            ...
            <input type="hidden" id="sales-isbatch-orderGoodsDetailAddPage" value="${isbatch}"/>
        </form>
    </div>
    <div data-options="region:'south',border:false">
        <div class="buttonDetailBG" style="height:30px;text-align:right;">
            快捷键<span style="font-weight: bold;color: red;">Ctrl+Enter</span>或者<span style="font-weight: bold;color: red;">+</span>
            <input type="button" value="确定" name="savegoon" id="sales-savegoon-orderGoodsDetailAddPage" />
        </div>
    </div>
</div>
<script type="text/javascript">
    ...
    $(function(){
        $("#sales-goodsId-orderGoodsDetailAddPage").goodsWidget({
            name:'t_sales_goodsorder_detail',
            col:'goodsid',
            width:150,
            required:true,
            canBuySale:"2",
            ...
            onSelect: function(data){
                ...
                $("input[name=buyprice]").val(data.highestbuyprice);
                ...
                $.ajax({
                    ...
                    success:function(json){
                        ...
                        $("input[name=taxtype]").val('02');
                        $("input[name=taxtypename]").val('免税');
                        $("input[name=taxprice]").val(json.detail.notaxprice);
                        ...
                        if(deliverytype=='1' && presentByZero==0){
                            ...
                            $("#sales-oldtaxprice-orderGoodsDetailAddPage").val(json.detail.notaxprice);
                            $("#sales-taxprice-orderGoodsDetailAddPage").val(json.detail.taxprice);
                            $("#sales-boxprice-orderGoodsDetailAddPage").val((json.detail.notaxprice*data.boxnum).toFixed(6));
                            $("#sales-taxamount-orderGoodsDetailAddPage").val(json.detail.notaxamount);
            ...
            if(hasFree=="1"){
                ...
                $.messager.confirm("提醒","该商品符合满赠条件，是否赠送?",function(r){
                    if(r){
                        ...
                        showFullFreePage(orderid,customerid,goodsid,num,"edit");
                    }else{
                        $("#sales-saveDetailFlag-orderGoodsDetailAddPage").val("2");
    ...
    function unitnumChange(type){ //数量改变方法
        ...
        var url = "";
        var data = "";
        var boxnum=$("#sales-boxnum-orderGoodsDetailAddPage").val();
        if(type == 1){
        ...
        $.ajax({
            ...
            success:function(json){
                ...
                $("#sales-notaxamount-orderGoodsDetailAddPage").val(json.taxamount);
                $("#sales-taxprice-orderGoodsDetailAddPage").val(json.taxprice);
                $("#sales-boxprice-orderGoodsDetailAddPage").val((json.taxprice*boxnum).toFixed(6));
                $("#sales-notaxprice-orderGoodsDetailAddPage").val(json.taxprice);
                $("#sales-tax-orderGoodsDetailAddPage").numberbox('setValue',0);
