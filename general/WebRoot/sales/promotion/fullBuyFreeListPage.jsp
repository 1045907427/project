...
$(function(){
    ...
    $("#sales-buttons-promotionListPage").buttonWidget({
        initButton:[
            ...
            <security:authorize url="/sales/promoAddPage.do">
            {
                type: 'button-add',
                handler: function(){
                    top.addTab('sales/promotionPage.do?act=3', "满赠活动新增");
                }
            },
            </security:authorize>
            <security:authorize url="/sales/promotionViewPage.do">
            {
                ...
                handler: function(){
                    ...
                    top.addOrUpdateTab('sales/promotionPage.do?type=edit&act=3&id='+con.id, '满赠活动查看');
                }
            },
            </security:authorize>
        ...
        buttons:[
            ...
            <security:authorize url="/sales/promotionCancelBtn.do">
            {
                ...
                handler:function() {
                    ...
                    $.messager.confirm("提醒","确定作废选中的满赠促销信息？",function(r){
                        if(r){
    ...
    //表头标题
    var promotionSaleJson = $("#sales-datagrid-promotionListPage").createGridColumnLoad({
        name :'t_sales_promotion_package',
        frozenCol : [[
    ...
    $("#sales-datagrid-promotionListPage").datagrid({
        authority:promotionSaleJson,
        frozenColumns:promotionSaleJson.frozen,
        columns:promotionSaleJson.common,
        fit:true,
        title:"",
        method:'post',
        rownumbers:true,
        ...
        checkOnSelect:true,
        selectOnCheck:true,
        url: 'sales/getPromotionList.do?ptype=3',
        queryParams:queryJSON,
        toolbar:'#sales-queryDiv-promotionListPage',
        onDblClickRow:function(index, data){
            top.addOrUpdateTab('sales/promotionPage.do?type=edit&act=3&id='+data.id, '满赠活动查看');
        }
