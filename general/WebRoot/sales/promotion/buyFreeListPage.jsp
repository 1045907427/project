            ...
            <form id="sales-queryForm-promotionListPage">
                <table class="querytable">
                    ...
                    <tr>
                        ...
                        <td>客户群名称：</td>
                        <td id="customertd"><input type="text" id="sales-customer-promotionListPage"  style="width:183px" name="customerid" /></td>
                        <td rowspan="3" colspan="2" class="tdbutton" style="padding-left: 2px">
...
$(function(){
    ...
    $("#sales-resetQueay-promotionListPage").click(function(){
        ...
        $("#sales-customertype-promotionListPage").val();
        $("#sales-customer-promotionListPage").widget("clear");
	...
	$("#sales-buttons-promotionListPage").buttonWidget({
		initButton:[
					...
					<security:authorize url="/sales/promoAddPage.do">
					{
						type: 'button-add',
						handler: function(){
							top.addTab('sales/promotionPage.do?act=1', "买赠活动新增");
						}
					},
					</security:authorize>
					<security:authorize url="/sales/promotionViewPage.do">
					{
						...
						handler: function(){
                            ...
                            top.addOrUpdateTab('sales/promotionPage.do?type=edit&act=1&id='+con.id, '买赠活动查看');
						}
					},
					</security:authorize>
        ...
        buttons:[
            ...
            <security:authorize url="/sales/promotionCancelBtn.do">
            {
                ...
                handler:function() {
                    ...
                    $.messager.confirm("提醒","确定作废选中的买赠促销信息？",function(r){
                       if(r){
    ...
    //表头标题
    var buyFreeSaleJson = $("#sales-datagrid-promotionListPage").createGridColumnLoad({
		name :'t_sales_promotion_package',
        frozenCol : [[
	...
	$("#sales-datagrid-promotionListPage").datagrid({ 
 		authority:buyFreeSaleJson,
 		frozenColumns:buyFreeSaleJson.frozen,
		columns:buyFreeSaleJson.common,
 		fit:true,
 		title:"",
 		method:'post',
 		rownumbers:true,
        ...
        checkOnSelect:true,
        selectOnCheck:true,
		url: 'sales/getPromotionList.do?ptype=1',
        queryParams:queryJSON,
		toolbar:'#sales-queryDiv-promotionListPage',
	    onDblClickRow:function(index, data){
			top.addOrUpdateTab('sales/promotionPage.do?type=edit&act=1&id='+data.id, '买赠活动查看');
    	}
