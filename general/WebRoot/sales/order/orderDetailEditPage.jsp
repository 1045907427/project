...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center',border:false">
        <form id="sales-form-orderDetailEditPage">
            <table cellpadding="5" cellspacing="2">
                <tr>
                    <td class="len80">选择商品：</td>
                    <td>
                        <input type="text" id="sales-goodsId-orderDetailAddPage" class="len150" />
                        <input type="hidden" name="goodsid" id="goodsid" />
                        <input type="hidden" name="brandid" />
                        <input id="sales-usablenum-orderDetailAddPage" type="hidden" name="usablenum"/>
                ...
                <tr>
                    ...
                    <td>辅数量：</td>
                    <td><input type="text" name="auxnum" class="formaterNum easyui-validatebox" value="0" style="width:60px;" onfocus="this.select();frm_focus('auxnum');" onblur="frm_blur('auxnum');" data-options="validType:'integer'" /><span id="sales-auxunitname-orderDetailAddPage"></span>
                        <input type="text" name="overnum" class="formaterNum easyui-validatebox" value="0" style="width:60px;" onfocus="this.select();frm_focus('overnum');" onblur="frm_blur('overnum');" data-options="validType:'intOrFloatNum[${decimallen}]'" /><span id="sales-unitname-orderDetailAddPage"></span>
                    </td>
                </tr>
                <tr>
                    <td>含税单价：</td>
                ...
                <tr>
                    ...
                    <td>税额：</td>
                    <td><input type="text" class="len150 readonly no_input easyui-numberbox" id="sales-tax-orderDetailAddPage" readonly="readonly" name="tax" data-options="precision:6,groupSeparator:','" /></td>
                </tr>
                <tr>
                    <td>单位：</td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input id="sales-storagename-orderDetailAddPage" type="hidden" name="storagename" />
            ...
            <input type="hidden" id="sales-isbatch-orderDetailAddPage" value="${isbatch}"/>
    ...
    <div data-options="region:'south',border:false">
        <div class="buttonDetailBG" style="height:30px;text-align:right;">
            ...
            <input type="button" value="确定" name="savegoon" id="sales-savegoon-orderDetailAddPage" />
        </div>
    </div>
</div>
