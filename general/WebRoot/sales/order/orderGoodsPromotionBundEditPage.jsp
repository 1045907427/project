...
<div class="easyui-layout" data-options="fit:true">
                    ...
                    <tr>
                        ...
                        <c:choose>
                            <c:when test="${promotionPackageGroup.remainnum>0 && promotionPackageGroup.limitnum>0}">
                                <td><input id="sales-unitnum-orderGoodsPromotionBundAddPage" class="formaterNum easyui-validatebox len150 goodsNum" value="0" data-options="required:true,validType:['intOrFloatNum[${decimallen}]','max[${promotionPackageGroup.remainnum}]']" /></td>
                            </c:when>
                            <c:otherwise>
                                <td><input id="sales-unitnum-orderGoodsPromotionBundAddPage" class="formaterNum easyui-validatebox len150 goodsNum" value="0" data-options="required:true,validType:'intOrFloatNum[${decimallen}]'" /></td>
                            </c:otherwise>
                        </c:choose>
                    </tr>
                    <tr>
                        <td>含税金额：</td>
                        <td><input class="len150 readonly easyui-numberbox" id="sales-taxamount-orderGoodsPromotionBundAddPage" data-options="precision:6,groupSeparator:','" readonly="readonly" /></td>
                        <td>未税金额：</td>
                        <td><input class="len150 readonly easyui-numberbox" id="sales-notaxamount-orderGoodsPromotionBundAddPage" readonly="readonly"  data-options="precision:6,groupSeparator:','" /></td>
                    </tr>
                    <tr>
                        <td>备注：</td>
    ...
    <div data-options="region:'south',border:false">
        <div class="buttonDetailBG" style="height:30px;text-align:right;">
            <input type="button" value="保存" name="savegoon" id="sales-savegoon-orderGoodsPromotionBundAddPage" />
        </div>
    </div>
</div>
...
$(function(){
    ...
    $("#sales-savegoon-orderGoodsPromotionBundAddPage").click(function(){
        setTimeout(editSaveBundNumDetail(),200);
    });
});
function giveunitnumChange(){ //数量改变方法
    ...
    function editSaveBundNumDetail(){
        var groupid =$("#sales-groupid-orderGoodsPromotionBundAddPage").val();
