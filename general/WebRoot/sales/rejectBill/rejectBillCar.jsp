    ...
    $(function () {
        ...
        $("#sales-buttons-rejectBill").buttonWidget({
            initButton: [
                ...
                <security:authorize url="/sales/rejectBillCarSave.do">
                {
                    type: 'button-save',
                    handler: function () {
                ...
                <security:authorize url="/sales/rejectBillSaveAudit.do">
                {
                    ...
                    handler: function () {
                        $.messager.confirm("提醒", "确定保存退货通知单？", function (r) {
                            if (r) {
                                var json = $("#sales-datagrid-rejectBillAddPage").datagrid('getRows');
                                $("#sales-goodsJson-rejectBillAddPage").val(JSON.stringify(json));
                                $('#sales-form-rejectBillAddPage').form('submit', {
                                    url: 'sales/updateRejectBillCarAudit.do',
                                    onSubmit: function () {
                    ...
                    handler: function () {
                        ...
                        $.messager.confirm("提醒", "确定审核该退货通知单信息？", function (r) {
                            if (r) {
                                loading("审核中..");
                                $.ajax({
                                    url: 'sales/auditRejectBillCar.do',
                                    dataType: 'json',
                                    type: 'post',
                                    data: 'id=' + id,
                                    success: function (json) {
                                        ...
                                        if (json.flag) {
                                            ...
                                            //刷新车销退货申请列表
                                            tabsWindowURL("/sales/rejectBillCarListPage.do").$("#sales-datagrid-rejectBillListPage").datagrid('reload');
                                            //关闭当前标签页
                                            top.closeNowTab();
                                        }
                                        else {
                ...
                <security:authorize url="/sales/oppauditRejectBillCar.do">
                {
                    ...
                    handler: function () {
                        ...
                        $.messager.confirm("提醒", "确定反审该退货通知单信息？", function (r) {
                            if (r) {
                                loading("反审中..");
                                $.ajax({
                                    url: 'sales/oppauditRejectBillCar.do',
                                    dataType: 'json',
                                    type: 'post',
                                    data: 'id=' + id + '&type=2',
                                    success: function (json) {
                ...
                <security:authorize url="/sales/rejectBillCarBack.do">
                {
                    type: 'button-back',
                ...
                <security:authorize url="/sales/rejectBillCarNext.do">
                {
                    type: 'button-next',
                    handler: function (data) {
                        $("#sales-backid-rejectBill").val(data.id);
            ...
            type: 'view',
            tab: '车销退货申请单列表',
            taburl: '/sales/rejectBillCarListPage.do',
            id: '${id}',
