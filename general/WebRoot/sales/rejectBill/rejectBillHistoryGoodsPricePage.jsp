...
<body>
    <table id="rejectBill-goods-history-price-dialog"></table>
    <script type="text/javascript">
        var historyPriceListJson = $("#rejectBill-goods-history-price-dialog").createGridColumnLoad({ //以下为商品明细datagrid字段
            commonCol: [[
        ...
        $(function(){
            $("#rejectBill-goods-history-price-dialog").datagrid({ //销售商品明细信息编辑
