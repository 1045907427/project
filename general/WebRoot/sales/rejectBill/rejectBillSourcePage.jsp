  ...
  <body>
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'north',split:true,border:false" style="height:260px">
			<table id="sales-billDatagrid-rejectBillSourcePage"></table>
		</div>
		<div data-options="region:'center',border:false">
			<table id="sales-detailDatagrid-rejectBillSourcePage"></table>
		</div>
	</div>
	<script type="text/javascript">
		$(function(){
			$("#sales-detailDatagrid-rejectBillSourcePage").datagrid({
				columns:[[	
