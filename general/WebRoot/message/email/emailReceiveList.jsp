					...
					<div>
						...
						<form action="" id="messageEmail-form-emailReceivePreviewList" method="post">
                            <table class="querytable">
                                <tr>
                                    <td>发件人：</td>
                                    <td><input id="messageEmail-form-emailReceivePreviewList-sender" name="senduserid" style="width:200px"></td>
                                    <td>标题内容：</td>
                                    <td><input name="msgctlecont" style="width:200px"></td>
                                </tr>
                                <tr>
                                    <td>
                                        接收时间：
	...
	<div style="display:none">
		...
		$(document).ready(function(){
			...
			$("#messageEmail-emailReceivePreviewList-btn-reloadEmailList").click(function(){
			    $("#messageEmail-form-emailReceivePreviewList-sender").widget("clear");
            ...
            //收件人
            $("#messageEmail-form-emailReceivePreviewList-sender").widget({
                name: 'msg_emailcontent',
                col: 'adduserid',
                singleSelect: true,
                width: 200,
