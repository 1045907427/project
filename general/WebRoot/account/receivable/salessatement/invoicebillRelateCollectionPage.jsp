...
<html>
  <head>
    <title>销售开票关联收款单</title>
  </head>
  
  <body>
  	<div id="account-relateCollectionOrder-toolbar">
   		<form action="account/receivable/addInvoiceBillRelateCollectionOrder.do" method="post" id="account-form-relateCollectionOrder">
   		<table  border="0" class="box_table">
   			<tr>
   				<td>编号:</td>
   				<td>
   					<input type="text" width="180" class="no_input" readonly="readonly" name="billid" value="${billid }"/>
   			...
   			$("#account-relateCollectionOrder-table").datagrid({
   				columns:[[
							  ...
							  {field:'tailcontrol',title:'尾差控制',resizable:true,align:'right',align:'right',
							  	formatter:function(value,rowData,rowIndex){
							  		if(rowData.checked == '1' && rowData.remainderamount<${positeTailAmount} && rowData.remainderamount > ${negateTailAmount} && rowData.remainderamount>0){
