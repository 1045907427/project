...
<html>
  <head>
    <title>按客户查询销售情况流水表（超账期原因）</title>
    <script type="text/javascript" src="js/reportDatagrid.js" charset="UTF-8"></script>  
  </head>
  
  <body>
    	<table id="report-datagrid-customerSalesFlowDetail"></table>
    	<form action="" id="report-query-form-customerSalesFlowDetail" method="post">
    	...
    	<div id="report-toolbar-customerSalesFlowDetail" style="padding: 0px">
			<div class="buttonBG">
    	...
    	<script type="text/javascript">
    		var initQueryJSON = $("#report-query-form-customerSalesFlowDetail").serializeJSON();
    		$(function(){
    			var tableColumnListJson = $("#report-datagrid-customerSalesFlowDetail").createGridColumnLoad({
					frozenCol : [[]],
					commonCol : [[
    			...
    			$("#report-datagrid-customerSalesFlowDetail").datagrid({ 
					...
					columns:tableColumnListJson.common,
			 		method:'post',
		  	 		...
		  	 		singleSelect:true,
		  	 		pageSize:100,
					toolbar:'#report-toolbar-customerSalesFlowDetail',
				...
				$("#report-export-salesuserRPDSalesFlow").Excel('export',{
					queryForm: "#report-query-form-customerSalesFlowDetail", //查询条件的form表单，导出时只用通过查询的条件，将通用查询放在form表单里面。
			 		...
			 		name:'客户：[${customername}]，品牌业务员：[${brandusername}]销售情况流水表',
