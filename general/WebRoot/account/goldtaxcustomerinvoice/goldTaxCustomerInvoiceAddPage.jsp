...
<html>
  ...
  <div class="easyui-panel" title="" data-options="fit:true,border:false">
	  <div class="easyui-layout" data-options="fit:true">
	  		<div data-options="region:'north',border:false" style="height:135px;">
				<form action="account/goldtaxcustomerinvoice/addGoldTaxCustomerInvoice.do" id="account-form-goldTaxCustomerInvoiceAddPage" method="post">
				...
				<table style="border-collapse:collapse;" border="0"  cellpadding="2px" cellspacing="2px">
					<tr>
						...
						<td class="len165"><input type="text" id="account-goldTaxCustomerInvoice-businessdate" class="len150" value="${today }" name="goldTaxCustomerInvoice.businessdate" onfocus="WdatePicker({'dateFmt':'yyyy-MM-dd'})" class="easyui-validatebox "  required="required" tabindex="1"  /></td>
					...
					<tr>
						...
						<td>
							<input type="text" id="account-goldTaxCustomerInvoice-customerid"  name="goldTaxCustomerInvoice.customerid" class="len150" />
                            <input type="hidden" id="account-goldTaxCustomerInvoice-hid-customername"  name="goldTaxCustomerInvoice.customername"/>
						</td>
                ...
                <input type="hidden" id="account-goldTaxCustomerInvoice-hid-billtype" value="1"/>
  ...
  <script type="text/javascript">
  	...
  	$(document).ready(function(){
  		$("#account-buttons-goldTaxCustomerInvoicePage").buttonWidget("initButtonType", 'add');
