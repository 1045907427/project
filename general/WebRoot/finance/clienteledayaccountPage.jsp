				...
				<form action="" id="finance-form-QueryClienteleDayAccount" method="post">
					<table class="querytable">
						<tr>
							<td>业务日期：</td>
							<td>
								<input id="begintime" name="begintime" class="Wdate" style="width:100px" onfocus="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd',minDate:'1980-01-01',maxDate:'%y-%M-%ld'})"/>
								到 <input id="endtime" name="endtime" class="Wdate" style="width:100px" onfocus="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd',minDate:'1980-01-01',maxDate:'%y-%M-%ld'})" />
							</td>
							<td rowspan="4">
								<div>
						...
						<tr>
							...
							<td rowspan="4">
								<a href="javaScript:void(0);" id="finance-query-ClienteleList" class="button-qr" title="查询流水账">查询</a>
							</td>
						</tr>
					</table>
				</form>
    ...
    <script type="text/javascript">
    	...
    	var expensesEnteringListColJson=$("#finance-table-Clientelelist").createGridColumnLoad({
	     	...
	     	commonCol:[[
				...
				{field:'subjectexpenses',title:'科目费用',width:100,sortable:true,align:'right',isShow:true,
					formatter:function(val,rowData,rowIndex){
						if(val != "" && val != null){
				...
				{field:'approvalAmount',title:'核准金额',width:100,sortable:true,align:'right',isShow:true,
					formatter:function(val,rowData,rowIndex){
						if(val != "" && val != null){
							return formatterMoney(val);
						}
		...
		$(function(){
			...
			$("#finance-table-Clientelelist").treegrid({ 
			    ...
			    url:'basefiles/finance/getClienteleDayAccountList.do',
