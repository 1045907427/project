   ...
   <div class="easyui-layout" data-options="fit:true">
    	<div data-options="region:'center',border:false" style="border: 0px;">
	    	<form action="" method="post" id="approvalPrice-form-edit">
		    	<table cellpadding="2" cellspacing="2" border="0">
	    			...
	    			<tr>
	    				<td>实际占用金额：</td>
	    				<td><input type="text" name="approvalPrice.atamount" style="width: 120" class="easyui-numberbox" <c:if test="${editFlag == false }">disabled="disabled"</c:if> value="${approvalPrice.atamount}" required="true" data-options="min:-9999999999,max:9999999999,precision:2,groupSeparator:','"/></td>
	    			</tr>
	    		</table>
	    	</form>
    	</div>
    ...
    <script type="text/javascript">
		...
		$("#finance-button-initsupplier").click(function(){
			...
			var ret = approvalPrice_AjaxConn($("#approvalPrice-form-edit").serializeJSON(),'basefiles/finance/editApprovalPrice.do');
