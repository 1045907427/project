            ...
            <table  border="0" class="box_table">
                <tr>
                    ...
                    <td style="text-align: left;">
                        <input type="text" id="dataparam-name-addDataconfig" name="name" style="width: 150px" class="easyui-validatebox"  required="required"/>
                    </td>
                    <td width="120">标识:</td>
                    <td style="text-align: left;">
                        <input type="text" id="dataparam-markid-addDataconfig" name="markid" style="width: 150px"  class="easyui-validatebox"  required="required"/>
                    </td>
                </tr>
                <tr>
                    <td width="120">供应商:</td>
                ...
                <tr>
                    ...
                    <td style="text-align: left;" id="gtypeids">
                        <input type="text" id="dataparam-gtypeids-addDataconfig" name="gtypeids" style="width: 150px" disabled="disabled"/>
                ...
                <tr>
                    ...
                    <td style="text-align: left;" id="ctypeids">
                        <input type="text" id="dataparam-ctypeids-addDataconfig" name="ctypeids" style="width: 150px" disabled="disabled"/>
                ...
                <tr>
                    ...
                    <td style="text-align: left;" id="storageid">
                        <input type="text" id="dataparam-storageid-addDataconfig" name="storageid" style="width: 150px" disabled="disabled"/>
                ...
                <tr>
                    ...
                    <td style="text-align: left;">
                        <input type="text" id="dataparam-vstorageid-addDataconfig" name="vstorageid" style="width: 150px"  class="easyui-validatebox"  required="required"/>
                    </td>
                    <td width="120">虚拟仓库名称:</td>
                    <td style="text-align: left;">
                        <input type="text" id="dataparam-vstoragename-addDataconfig" name="vstoragename" style="width: 150px"  class="easyui-validatebox"  required="required"/>
                    </td>
                </tr>
                <tr>
                    <td width="120">状态:</td>
                    <td style="text-align: left;">
                        <select id="dataparam-state-addDataconfig" style="width:150px;" readonly="readonly" disabled="disabled">
                            <option value="0" >禁用</option>
                            <option value="1">启用</option>
                            <option value="2"  selected="selected">保存</option>
                        </select>
                        <input type="hidden" name="state" value="2" style="width: 150px"/>
                    </td>
                    <td width="120">优先级:</td>
                    <td style="text-align: left;">
                        <select id="dataparam-level-addDataconfig" name="level" style="width:150px;">
                ...
                <tr>
                    ...
                    <td style="text-align: left;">
                        <select id="dataparam-viewtype-addDataconfig" name="viewtype" style="width:150px;" >
                            <option value="0" selected="selected">默认视图</option>
