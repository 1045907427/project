...
<a href="javascript:history.back()" data-rel="back"  class="ui-btn ui-corner-all ui-btn-inline ui-btn-icon-left ui-icon-back" style="border: 0px; background: #E9E9E9;">返回</a>

<%--<a href="history.go(-1)" data-rel="back" class="ui-btn ui-corner-all ui-btn-inline ui-btn-icon-left ui-icon-back" style="border: 0px; background: #E9E9E9;">返回</a>--%>
...
<c:if test="${track.status == 1}">
    <div class="main">
        <c:if test="${track.orderstatus == 3 or track.orderstatus == 4}">
            ...
            <div id="orderidView" style="display: none;">要货单编号：${track.id}</div>
        </c:if>
