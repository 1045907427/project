							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									...
									<tr>
										<td class="left">说明：</td>
										<td colspan="9">
											<textarea name="access.remark1" id="oa-remark1-oaAccessHandlePage" style="width: 707px; height: 50px;" readonly="readonly"><c:out value="${access.remark1 }" escapeXml="true"></c:out></textarea>
										</td>
									</tr>
								</table>
							</div>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									...
									<tr>
										...
										<td class="left">
											<select class="easyui-validatebox len60" name="access.autoassign" id="oa-autoassign-oaAccessHandlePage" data="${access.autoassign }" disabled="disabled">
												<option></option>
