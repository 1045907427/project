		...
		<div class="easyui-layout" data-options="fit:true,border:false">
			<form action="oa/editOaAccess.do" id="oa-form-oaAccessHandlePage" method="post">
				...
				<div data-options="region:'center',border:false">
					<div style="margin: 20px auto; width: 840px; background-color: ; border: 1px solid #AAA;">
                    <div style="margin: 0px auto; height: 50px; font-size: 16pt; font-weight: bold; line-height: 50px; text-align: center;">
                        <c:out value="${process.definitionname }"/>
                    </div>
								...
								<table style="border-collapse:collapse;" border="0" cellpadding="2" cellspacing="2">
									<tr>
										...
										<td class="left len200">
											<input class="easyui-validatebox len90 Wdate" name="access.planbegindate" value="${access.planbegindate }" id="oa-planbegindate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off"/>～<input class="easyui-validatebox len90 Wdate" value="${access.planenddate }" name="access.planenddate" id="oa-planenddate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off"/>
										</td>
										...
										<td>
											<c:choose>
												<c:when test="${empty access.pricetype and empty access.expensesort}">
													<select name="access.pricetype" id="oa-pricetype-oaAccessHandlePage" class="easyui-validatebox len190" data="${access.pricetype }">
												</c:when>
												<c:otherwise>
													<select name="access.pricetype" id="oa-pricetype-oaAccessHandlePage" class="easyui-validatebox len190" data="${access.pricetype }">
												</c:otherwise>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td class="len90"><input class="easyui-numberbox" style="width: 80px;" name="access.factoryamount" id="oa-factoryamount-oaAccessHandlePage" value="${access.factoryamount }" autocomplete="off" data-options="precision:2,onChange:computeBranchaccount"/></td>
										<td class="left len60">自理金额：</td>
										<td class="len90"><input class="easyui-numberbox" style="width: 80px;" name="access.myamount" id="oa-myamount-oaAccessHandlePage" value="${access.myamount }" autocomplete="off" data-options="precision:2"/></td>
										<td class="left len60">收回方式：</td>
										<td class="len90">
											<select class="easyui-validatebox" style="width: 80px;" name="access.reimbursetype" id="oa-reimbursetype-oaAccessHandlePage" data="${access.reimbursetype }" data-options="required:false">
												<option></option>
										...
										<td class="len90"><input class="easyui-validatebox Wdate" style="width: 80px;" name="access.reimbursedate" value="${access.reimbursedate }" id="oa-reimbursedate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM'})" style=" margin-left: 0px;" autocomplete="off"/></td>
										<td class="left len60">支付日期：</td>
										<td class="len90"><input class="easyui-validatebox Wdate" style="width: 80px;" name="access.paydate" value="${access.paydate }" id="oa-paydate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM'})" autocomplete="off"/></td>
									</tr>
									<tr>
										<td class="left">说明：</td>
										<td colspan="9">
											<textarea name="access.remark1" id="oa-remark1-oaAccessHandlePage" style="width: 707px; height: 50px;"><c:out value="${access.remark1 }" escapeXml="true"></c:out></textarea>
										</td>
									</tr>
								</table>
							</div>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td class="left len60 nodisplay"><input id="oa-confirmoption-oaAccessHandlePage" class="easyui-validatebox len60" autocomplete="off"/></td>
										<td class="left len60 nodisplay">补库;存：</td>
										<td class="left len60 nodisplay"><input id="oa-comfirmaddstorage-oaAccessHandlePage" class="easyui-validatebox len60" autocomplete="off"/></td>
										<td class="left len60 condate">确认时间：</td>
										<td class="len200 condate">
											<input class="easyui-validatebox Wdate len90" name="access.conbegindate" id="oa-conbegindate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off" value="${access.conbegindate }"/>～<input class="easyui-validatebox Wdate len90" name="access.conenddate" id="oa-conenddate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off" value="${access.conenddate }"/>
										</td>
										<td class="left len90 comdate">降价设定时间：</td>
										<td class="len200 comdate">
											<input class="easyui-validatebox Wdate len90" name="access.combegindate" id="oa-combegindate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off" value="${access.combegindate }"/>～<input class="easyui-validatebox Wdate len90" name="access.comenddate" id="oa-comenddate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off" value="${access.comenddate }"/>
										</td>
									</tr>
									<tr>
										<td class="left">支付方式：</td>
										<td class="left">
											<select class="easyui-validatebox len190" name="access.paytype" id="oa-paytype-oaAccessHandlePage" data="${access.paytype } ">
										...
										<td class="left">
											<select class="easyui-validatebox len60" name="access.autoassign" id="oa-autoassign-oaAccessHandlePage" data="${access.autoassign }">
												<option></option>
										...
										<td class="left" colspan="3">
											<c:choose>
												<c:when test="${not empty access.totalamount }">
													<input class="easyui-numberbox" style="width: 192px;" name="access.totalamount" id="oa-totalamount-oaAccessHandlePage" value="${access.totalamount }" autocomplete="off" data-options="required:true, precision:2"/>
												</c:when>
												<c:otherwise>
													<input class="easyui-numberbox" style="width: 192px;" name="access.totalamount" id="oa-totalamount-oaAccessHandlePage" value="0.00" autocomplete="off" data-options="required:true, precision:2"/>
												</c:otherwise>
											</c:choose>
										</td>
									</tr>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td><textarea name="access.remark2" id="oa-remark2-oaAccessHandlePage" style="width: 690px; height: 50px;"><c:out value="${access.remark2 }" escapeXml="true"></c:out></textarea></td>
									</tr>
								</table>
							</div>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td class="len100"><input class="easyui-numberbox" style="width: 90px;" name="access.branchaccount" id="oa-branchaccount-oaAccessHandlePage" value="${access.branchaccount }" autocomplete="off" data-options="required:false,precision:2"/></td>
									</tr>
								</table>
							</div>
							...
							<div id="oa-invoice-oaAccessHandlePage" class="easyui-panel" data-options="border: false" title="支票支付">
								<table>
									...
									<tr>
										...
										<td class=""><input class="easyui-validatebox Wdate len80" name="invoice.invoicedate" id="oa-invoicedate-oaAccessHandlePage" value="${invoice.invoicedate }" onclick="" style=" margin-left: 0px;" autocomplete="off"/></td>
										<td class="left">付款日期：</td>
										<td class=""><input class="easyui-validatebox Wdate len130" name="invoice.paydate" id="oa-paydate-oaAccessHandlePage" value="${invoice.paydate }" onclick="" style=" margin-left: 0px;" autocomplete="off"/></td>
									</tr>
								</table>
							</div>
