...
//            });
        ...
        $(document).on('pageshow', '#oa-amountdetail-oaAccessAmountDetailPage', function(e) {
            ...
            if(index != -1) {
                ...
                amount.unitnum = formatterNum(amount.unitnum || '0');
                amount.auxnum = formatterNum(amount.auxnum || '0');
                amount.auxremainder = formatterNum(amount.auxremainder || '0');
                amount.auxdetail = formatterNum(amount.auxdetail || '0');
                amount.amount = formatterMoney(amount.amount || '0.00');
                amount.erpnum = formatterNum(amount.erpnum || '0');
        ...
        */
        ...
        $(function() {
            ...
            // 支付日期
            $(document).on('click', '#oa-paydate-oaAccessHandlePage', function(e) {

                androidDateWidget($('#oa-paydate-oaAccessHandlePage').val() || new Date().Format('yyyy-MM-dd'), 'yyyy-MM', 'selectPaydate');
            });
        ...
        <form action="" id="oa-form-oaAccessHandlePage" method="post">
            ...
            <div class="ui-corner-all custom-corners">
                ...
                <div class="ui-body ui-body-a">
                    ...
                    <div class="ui-field-contain">
                        <label>收回日期
                            <input type="text" name="access.reimbursedate" id="oa-reimbursedate-oaAccessHandlePage" value="${access.reimbursedate }" data-clear-btn="true"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>支付日期
                            <input type="text" name="access.paydate" id="oa-paydate-oaAccessHandlePage" value="${access.paydate }" data-clear-btn="true"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>说明
                            <textarea name="access.remark1" id="oa-remark1-oaAccessHandlePage"><c:out value="${access.remark1}"/></textarea>
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="ui-corner-all custom-corners">
                ...
                <div class="ui-body ui-body-a">
                    <div class="ui-field-contain">
                        <label>电脑冲差金额
                            <input type="number" name="access.compdiscount" id="oa-compdiscount-oaAccessHandlePage" value="${access.compdiscount }" data-clear-btn="false"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>电脑降价金额
                            <input type="number" name="access.comdownamount" id="oa-comdownamount-oaAccessHandlePage" value="${access.comdownamount }" data-clear-btn="false"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>支票金额
                            <input type="number" name="access.payamount" id="oa-payamount-oaAccessHandlePage" value="${access.payamount }" data-clear-btn="false"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>结算金额
                            <input type="number" name="access.branchaccount" id="oa-branchaccount-oaAccessHandlePage" value="${access.branchaccount }" data-clear-btn="false"/>
                        </label>
                    </div>
                </div>
            </div>
