        ...
        <form action="" id="oa-form-oaAccessViewPage" method="post">
            ...
            <div class="ui-corner-all custom-corners">
                ...
                <div class="ui-body ui-body-a">
                    ...
                    <div class="ui-field-contain">
                        <label>工厂金额
                            <input type="text" name="access.factoryamount" id="oa-factoryamount-oaAccessViewPage" value="${access.factoryamount }" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>自理金额
                            <input type="text" name="access.myamount" id="oa-myamount-oaAccessViewPage" value="${access.myamount }" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>收回方式
                    ...
                    <div class="ui-field-contain">
                        <label>收回日期
                            <input type="text" name="access.reimbursedate" id="oa-reimbursedate-oaAccessViewPage" value="${access.reimbursedate }" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>支付日期
            ...
            <div class="ui-corner-all custom-corners">
                ...
                <div class="ui-body ui-body-a">
                    ...
                    <div class="ui-field-contain">
                        <label>费用金额
                            <input type="text" name="access.totalamount" id="oa-totalamount-oaAccessViewPage" value="${access.totalamount }" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
