							...
							<div class="easyui-panel" data-options="border: false">
                                <table>
                                    ...
                                    <tr>
                                        ...
                                        <td class="left" colspan="3"><input class="easyui-numberbox len190" name="access.totalamount" id="oa-totalamount-oaAccessHandlePage" value="${access.totalamount }" autocomplete="off" data-options="required:false, precision:2" readonly="readonly"/></td>
                                    </tr>
                                </table>
							</div>
                            <div class="easyui-panel" data-options="border:true" style="height: 152px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;"><!-- style="height: 200px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;" -->
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td class="len100"><input class="easyui-numberbox" style="width: 90px;" name="access.compdiscount" id="oa-compdiscount-oaAccessHandlePage" value="${access.compdiscount }" autocomplete="off" data-options="required:false,precision:2" readonly="readonly"/></td>
										<td class="len90 left">电脑降价金额：</td>
										<td class="len100"><input class="easyui-numberbox" style="width: 90px;" name="access.comdownamount" id="oa-comdownamount-oaAccessHandlePage" value="${access.comdownamount }" autocomplete="off" data-options="required:false,precision:2" readonly="readonly"/></td>
										<td class="len80 left">支票金额：</td>
										<td class="len100"><input class="easyui-numberbox" style="width: 90px;" name="access.payamount" id="oa-payamount-oaAccessHandlePage" value="${access.payamount }" autocomplete="off" data-options="required:false,precision:2,onChange:computeBranchaccount" readonly="readonly"/></td>
										<td class="len80 left">结算金额：</td>
										<td class="len100"><input class="easyui-numberbox" style="width: 90px;" name="access.branchaccount" id="oa-branchaccount-oaAccessHandlePage" value="${access.branchaccount }" autocomplete="off" data-options="required:false,precision:2" readonly="readonly"/></td>
									</tr>
								</table>
							</div>
							...
							<div id="oa-invoice-oaAccessHandlePage" class="easyui-panel" data-options="border: false" title="支票支付">
								<table>
									...
									<tr>
										...
										<td class=""><input class="easyui-numberbox len80" name="invoice.payamount" id="oa-payamount-oaAccessHandlePage" value="${invoice.payamount }" autocomplete="off" data-options="required:false,precision:2,onChange:upperPayamount" readonly="readonly"/></td>
										...
										<td class=""><input class="easyui-validatebox len90" name="invoice.expensesort" id="oa-expensesort-oaAccessHandlePage" value="${invoice.expensesort }" autocomplete="off" data-options="required:false" readonly="readonly"/></td>
