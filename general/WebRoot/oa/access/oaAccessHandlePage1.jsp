										...
										<td>
											<c:choose>
												<c:when test="${empty access.pricetype and empty access.expensesort}">
													<select name="access.pricetype" id="oa-pricetype-oaAccessHandlePage" class="easyui-validatebox len190" data-options="required:true,missingMessage:'通路费和特价至少应选择一个！'" data="${access.pricetype }">
												</c:when>
												<c:otherwise>
													<select name="access.pricetype" id="oa-pricetype-oaAccessHandlePage" class="easyui-validatebox len190" data-options="required:false,missingMessage:'通路费和特价至少应选择一个！'" data="${access.pricetype }">
												</c:otherwise>
											</c:choose>
												<option></option>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td class="len90"><input class="easyui-numberbox" style="width: 80px;" name="access.factoryamount" id="oa-factoryamount-oaAccessHandlePage" value="${access.factoryamount }" autocomplete="off" data-options="required:false,precision:2,onChange:computeBranchaccount"/></td>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td><textarea name="access.remark2" id="oa-remark2-oaAccessHandlePage" style="width: 690px; height: 50px;" readonly="readonly"><c:out value="${access.remark2 }" escapeXml="true"></c:out></textarea></td>
									</tr>
								</table>
							</div>
