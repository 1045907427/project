        ...
        <div class="ui-corner-all custom-corners">
            ...
            <div class="ui-body ui-body-a">
                <div class="ui-field-contain">
                    <label>客户编号<font color="#F00">*</font>
                        <input type="text" class="required" name="customer.customerid" id="oa-customerid-oacustomerHandlePage" value="${customer.customerid }" data-clear-btn="true"/>
                    </label>
                </div>
                <div class="ui-field-contain">
