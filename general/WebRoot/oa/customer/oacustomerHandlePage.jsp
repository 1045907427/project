...
<html>
  ...
  <body>
	<div class="easyui-panel" data-options="fit:true,border:false" style1="height: 920px;">
                ...
                <div class="easyui-panel assignee-oacustomer oa-step090Div-oacustomerHandlePage" data-options="border:false" title="客户基本信息">
                    <table style="border-collapse:collapse;" border="0" cellpadding="2" cellspacing="2">
                        <tr>
                            ...
                            <td class="len180"><input class="easyui-validatebox len130" style="margin-left: 0px;" name="customer.customerid" id="oa-customerid-oacustomerHandlePage" value="<c:out value='${customer.customerid }' escapeXml='true'></c:out>" data-options="required:false,validType:['validLength[]']" autocomplete="off" maxlength="20"/></td>
                        ...
                        <tr>
                            <td class="left len100">销售部门：</td>
                            <td class="len180"><input class="easyui-validatebox len130" style="margin-left: 0px;" name="customer.salesdeptid" id="oa-salesdeptid-oacustomerHandlePage" value="<c:out value='${customer.salesdeptid }' escapeXml='true'></c:out>" autocomplete="off" data-options="required:true" maxlength="50"/></td>
                            <%--
                            ...
                            --%>
                            <td class="right len100">联系人：</td>
                            <td class="len180"><input class="easyui-validatebox len130" style="margin-left: 0px;" name="customer.contact" id="oa-contact-oacustomerHandlePage" value="<c:out value='${customer.contact }' escapeXml='true'></c:out>" autocomplete="off" data-options="required:true" maxlength="20"/></td>
                            <td class="right len100">联系电话：</td>
                            <td class="len180"><input class="easyui-validatebox len130" style="margin-left: 0px;" name="customer.mobile" id="oa-mobile-oacustomerHandlePage" value="<c:out value='${customer.mobile }' escapeXml='true'></c:out>" autocomplete="off" data-options="required:true" maxlength="50"/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td class=""><input class="easyui-numberbox len130" style="margin-left: 0px; width: 130px;" data-options="max:999999999999,precision:0,required:true" name="customer.credit" id="oa-credit-oacustomerHandlePage" value="<c:out value='${customer.credit }' escapeXml='true'></c:out>" autocomplete="off"/></td>
                        </tr>
                        <tr>
