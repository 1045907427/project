    ...
    <form action="" id="oa-form-oaPurchasePayHandlePage" method="post">
        ...
        <div class="ui-corner-all custom-corners">
            ...
            <div class="ui-body ui-body-a">
                <div class="ui-field-contain">
                    <label>申请日期
                        <c:choose>
                            ...
                            <c:otherwise>
                                <input type="text" class="dateISO" name="pay.businessdate" id="oa-businessdate-oaPurchasePayHandlePage" value="<c:out value='${pay.businessdate }'/>" data-clear-btn="true" maxlength="10"/>
                            </c:otherwise>
                        </c:choose>
                    </label>
                </div>
                ...
                <div class="ui-field-contain">
                    <label>付款银行<span style="color: #F00;">*</span>
                        <input type="text" class="required" name="pay.paybank2" id="oa-paybank2-oaPurchasePayHandlePage" value="<c:if test='${not empty bank }'><c:out value='${bank.name }'/></c:if>" data-clear-btn="true" readonly="readonly"/>
