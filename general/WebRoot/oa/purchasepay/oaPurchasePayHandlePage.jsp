                    ...
                    <div class="easyui-panel" data-options="border:false">
                        <table class="purchasepay-work-table">
                            ...
                            <tr>
                                ...
                                <td class=""><input class="easyui-validatebox len140" name="pay.paybank" id="oa-paybank-oaPurchasePayHandlePage" data-options="required:true" value="<c:out value='${pay.paybank }'/>" autocomplete="off" maxlength="20"/></td>
