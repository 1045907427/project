                    ...
                    <label>银行&nbsp;
                        <c:choose>
                            <c:when test="${not empty matcost and not empty matcost.paybank and not empty bank}">
                                <input type="text" class="" name="matcost.bank" id="oa-bank-oaMatcostHandlePage" value="${bank.name }" readonly="readonly" data-clear-btn="true"/>
                            </c:when>
                            <c:otherwise>
                                <input type="text" class="" name="matcost.bank" id="oa-bank-oaMatcostHandlePage" value="" readonly="readonly" data-clear-btn="true"/>
                            </c:otherwise>
                        </c:choose>
                        <input type="hidden" class="" name="matcost.paybank" id="oa-paybank-oaMatcostHandlePage" value="${matcost.paybank }" readonly="readonly" data-clear-btn="true"/>
                    </label>
                </div>
