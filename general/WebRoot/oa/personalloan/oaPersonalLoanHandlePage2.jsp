					...
					<div style="margin: 20px auto; width: 790px; border: 1px solid #AAA;">
						...
						<table>
							...
							<tr>
								...
								<td class=""><input class="easyui-validatebox len140" name="loan.paybank" id="oa-paybank-oaPersonalLoanHandlePage" data-options="required:true" value="${loan.paybank }" autocomplete="off" maxlength="15"/><font color="#F00">*</font></td>
