    ...
    <form action="" id="oa-form-oaCustomerFeeHandlePage" method="post">
        ...
        <div class="ui-corner-all custom-corners">
            ...
            <div class="ui-body ui-body-a">
                ...
                <div class="ui-field-contain">
                    <label>费用科目
                        <input type="text" name="customerfee.expensesort2" id="oa-expensesort2-oaCustomerFeeHandlePage" value="<c:if test='${not empty expensesort }'><c:out value='${customerfee.expensesort }'/>:<c:out value='${expensesort.name }'/></c:if>" data-clear-btn="true" readonly="readonly"/>
                ...
                <div class="ui-field-contain">
                    <label>银行名称
                        <input type="text" name="customerfee.paybank2" id="oa-paybank2-oaCustomerFeeHandlePage" value="<c:if test='${not empty bank }'><c:out value='${customerfee.paybank }'/>:<c:out value='${bank.name }'/></c:if>" data-clear-btn="true" readonly="readonly"/>
