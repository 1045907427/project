                        ...
                        <div class="easyui-panel" data-options="border:false">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input class="easyui-validatebox len140" name="share.upamount" id="oa-upamount-oaInnerShareHandlePage" data-options="required:false" value="${share.upamount }" autocomplete="off" maxlength="50"/><font color="#F00">*</font></td>
