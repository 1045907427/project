						...
						<div class="easyui-panel" data-options="border:false">
							<table>
								<tr>
									...
									<td class="len150"><input type="text" class="easyui-validatebox len136" name="brandfee.expensesort" id="oa-expensesort-oaBrandFeeHandlePage" value="${brandfee.expensesort }" autocomplete="off"/></td>
