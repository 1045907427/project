    ...
    <form action="" id="oa-form-oaBrandFeeHandlePage" method="post">
        ...
        <div class="ui-corner-all custom-corners">
            ...
            <div class="ui-body ui-body-a">
                ...
                <div class="ui-field-contain">
                    <label>付款银行<span class="warnning">*</span>
                        <input type="text" class="required" name="brandfee.paybank2" id="oa-paybank2-oaBrandFeeHandlePage" value="<c:if test='${not empty bank }'><c:out value='${brandfee.paybank }'/>:<c:out value='${bank.name }'/></c:if>" data-clear-btn="true" readonly="readonly"/>
