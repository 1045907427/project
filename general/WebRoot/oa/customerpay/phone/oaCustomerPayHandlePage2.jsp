...
//        $('#oa-supplierid2-oaCustomerPayHandlePage').val(data.id + ':' + data.name);
//        $('#oa-supplierid-oaCustomerPayHandlePage').val(data.id);
        setSupplier(data);
            ...
            <div class="ui-body ui-body-a">
                ...
                <div class="ui-field-contain">
                    <label>客户<font color="#F00">*</font>
                        <input type="text" class="required" id="oa-customerid2-oaCustomerPayHandlePage" value="<c:if test='${not empty customer }'><c:out value='${customerpay.customerid }'/>:<c:out value='${customer.name }'/></c:if>" data-clear-btn="true" readonly="readonly"/>
                ...
                <div class="ui-field-contain">
                    <label>付款银行<font color="#F00">*</font>
                        <input type="text" class="required" name="customerpay.paybank2" id="oa-paybank2-oaCustomerPayHandlePage" value="<c:if test='${not empty bank }'><c:out value='${customerpay.paybank }'/>:<c:out value='${bank.name }'/></c:if>" data-clear-btn="true" readonly="readonly"/>
