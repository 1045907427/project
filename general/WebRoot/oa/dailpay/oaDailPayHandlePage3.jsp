                        ...
                        <div data-options="region:'center',border:false">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input class="easyui-validatebox len140" name="pay.paybank" id="oa-paybank-oaDailPayHandlePage" data-options="required:false" value="${pay.paybank }" autocomplete="off" maxlength="10"/><font color="#F00">*</font></td>
                                </tr>
                                <tr>
