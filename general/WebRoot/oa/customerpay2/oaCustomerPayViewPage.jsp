...
<html>
  ...
  <body>
		...
		<div class="easyui-layout" data-options="fit:true,border:false">
			<c:choose>
				<c:when test="${empty customerpay or empty customerpay.id}">
					<form action="oa/hd/addOaCustomerPay.do" id="oa-form-oaCustomerPayViewPage" method="post">
				</c:when>
				<c:otherwise>
					<form action="oa/hd/editOaCustomerPay.do" id="oa-form-oaCustomerPayViewPage" method="post">
				</c:otherwise>
			</c:choose>
				...
				<div data-options="region:'center',border:false">
					<div style="margin: 20px auto; width: 790px; border: 1px solid #AAA;">
                        ...
                        <div class="easyui-panel" data-options="border:false">
                            <table>
                                <tr>
                                    ...
                                    <td class="len180"><input class="easyui-validatebox len140" name="customerpay.customerid" id="oa-customerid-oaCustomerPayViewPage" data-options="required:false" value="${customerpay.customerid }" autocomplete="off" maxlength="20" readonly="readonly"/></td>
                                </tr>
                                <tr>
                                    <td class="left">客户名称：</td>
                                    <td class=""><input class="easyui-validatebox len140" name="customerpay.customerid2" id="oa-customerid2-oaCustomerPayViewPage" data-options="required:false" value="${customerpay.customerid2 }" autocomplete="off" maxlength="20" readonly="readonly"/></td>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input class=" easyui-numberbox" style="width: 140px;" name="customerpay.payamount" id="oa-payamount-oaCustomerPayViewPage" data-options="required:false,min:0,precision:2" value="${customerpay.payamount }" autocomplete="off" maxlength="15" readonly="readonly"/></td>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input class="easyui-validatebox len140" name="customerpay.paybank" id="oa-paybank-oaCustomerPayViewPage" data-options="required:false" value="${customerpay.paybank }" autocomplete="off" maxlength="20" readonly="readonly"/></td>
                                    ...
                                    <td class=""><input class="easyui-validatebox len140" name="customerpay.expensesort" id="oa-expensesort-oaCustomerPayViewPage" data-options="" value="${customerpay.expensesort }" autocomplete="off" readonly="readonly"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class=""><input class="easyui-numberbox" style="width: 140px;" name="customerpay.billamount" id="oa-billamount-oaCustomerPayViewPage" data-options="required:false,min:0,precision:2" value="${customerpay.billamount }" autocomplete="off" maxlength="15" readonly="readonly"/></td>
                                </tr>
                                <tr>
						...
						<div class="easyui-panel" data-options="border:false" style="height: 285px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;"><!-- style="height: 200px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;" -->
    ...
    var $customerid2 = $('#oa-customerid2-oaCustomerPayViewPage');
