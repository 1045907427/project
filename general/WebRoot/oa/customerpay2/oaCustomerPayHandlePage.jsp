...
<html>
  ...
  <body>
		...
		<div class="easyui-layout" data-options="fit:true,border:false">
			<c:choose>
				<c:when test="${empty customerpay or empty customerpay.id}">
					<form action="oa/hd/addOaCustomerPay.do" id="oa-form-oaCustomerPayHandlePage" method="post">
				</c:when>
				<c:otherwise>
					<form action="oa/hd/editOaCustomerPay.do" id="oa-form-oaCustomerPayHandlePage" method="post">
				</c:otherwise>
			</c:choose>
				...
				<div data-options="region:'center',border:false">
					<div style="margin: 20px auto; width: 790px; border: 1px solid #AAA;">
                        ...
                        <div class="easyui-panel" data-options="border:false">
                            <table>
                                <tr>
                                    ...
                                    <td class="len180"><input class=" easyui-numberbox" style="width: 140px;" name="customerpay.relateoaid" id="oa-relateoaid-oaCustomerPayHandlePage" data-options="required:true,min:0,precision:0,onChange:switchViewLink" value="${customerpay.relateoaid }" autocomplete="off" maxlength="10"/><a id="oa-link-oaCustomerPayHandlePage" href="javascript:void(0);" onclick="viewOaAccess()">查看</a><font color="#F00">*</font></td>
                                    <td class="len80 right">供应商：</td>
                                    <td class="len148"><input class="easyui-validatebox len160" name="customerpay.supplierid" id="oa-supplierid-oaCustomerPayHandlePage" data-options="" value="${customerpay.supplierid }" autocomplete="off"/><font color="#F00">*</font></td>
                                    <td class="len80 right nodisplay">所属部门：</td>
                                    <td class="len180 nodisplay">
                                        <c:choose>
                                            <c:when test="${empty customerpay }">
                                                <input class="easyui-validatebox len140" name="customerpay.deptid" id="oa-deptid-oaCustomerPayHandlePage" data-options="required:false" value="${user.departmentid }" autocomplete="off" maxlength="20"/><font color="#F00">*</font>
                                            </c:when>
                                            <c:otherwise>
                                                <input class="easyui-validatebox len140" name="customerpay.deptid" id="oa-deptid-oaCustomerPayHandlePage" data-options="required:false" value="${customerpay.deptid }" autocomplete="off" maxlength="20"/><font color="#F00">*</font>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                    <td class="len80 right">客户：</td>
                                    <td class="len180"><input class="easyui-validatebox len140" name="customerpay.customerid" id="oa-customerid-oaCustomerPayHandlePage" data-options="required:true" value="${customerpay.customerid }" autocomplete="off" maxlength="20"/><font color="#F00">*</font></td>
                                </tr>
                                <tr>
                                    <td class="left">客户名称：</td>
                                    <td class=""><input class="easyui-validatebox len140" name="customerpay.customerid2" id="oa-customerid2-oaCustomerPayHandlePage" data-options="required:false" value="${customerpay.customerid2 }" autocomplete="off" maxlength="20"/></td>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input class=" easyui-numberbox" style="width: 140px;" name="customerpay.payamount" id="oa-payamount-oaCustomerPayHandlePage" data-options="required:true,min:0,precision:2,onChange:payamountToUpper" value="${customerpay.payamount }" autocomplete="off" maxlength="15"/><font color="#F00">*</font></td>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input class="easyui-validatebox len140" name="customerpay.paybank" id="oa-paybank-oaCustomerPayHandlePage" data-options="required:false" value="${customerpay.paybank }" autocomplete="off" maxlength="20"/></td>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input class=" easyui-numberbox" style="width: 140px;" name="customerpay.billamount" id="oa-billamount-oaCustomerPayHandlePage" data-options="required:false,min:0,precision:2" value="${customerpay.billamount }" autocomplete="off" maxlength="15"/></td>
                                </tr>
                                <tr>
						...
						<div class="easyui-panel" data-options="border:false" style="height: 325px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;"><!-- style="height: 200px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;" -->
    ...
    var $customerid2 = $('#oa-customerid2-oaCustomerPayHandlePage');
