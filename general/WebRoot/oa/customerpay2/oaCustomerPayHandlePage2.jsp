                        ...
                        <div class="easyui-panel" data-options="border:false">
                            <table>
                                <tr>
                                    ...
                                    <td class="len180"><input class="easyui-validatebox len140" name="customerpay.customerid" id="oa-customerid-oaCustomerPayHandlePage" data-options="required:true" value="${customerpay.customerid }" autocomplete="off" maxlength="20" readonly="readonly"/><font color="#F00">*</font></td>
                                </tr>
                                <tr>
