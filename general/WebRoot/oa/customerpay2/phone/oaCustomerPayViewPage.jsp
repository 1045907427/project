            ...
            <div class="ui-body ui-body-a">
                ...
                <div class="ui-field-contain">
                    <label>客户<font color="#F00">*</font>
                        <input type="text" class="required" name="customerpay.customerid2" id="oa-customerid2-oaCustomerPayViewPage" value="<c:if test='${not empty customer }'><c:out value='${customerpay.customerid }'/>:<c:out value='${customer.name }'/></c:if>" readonly="readonly" readonly="readonly"/>
