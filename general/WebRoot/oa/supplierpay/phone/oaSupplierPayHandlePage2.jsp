    ...
    <form action="" id="oa-form-oaSupplierPayHandlePage" method="post">
        ...
        <div class="ui-corner-all custom-corners">
            ...
            <div class="ui-body ui-body-a">
                ...
                <div class="ui-field-contain">
                    <label>收款银行
                        <input type="text" class="required" name="pay.collectionbank" id="oa-collectionbank-oaSupplierPayHandlePage" value="${pay.collectionbank}" data-clear-btn="true"/>
                    </label>
                </div>
                <div class="ui-field-contain">
                    <label>银行账号
                ...
                <div class="ui-field-contain">
                    <label>付款金额<font color="#F00">*</font>
                        <input type="number" class="required" name="pay.payamount" id="oa-payamount-oaSupplierPayHandlePage" value="${pay.payamount }" data-clear-btn="true" maxlength="15"/>
                ...
                <div class="ui-field-contain">
                    <label>付款银行<font color="#F00">*</font>
                        <input type="text" class="required" name="pay.paybank2" id="oa-paybank2-oaSupplierPayHandlePage" value="<c:if test='${not empty bank }'><c:out value='${pay.paybank }'/>:<c:out value='${bank.name }'/></c:if>" data-clear-btn="true" readonly="readonly"/>
