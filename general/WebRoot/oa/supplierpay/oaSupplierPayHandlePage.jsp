                        ...
                        <div class="easyui-panel" data-options="border:false">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="">
                                        <c:choose>
                                            <c:when test="${param.step eq '02'}">
                                                <input class="easyui-numberbox" style="width: 140px;" name="pay.payamount" id="oa-payamount-oaSupplierPayHandlePage" data-options="required:true,precision:2,onChange:computePayMargin" value="${pay.payamount }" autocomplete="off" maxlength="15"/><font color="#F00">*</font>
                                            </c:when>
                                            <c:otherwise>
                                                <input class="easyui-numberbox" style="width: 140px;" name="pay.payamount" id="oa-payamount-oaSupplierPayHandlePage" data-options="required:false,precision:2,onChange:computePayMargin" value="${pay.payamount }" autocomplete="off" maxlength="15"/>
                                            </c:otherwise>
                                        </c:choose>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class=""><input class="easyui-validatebox len140" name="pay.paybank" id="oa-paybank-oaSupplierPayHandlePage" data-options="required:true" value="${pay.paybank }" autocomplete="off" maxlength="20"/></td>
