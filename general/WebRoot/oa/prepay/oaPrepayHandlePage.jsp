					...
					<div style="margin: 20px auto; width: 790px; border: 1px solid #AAA;">
						...
						<table>
							...
							<tr>
								...
								<td class=""><input class="easyui-validatebox len140" name="prepay.paybank" id="oa-paybank-oaPrepayHandlePage" data-options="required:true" value="${prepay.paybank }" autocomplete="off" maxlength="15"/></td>
