...
//                    param: [{field: 'defaultsupplier' ,op: 'equal', value: $('#oa-supplierid-oaAccessHandlePage').val()}]
        ...
        // 切换到数量明细页面时，加载表单数据
        $(document).on('pagecreate', '#oa-amountdetail-oaAccessAmountDetailPage', function(e) {
...
//            $('#oa-form-oaAccessPriceDetailPage')[0].reset();
        ...
        * @returns {boolean}
        ...
        function workFormSubmit(call, args) {
            ...
            var flag = $('#oa-form-oaAccessHandlePage').valid();
            if(!flag) {
        ...
        <form action="" id="oa-form-oaAccessHandlePage" method="post">
            ...
            <div class="ui-corner-all custom-corners">
                ...
                <div class="ui-body ui-body-a">
                        ...
                        <label>供应商
                            <c:choose>
                                <c:when test="${not empty access and not empty access.supplierid and not empty supplier}">
                                    <input type="text" class="required" name="access.supplierid2" id="oa-supplierid2-oaAccessHandlePage" value="${supplier.id }:${supplier.name }" data-clear-btn="false" readonly="readonly"/>
                                </c:when>
                                <c:otherwise>
                                    <input type="text" class="required" name="access.supplierid2" id="oa-supplierid2-oaAccessHandlePage" value="" data-clear-btn="false" readonly="readonly"/>
                                </c:otherwise>
                            </c:choose>
                            <input type="hidden" class="required" name="access.supplierid" id="oa-supplierid-oaAccessHandlePage" value="${supplier.id }" data-clear-btn="false" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>时间段
                            <input type="text" class="required dateISO" name="access.planbegindate" id="oa-planbegindate-oaAccessHandlePage" value="${access.planbegindate }" data-clear-btn="false" readonly="readonly"/>
                            <input type="text" class="required dateISO" name="access.planenddate" id="oa-planenddate-oaAccessHandlePage" value="${access.planenddate }" data-clear-btn="false" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>确认单号
                            <input type="text" class="number" name="access.confirmid" id="oa-confirmid-oaAccessHandlePage" value="${access.confirmid }" data-clear-btn="false" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>申请通路费
                            <c:choose>
                                ...
                                <c:otherwise>
                                    <input type="text" class="required" name="access.expensesort2" id="oa-expensesort2-oaAccessHandlePage" value="" data-clear-btn="false" readonly="readonly"/>
                                </c:otherwise>
                            </c:choose>
                        ...
                        <label>客户
                            <c:choose>
                                <c:when test="${not empty access and not empty access.customerid and not empty customer }">
                                    <input type="text" class="required" name="access.customerid2" id="oa-customerid2-oaAccessHandlePage" value="${customer.id }:${customer.name }" data-clear-btn="false" readonly="readonly"/>
                                </c:when>
                                <c:otherwise>
                                    <input type="text" class="required" name="access.customerid2" id="oa-customerid2-oaAccessHandlePage" value="" data-clear-btn="false" readonly="readonly"/>
                                </c:otherwise>
                            </c:choose>
                            <input type="hidden" class="required" name="access.customerid" id="oa-customerid-oaAccessHandlePage" value="${customer.id }" data-clear-btn="false" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>执行地点
                    ...
                    <div class="ui-field-contain">
                        <label>工厂金额
                            <input type="text" name="access.factoryamount" id="oa-factoryamount-oaAccessHandlePage" value="${access.factoryamount }" data-clear-btn="false" readonly="readonly"/>
                        </label>
                    </div>
                    --%>
                    <div class="ui-field-contain">
                        <label>自理金额
                            <input type="number" name="access.myamount" id="oa-myamount-oaAccessHandlePage" value="${access.myamount }" data-clear-btn="false" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>收回方式
                    ...
                    <div class="ui-field-contain">
                        <label>说明
                            <textarea name="access.remark1" id="oa-remark1-oaAccessHandlePage" readonly="readonly" maxlength="166"><c:out value="${access.remark1}"/></textarea>
                        </label>
                    </div>
                </div>
            </div>
            <div class="ui-corner-all custom-corners">
                ...
                <div class="ui-body ui-body-a">
                    <div class="ui-field-contain">
                        <label>确认时间
                            <input type="text" class="dateISO" name="access.conbegindate" id="oa-conbegindate-oaAccessHandlePage" value="${access.conbegindate }" data-clear-btn="false" readonly="readonly"/>
                            <input type="text" class="dateISO" name="access.conenddate" id="oa-conenddate-oaAccessHandlePage" value="${access.conenddate }" data-clear-btn="false" readonly="readonly"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>降价设定时间
                            <input type="text" class="dateISO" name="access.combegindate" id="oa-combegindate-oaAccessHandlePage" value="${access.combegindate }" data-clear-btn="false" readonly="readonly"/>
                            <input type="text" class="dateISO" name="access.comenddate" id="oa-comenddate-oaAccessHandlePage" value="${access.comenddate }" data-clear-btn="false" readonly="readonly"/>
                        </label>
                    </div>
            ...
            <div class="ui-corner-all custom-corners">
                ...
                <div class="ui-body ui-body-a">
                    <div class="ui-field-contain">
                        <label>电脑冲差金额
                            <input type="number" name="access.compdiscount" id="oa-compdiscount-oaAccessHandlePage" value="${access.compdiscount }" data-clear-btn="true"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>电脑降价金额
                            <input type="number" name="access.comdownamount" id="oa-comdownamount-oaAccessHandlePage" value="${access.comdownamount }" data-clear-btn="true"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>支票金额
                            <input type="number" name="access.payamount" id="oa-payamount-oaAccessHandlePage" value="${access.payamount }" data-clear-btn="true"/>
                        </label>
                    </div>
                    <div class="ui-field-contain">
                        <label>结算金额
                            <input type="number" name="access.branchaccount" id="oa-branchaccount-oaAccessHandlePage" value="${access.branchaccount }" data-clear-btn="true"/>
                        </label>
                    </div>
                </div>
            </div>
