							...
							<div class="easyui-panel" data-options="border:false">
								<table style="border-collapse:collapse;" border="0" cellpadding="2" cellspacing="2">
									<tr>
										...
										<td class="len200"><input class="easyui-validatebox" style="width: 193px;" name="access.supplierid" value="${access.supplierid }" id="oa-supplierid-oaAccessHandlePage" autocomplete="off"/></td>
										...
										<td>
											<c:choose>
												<c:when test="${empty access.pricetype and empty access.expensesort}">
													<select name="access.pricetype" id="oa-pricetype-oaAccessHandlePage" class="easyui-validatebox len192" data="${access.pricetype }" disabled="disabled">
												</c:when>
												<c:otherwise>
													<select name="access.pricetype" id="oa-pricetype-oaAccessHandlePage" class="easyui-validatebox len192" data="${access.pricetype }" disabled="disabled">
												</c:otherwise>
									...
									<tr>
										<td class="left">客户：</td>
										<td class=""><input class="easyui-validatebox" style="width: 193px;" name="access.customerid" id="oa-customerid-oaAccessHandlePage" value="${access.customerid }" autocomplete="off"/></td>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
                                        ...
                                        <td class="len200"><input class="easyui-numberbox len173" name="access.myamount" id="oa-myamount-oaAccessHandlePage" value="${access.myamount }" autocomplete="off" data-options="precision:2" readonly="readonly"/></td>
										<td class="right len80">收回方式：</td>
										<td class="len200">
											<select class="easyui-validatebox len173" name="access.reimbursetype" id="oa-reimbursetype-oaAccessHandlePage" data="${access.reimbursetype }" data-options="required:false" disabled="disabled">
												<option></option>
										...
										<td class=""><input class="easyui-validatebox Wdate len120" name="access.reimbursedate" value="${access.reimbursedate }" id="oa-reimbursedate-oaAccessHandlePage" onclick="" style=" margin-left: 0px;" autocomplete="off" readonly="readonly"/></td>
									</tr>
									<tr>
										<td class="left">说明：</td>
										<td colspan="9">
											<textarea name="access.remark1" id="oa-remark1-oaAccessHandlePage" style="width: 690px; height: 50px; resize: none" readonly="readonly"><c:out value="${access.remark1 }" escapeXml="true"></c:out></textarea>
										</td>
									</tr>
								</table>
							</div>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
                                        ...
                                        <td class="left">
                                            <select class="easyui-validatebox len100" name="access.paytype" id="oa-paytype-oaAccessHandlePage" data="${access.paytype }" disabled="disabled">
                                                <option></option>
										...
										<td class="left">
											<c:choose>
												<c:when test="${not empty access.totalnum }">
													<input class="easyui-numberbox len212" name="access.totalnum" id="oa-totalnum-oaAccessHandlePage" value="${access.totalnum }" autocomplete="off" data-options="required:true, precision:0" readonly="readonly"/>
												</c:when>
												<c:otherwise>
													<input class="easyui-numberbox len212" name="access.totalnum" id="oa-totalnum-oaAccessHandlePage" value="0" autocomplete="off" data-options="required:true, precision:0" readonly="readonly"/>
												</c:otherwise>
											</c:choose>
										</td>
										-->
										...
										<td class="left">
											<c:choose>
												<c:when test="${not empty access.totalamount }">
													<input class="easyui-numberbox len212" style="width: 212px;" name="access.totalamount" id="oa-totalamount-oaAccessHandlePage" value="${access.totalamount }" autocomplete="off" data-options="required:true, precision:2" readonly="readonly"/>
												</c:when>
												<c:otherwise>
													<input class="easyui-numberbox len212" style="width: 212px;" name="access.totalamount" id="oa-totalamount-oaAccessHandlePage" value="0.00" autocomplete="off" data-options="required:true, precision:2" readonly="readonly"/>
												</c:otherwise>
											</c:choose>
										</td>
                                        <td class="left">支付日期：</td>
                                        <td><input class="easyui-validatebox Wdate len100" name="access.paydate" value="${access.paydate }" id="oa-paydate-oaAccessHandlePage" onclick="" autocomplete="off" readonly="readonly"/></td>
									</tr>
								</table>
							</div>
							<div class="easyui-panel" data-options="border:true" style="height: 152px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;"><!-- style="height: 200px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;" -->
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td class="len108"><input class="easyui-numberbox" style="width: 90px" name="access.compdiscount" id="oa-compdiscount-oaAccessHandlePage" value="${access.compdiscount }" autocomplete="off" data-options="required:false,precision:2"/></td>
										<td class="len90 right">电脑降价金额：</td>
										<td class="len108"><input class="easyui-numberbox" style="width: 90px" name="access.comdownamount" id="oa-comdownamount-oaAccessHandlePage" value="${access.comdownamount }" autocomplete="off" data-options="required:false,precision:2"/></td>
										<td class="len80 right">支票金额：</td>
										<td class="len108"><input class="easyui-numberbox" style="width: 90px" name="access.payamount" id="oa-payamount-oaAccessHandlePage" value="${access.payamount }" autocomplete="off" data-options="required:false,precision:2,onChange:computeBranchaccount"/></td>
										<td class="len80 right">结算金额：</td>
										<td class="len108"><input class="easyui-numberbox" style="width: 90px" name="access.branchaccount" id="oa-branchaccount-oaAccessHandlePage" value="${access.branchaccount }" autocomplete="off" data-options="required:false,min:-9999999999,precision:2"/></td>
									</tr>
								</table>
							</div>
							...
							<div id="oa-invoice-oaAccessHandlePage" class="easyui-panel" data-options="border: false" title="支票支付">
								<table>
									...
									<tr>
										...
										<td class=""><input class="easyui-numberbox len80" name="invoice.payamount" id="oa-payamount2-oaAccessHandlePage" value="${invoice.payamount }" autocomplete="off" data-options="required:false,precision:2,onChange:upperPayamount"/></td>
										...
										<td class=""><input class="easyui-validatebox len90" name="invoice.expensesort" id="oa-expensesort2-oaAccessHandlePage" value="${invoice.expensesort }" autocomplete="off" data-options="required:false"/></td>
