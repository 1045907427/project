				...
				<div data-options="region:'center',border:false">
					<div style="margin: 20px auto; width: 840px; border: 1px solid #AAA;">
						...
						<div class="easyui-panel" data-options="border:false" title="第一确认：工厂">
							...
							<!-- 商品明细一览 -->
							<div class="easyui-panel" data-options="border:true" style="height: 160px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;"><!-- style="height: 200px; border-top: solid 1px #aaa; border-bottom: solid 1px #aaa;" -->
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td class="len150"><input class="easyui-validatebox Wdate len120" name="access.reimbursedate" value="${access.reimbursedate }" id="oa-reimbursedate-oaAccessHandlePage" onclick="" style=" margin-left: 0px;" autocomplete="off" readonly="readonly"/></td>
									</tr>
									<tr>
										<td class="left">说明：</td>
										<td colspan="9">
								...
								<table>
									<tr>
										...
										<td class="len220 condate">
											<input class="easyui-validatebox Wdate len100" name="access.conbegindate" id="oa-conbegindate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off" value="${access.conbegindate }"/>～<input class="easyui-validatebox Wdate len100" name="access.conenddate" id="oa-conenddate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off" value="${access.conenddate }"/>
										</td>
										<td class="left len90 comdate">降价设定时间：</td>
										<td class="len220 comdate">
											<input class="easyui-validatebox Wdate len100" name="access.combegindate" id="oa-combegindate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off" value="${access.combegindate }"/>～<input class="easyui-validatebox Wdate len100" name="access.comenddate" id="oa-comenddate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM-dd'})" style=" margin-left: 0px;" autocomplete="off" value="${access.comenddate }"/>
										</td>
                                        <td class="left len70">支付方式：</td>
                                        <td class="right">
                                            <select class="easyui-validatebox len100" name="access.paytype" id="oa-paytype-oaAccessHandlePage" data="${access.paytype }">
                                                <option></option>
										...
										<td class="left">
											<c:choose>
												<c:when test="${not empty access.totalnum }">
													<input class="easyui-numberbox len212" name="access.totalnum" id="oa-totalnum-oaAccessHandlePage" value="${access.totalnum }" autocomplete="off" data-options="required:true, precision:0"/>
												</c:when>
												<c:otherwise>
													<input class="easyui-numberbox len212" name="access.totalnum" id="oa-totalnum-oaAccessHandlePage" value="0" autocomplete="off" data-options="required:true, precision:0"/>
												</c:otherwise>
											</c:choose>
										</td>
										-->
										...
										<td class="left">
											<c:choose>
												<c:when test="${not empty access.totalamount }">
													<input class="easyui-numberbox len212" style="width: 212px;" name="access.totalamount" id="oa-totalamount-oaAccessHandlePage" value="${access.totalamount }" autocomplete="off" data-options="required:true, precision:2"/>
												</c:when>
												<c:otherwise>
													<input class="easyui-numberbox len212" style="width: 212px;" name="access.totalamount" id="oa-totalamount-oaAccessHandlePage" value="0.00" autocomplete="off" data-options="required:true, precision:2"/>
												</c:otherwise>
											</c:choose>
										</td>
                                        <td class="left">支付日期：</td>
                                        <td><input class="easyui-validatebox Wdate len100" name="access.paydate" value="${access.paydate }" id="oa-paydate-oaAccessHandlePage" onclick="WdatePicker({'dateFmt':'yyyy-MM'})" autocomplete="off"/></td>
									</tr>
								</table>
							</div>
							...
							<div class="easyui-panel" data-options="border: false">
								<table>
									<tr>
										...
										<td><textarea name="access.remark2" id="oa-remark2-oaAccessHandlePage" style="width: 711px; height: 50px; resize: none"><c:out value="${access.remark2 }" escapeXml="true"></c:out></textarea></td>
									</tr>
								</table>
							</div>
