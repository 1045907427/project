...
<html>
  <head>
      ...
      <link rel="stylesheet" href="<%=request.getContextPath()%>/oa/hd/common/css/print.css" type="text/css"></link>
      <style type="text/css">
          table {
    ...
    <div class="limit-width2 align-center">
        ...
        <table>
            ...
            <tr>
                ...
                <td colspan="1">支付日期</td>
                <td colspan="4"><span><c:out value="${access.paydate }"/></span></td>
            </tr>
            <tr>
