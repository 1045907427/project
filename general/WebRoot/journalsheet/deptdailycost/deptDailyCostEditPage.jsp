  		...
  		<form action="" id="deptDailyCost-form-detailAdd" method="post">
   		<table>
   			<tr>
   				...
   				<td class="len140"><input type="text" class="len136 easyui-validatebox" name="deptdailycost.id" value="${deptdailycost.id }" readonly="readonly"/></td>
   				<td class="len80 right">业务日期：</td>
   				<td class="len140"><input type="text" id="deptDailyCost-detail-businessdate" class="len136 easyui-validatebox Wdate" onfocus="WdatePicker({'dateFmt':'yyyy-MM-dd'})" value="${deptdailycost.businessdate }" required="required" name="deptdailycost.businessdate" /></td>
   			...
   			<tr>
   				...
   				<td colspan="3">
   					<input type="text" id="deptDailyCost-detail-supplier" style="width:280px;" name="deptdailycost.supplierid" value="${deptdailycost.supplierid}" text="${deptdailycost.suppliername }"/>
   					<span id="deptDailyCost-detail-supplier-showid" style="margin-left:5px;line-height:25px;"></span>
   				</td>   				
   				<td class="right">所属部门：</td>
   				<td>
   					<input type="text" id="deptDailyCost-detail-deptid" name="deptdailycost.deptid" value="${deptdailycost.deptid }" class="len150"/>
   				</td>
   			</tr>
   			<tr>
   				<td class="right">费用科目：</td>
   				<td>
   					<input class="len136" type="text" id="deptDailyCost-detail-costsort" name="deptdailycost.costsort" value="${deptdailycost.costsort }"/>
   				</td>
   				<td class="right">品牌：</td>
   				<td>
   					<input class="len150" type="text" id="deptDailyCost-detail-brandid" name="deptdailycost.brandid" value="${deptdailycost.brandid }"/>
   				</td>
   				<td class="right">单位：</td>
   				<td>
   					<input class="len136" type="text" id="deptDailyCost-detail-unitid" name="deptdailycost.unitid" value="${deptdailycost.unitid }"/>
   				</td>
                <!--
   				<td>OA编号：</td>
   				<td>
   			...
   			<tr>
   				...
   				<td>
   					<input type="text" id="deptDailyCost-detail-unitnum" name="deptdailycost.unitnum" class="len136 easyui-validatebox" required="true" validType="intOrFloatNum[${decimallen}]" value="${deptdailycost.unitnum }"/>
   				</td>
   				<td class="right">单价：</td>
   				<td>
   					<input type="text" id="deptDailyCost-detail-taxprice" name="deptdailycost.taxprice" class="len136 easyui-validatebox" required="true" validType="intOrFloat" value="${deptdailycost.taxprice }"/>
   				</td>
                <td class="right">金额：</td>
                <td>
                    <input type="text" id="deptDailyCost-detail-amount" name="deptdailycost.amount" autocomplete="off" class="len150 easyui-validatebox" required="true" validType="intOrFloat" value="${deptdailycost.amount }"/>
                </td>
   			</tr>
   			<tr>
                <td class="right">人员：</td>
                <td>
                    <input class="len136" type="text" id="deptDailyCost-detail-salesuser" name="deptdailycost.salesuser" value="${deptdailycost.salesuser }"/>
                </td>
   				<td class="right">银行名称：</td>
   				<td>
   					<input class="len136" type="text" id="deptDailyCost-detail-bank" name="deptdailycost.bankid" value="${deptdailycost.bankid }"/>
   				</td>
   			</tr>
   			<tr>
   				<td class="right">备注：</td>
   				<td colspan="5" style="text-align: left">
   					<textarea id="deptDailyCost-detail-remark" style="width: 600px;height: 50px;" name="deptdailycost.remark" ><c:out value="${deptdailycost.remark }"/></textarea>
    ...
    <script type="text/javascript">
    	$(function(){
			...
			$("#deptDailyCost-detail-addbutton").click(function(){
				...
				$("#deptDailyCost-form-detailAdd").attr("action", "journalsheet/deptdailycost/editDeptDailyCost.do");
