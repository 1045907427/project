    			...
    			<form action="" method="post" id="matcostsReimburse-form-add" style="padding: 10px;">
	    			...
	    			<table cellpadding="2" cellspacing="2" border="0">
	    				<tr>
	    					...
	    					<td align="left" colspan="3"><input id="matcostsReimburse-date-businesstime" type="text" name="matcostsInput.businessdate" value="${matcostsInput.businessdate }" class="easyui-validatebox" required="true" style="width:120px" onclick="WdatePicker({firstDayOfWeek:1,dateFmt:'yyyy-MM-dd',minDate:'1958-01-01',maxDate:'%y-%M-%ld'})"/></td>	    					
	    				</tr>
	    				<tr>	    					
	    					<td align="right">供应商:</td>
	    					<td align="left" colspan="3"><input id="matcostsReimburse-widget-supplierid" type="text" name="matcostsInput.supplierid" value="${matcostsInput.supplierid }" text="${matcostsInput.suppliername}" style="width:320px;" /></td>    					
	    				</tr>
	    				<tr>
	    					<td width="70px" align="right">所属部门:</td>
	    					<td align="left"><input id="matcostsReimburse-widget-supplierdeptid" name="matcostsInput.supplierdeptid" value="${matcostsInput.supplierdeptid }"  type="text" style="width: 120px;"/></td>				
	    					<td width="70px" align="right">收回方式:</td>
	    					<td ><input id="matcostsReimburse-widget-reimbursetype" name="matcostsInput.reimbursetype" value="${matcostsInput.reimbursetype }" type="text" style="width:120px;"/></td>  					
	    				</tr>
	    				<tr>	    					
	    					<td align="right">银行名称:</td>
	    					<td align="left"><div id="matcostsReimburse-widget-bankid-div"></div></td>	    					
	    					<td align="right">收回科目:</td>
	    					<td align="left"><input id="matcostsReimburse-widget-shsubjectid" name="matcostsInput.shsubjectid" value="${matcostsInput.shsubjectid }" type="text" style="width:120px;" /></td>
	    				</tr>
	    				<tr>
	    					<td align="right">单位:</td>
	    					<td align="left"><input id="matcostsReimburse-text-unitid" name="matcostsInput.unitid" value="${matcostsInput.unitid }" type="text" style="width:120px;"/></td>	    					
	    					<td align="right">数量:</td>
	    					<td align="left"><input id="matcostsReimburse-text-unitnum" name="matcostsInput.unitnum" value="${matcostsInput.unitnum }" type="text" style="width:120px;" class="easyui-validatebox" required="true" validType="intOrFloatNum[${decimallen}]"/></td>
	    				</tr>
	    				<tr>
	    					<td align="right">单价:</td>
	    					<td align="left"><input id="matcostsReimburse-text-taxprice" name="matcostsInput.taxprice" value="${matcostsInput.taxprice }" type="text" style="width:120px;" class="easyui-validatebox" required="true" validType="intOrFloat"/></td>
	    					<td align="right">金额:</td>
	    					<td align="left"><input id="matcostsReimburse-text-reimburseamount" name="matcostsInput.reimburseamount" value="${matcostsInput.reimburseamount }" type="text" style="width:120px;" class="easyui-validatebox" required="true" validType="intOrFloat"/></td>
	    				</tr>
	    				<tr>
	    					<td align="right">备注:</td>
	    					<td align="left" colspan="3">
	    						<textarea id="matcostsReimburse-text-remark" name="matcostsInput.remark" class="easyui-validatebox" validType="maxLen[200]" style="width: 320px;height:60px;">${matcostsInput.remark }</textarea>
	    					</td>
	    				</tr>
	    			</table>
	    		</form>
    ...
    <script type="text/javascript">
    	...
    	$(function(){
        	...
        	$("#matcostsReimburse-save-saveMenu").click(function(){
            	...
            	var reimburseamount=$("#matcostsReimburse-text-reimburseamount").val();
            	if(reimburseamount==""){
            		$("#matcostsReimburse-text-reimburseamount").val(0);
            	}
            	
           		var ret = matcostsReimburse_AjaxConn($("#matcostsReimburse-form-add").serializeJSON(),'journalsheet/matcostsInput/editMatcostsReimburse.do','提交中..');
			...
			showBankidWidget(false,'${matcostsInput.bankid}');
		  //收回方式
            ...
            $("#matcostsReimburse-text-reimburseamount").bind('keydown',function(e){
   			...
   			$("#matcostsReimburse-text-remark").bind("keydown",function(event){
				//enter
				if(event.keyCode==13){
					$(this).blur();
					$("#matcostsReimburse-saveAgain-saveMenu").focus();
				}
   			});
