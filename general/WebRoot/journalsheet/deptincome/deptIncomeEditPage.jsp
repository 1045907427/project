  		...
  		<form action="" id="deptIncome-form-detailAdd" method="post">
   		<table>
   			<tr>
   				...
   				<td class="len140"><input type="text" class="len136 easyui-validatebox" name="deptIncome.id" value="${deptIncome.id }" readonly="readonly"/></td>
   				<td class="len80 right">业务日期：</td>
   				<td class="len140"><input type="text" id="deptIncome-detail-businessdate" class="len136 easyui-validatebox Wdate" onfocus="WdatePicker({'dateFmt':'yyyy-MM-dd'})" value="${deptIncome.businessdate }" required="required" name="deptIncome.businessdate" /></td>
   			...
   			<tr>
   				...
   				<td colspan="3">
   					<input type="text" id="deptIncome-detail-supplier" style="width:280px;" name="deptIncome.supplierid" value="${deptIncome.supplierid}" text="${deptIncome.suppliername }"/>
   					<span id="deptIncome-detail-supplier-showid" style="margin-left:5px;line-height:25px;"></span>
   				</td>   				
   				<td class="right">所属部门：</td>
   				<td>
   					<input type="text" id="deptIncome-detail-deptid" name="deptIncome.deptid" value="${deptIncome.deptid }" class="len150"/>
   				</td>
   			</tr>
   			<tr>
   				<td class="right">收入科目：</td>
   				<td>
   					<input class="len136" type="text" id="deptIncome-detail-costsort" name="deptIncome.costsort" value="${deptIncome.costsort }"/>
   				</td>
   				<td class="right">品牌：</td>
   				<td>
   					<input class="len150" type="text" id="deptIncome-detail-brandid" name="deptIncome.brandid" value="${deptIncome.brandid }"/>
   				</td>
   				<td class="right">单位：</td>
   				<td>
   					<input class="len136" type="text" id="deptIncome-detail-unitid" name="deptIncome.unitid" value="${deptIncome.unitid }"/>
   				</td>
                <!--
   				<td>OA编号：</td>
   				<td>
   			...
   			<tr>
   				...
   				<td>
   					<input type="text" id="deptIncome-detail-unitnum" name="deptIncome.unitnum" class="len136 easyui-validatebox" required="true" validType="intOrFloatNum[${decimallen}]" value="${deptIncome.unitnum }"/>
   				</td>
   				<td class="right">单价：</td>
   				<td>
   					<input type="text" id="deptIncome-detail-taxprice" name="deptIncome.taxprice" class="len136 easyui-validatebox" required="true" validType="intOrFloat" value="${deptIncome.taxprice }"/>
   				</td>
                <td class="right">金额：</td>
                <td>
                    <input type="text" id="deptIncome-detail-amount" name="deptIncome.amount" autocomplete="off" class="len150 easyui-validatebox" required="true" validType="intOrFloat" value="${deptIncome.amount }"/>
                </td>
   			</tr>
   			<tr>
   				<td class="right">银行名称：</td>
   				<td colspan="5">
   					<input class="len136" type="text" id="deptIncome-detail-bank" name="deptIncome.bankid" value="${deptIncome.bankid }"/>
   				</td>
   			</tr>
   			<tr>
   				<td class="right">备注：</td>
   				<td colspan="5" style="text-align: left">
   					<textarea id="deptIncome-detail-remark" style="width: 600px;height: 50px;" name="deptIncome.remark" ><c:out value="${deptIncome.remark }"/></textarea>
    ...
    <script type="text/javascript">
    	$(function(){
			...
			$("#deptIncome-detail-addbutton").click(function(){
				...
				$("#deptIncome-form-detailAdd").attr("action", "journalsheet/deptincome/editDeptIncome.do");
