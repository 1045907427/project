            ...
            <table  border="0" class="box_table">
                <tr>
                    ...
                    <td style="text-align: left;">
                        <input type="text" id="contract-caluseid-contractDetailPage" name="caluseid" style="width:160px;"  />
                    </td>
                    <td>费用类型:</td>
                    <td style="text-align: left;">
                ...
                <tr>
                    <td>支付月份:</td>
                    <td style="text-align: left;">
                        <input type="text" id="contract-returnmonthnum-contractDetailPage" name="returnmonthnum" style="width:160px;" readonly="readonly" value="0"  />
                    </td>
                    <td>支付要求:</td>
                    <td >
...
<script type="text/javascript">
    ...
    $(function() {
        ...
        $("#contract-caluseid-contractDetailPage").widget({
            referwid:'RL_T_FINANCE_CONTRACT_CALUSE',
            width:160,
            singleSelect:true,
            required:true,
            initValue:'',
            onSelect: function(data) {
                console.log(data)
                if("1" == data.returntype || "2" == data.returntype){
                    $("#contract-returnmonthnum-contractDetailPage").removeAttr("readonly");
                    $("#contract-returnmonthnum-contractDetailPage").val(data.returnmonthnum);
                }else{
                    $("#contract-returnmonthnum-contractDetailPage").removeAttr("readonly");
                    $("#contract-returnmonthnum-contractDetailPage").val("0");
                    $("#contract-returnmonthnum-contractDetailPage").attr("readonly","readonly");
                ...
                $("#contract-costtype-contractDetailPage").val(data.costtype);
                $("#contract-sharetype-contractDetailPage").val(data.sharetype);
                $("#contract-returntype-contractDetailPage").val(data.returntype);
                $("#contract-returnrequire-contractDetailPage").val(data.returnrequire);
                $("#contract-subjectexpenses-contractDetailPage").widget("setValue",data.subjectexpenses);
                $("#contract-subjectexpensesname-contractDetailPage").val(data.subjectexpensesname);
