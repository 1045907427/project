...
<html>
  ...
  <div class="easyui-layout" data-options="fit:true">
  		<div data-options="region:'center',border:false">
		  	<form id="purchase-form-arrivalOrderSourceDetailEditPage" method="post">
		  		<table style="border-collapse:collapse;" border="0" cellpadding="5" cellspacing="5">
					...
					<tr>
						...
						<td><input type="text" id="purchase-arrivalOrderDetail-notaxamount" name="notaxamount" class="easyui-validatebox <c:if test="${colMap.notaxprice == null }">readonly</c:if>"  required="required" validType="intOrFloat"  <c:if test="${colMap.notaxprice == null }">readonly="readonly"</c:if> style="width:150px;"/></td>
					</tr>
					<tr>
	...
	<script type="text/javascript">
		...
		function saveOrderDetail(){
	    	$("#purchase-arrivalOrderDetail-remark").focus();
  			var flag=$("#purchase-form-arrivalOrderSourceDetailEditPage").form('validate');
  			if(!flag){
	  			return false;
  			}

			var formdata=$("#purchase-form-arrivalOrderSourceDetailEditPage").serializeJSON();
			//保存前判断单价*数量 是否跟金额一致
