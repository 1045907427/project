  ...
  <body>
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'north',split:true,border:false" style="height:260px">
			<table id="purchase-planOrderDatagrid-buyOrderSourcePage"></table>
		</div>
		<div data-options="region:'center',border:false">
			<table id="purchase-planOrderdetailDatagrid-buyOrderSourcePage"></table>
		</div>
	</div>
	<script type="text/javascript">
		$(function(){
			$("#purchase-planOrderdetailDatagrid-buyOrderSourcePage").datagrid({
		 		fit:true,
		 		method:'post',
		 		rownumbers:true,
		 		idField:'id',
		 		<c:choose>
		 			<c:when test="${choicerefer == 1}">
			 			singleSelect:true,	
			 		</c:when>
		 			<c:otherwise>
				 		singleSelect:false,
				...
				columns:[[				
						...
						{field:'notaxprice',title:'无税单价',width:60,align:'right',
							formatter: function(value,row,index){
			        			return formatterMoney(value);
				        	}
				        },
