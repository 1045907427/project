...
<div class="easyui-layout" data-options="fit:true,border:false">
    <form id="crm-form-customerStorageOrderAddPage" action="" method="post">
        <div data-options="region:'north',border:false" style="height:140px;">
            <table style="border-collapse:collapse;" border="0" cellpadding="5px" cellspacing="5px">
                <tr>
                    <td class="len80 left">编&nbsp;&nbsp;号：</td>
                    <td class="len165"><input class="len150 easyui-validatebox" id="crm-id-customerStorageOrderAddPage" name="customerStorageOrder.id" value="${customerStorageOrder.id}"
                                  <c:if test="${autoCreate == true }">readonly='readonly'</c:if> <c:if test="${autoCreate == false }">required="required"</c:if> /></td>
                    <td class="len80 left">业务日期：</td>
                    <td class="len165"><input id="crm-businessdate-customerStorageOrderAddPage" type="text" readonly class="len150 Wdate" onfocus="WdatePicker({'dateFmt':'yyyy-MM-dd'})" name="customerStorageOrder.businessdate" value="${customerStorageOrder.businessdate}"/></td>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" id="crm-customer-customerStorageOrderAddPage" name="customerStorageOrder.customerid" readonly text="<c:out value="${customerStorageOrder.customername }"></c:out>" value="${customerStorageOrder.customerid }" style="width: 300px;"/>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" id="crm-salesDept-customerStorageOrderAddPage" readonly name="customerStorageOrder.salesdept" value="${customerStorageOrder.salesdept }"/>
                    </td>
                    <td class="len80 left">客户业务员：</td>
                    <td>
                        <input type="text" id="crm-salesMan-customerStorageOrderAddPage" readonly name="customerStorageOrder.salesuser" value="${customerStorageOrder.salesuser }"/>
                    </td>
                    <td>客户单号：</td>
                    <td class="len165"><input class="len150 easyui-validatebox" readonly id="crm-sourceid-customerStorageOrderAddPage" name="customerStorageOrder.sourceid" value="${customerStorageOrder.sourceid }"/></td>
                </tr>
                <tr>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#crm-datagrid-customerStorageOrderAddPage").datagrid({ //销售商品明细信息编辑
            ...
            onDblClickRow: function(rowIndex, rowData) {
                ...
                if (rowData.goodsid != undefined) {
                    beginEditCustomerStorageDetail(rowData,true);
                }
            },
            onCheckAll:function(){
        ...
        $("#crm-buttons-customerStorageOrderPage").buttonWidget("setDataID",
                {id:'${customerStorageOrder.id}', state:'${customerStorageOrder.status}', type:'view'});
