...
<div class="easyui-layout" data-options="fit:true">
            ...
            <table cellpadding="5" cellspacing="2">
                <tr>
                    ...
                    <td>
                        ...
                        <input type="hidden" name="rowIndex" id="crm-rowIndex-terminalOrderDetailAddPage"/>
                        <input id="crm-usablenum-terminalOrderDetailAddPage" type="hidden" name="usablenum" value="0"/>
                    <td></td>
                </tr>
                <tr>
                    <td>数量：</td>
                    <td><input class="easyui-validatebox len150 formaterNum" name="unitnum"  data-options="required:true,validType:'intOrFloatNum[${decimallen}]'"/></td>
                    <td>辅数量：</td>
                    <td>
                        <input type="text" name="auxnum" class="formaterNum easyui-validatebox" style="width:60px;" data-options="validType:'integer'" />
                        <span id="crm-auxunitname-terminalOrderDetailAddPage"></span>
                        <input type="text" name="overnum" class="formaterNum easyui-validatebox" style="width:60px;" data-options="validType:'intOrFloatNum[${decimallen}]'" />
                        <span id="crm-unitname-terminalOrderDetailAddPage"></span>
                    </td>
                </tr>
                <tr>
                    <td>含税单价：</td>
                    <td><input type="text" class="len150 easyui-validatebox" validType="intOrFloat" name="taxprice" id="crm-taxprice-terminalOrderDetailAddPage" required="required" validType="intOrFloat" /> </td>
                    <td>含税金额：</td>
                    <td><input type="text" class="len150 easyui-validatebox" validType="intOrFloat" id="crm-taxamount-terminalOrderDetailAddPage" name="taxamount" validType="intOrFloat" /></td>
                </tr>
                <tr>
                    <td>含税箱价：</td>
                    <td><input type="text" class="len150 easyui-validatebox" validType="intOrFloat" name="boxprice" id="crm-boxprice-terminalOrderDetailAddPage" /> </td>
                    <td>箱装量：</td>
                    <td><input type="text" name="boxnum" id="crm-boxnum-terminalOrderDetailAddPage" class="len150 readonly"/></td>
                </tr>
                <tr>
                    <td>未税单价：</td>
                    <td><input type="text" class="len150 easyui-validatebox" validType="intOrFloat" name="notaxprice" id="crm-notaxprice-terminalOrderDetailAddPage" required="required" validType="intOrFloat"/> </td>
                    <td>未税金额：</td>
                    <td><input type="text" class="len150 easyui-validatebox" validType="intOrFloat" id="crm-notaxamount-terminalOrderDetailAddPage" name="notaxamount" required="required" validType="intOrFloat"/></td>
                </tr>
                <tr>
                    <td>税种：</td>
                    <td><input class="len150 readonly" readonly="readonly" name="taxtypename" /><input type="hidden" name="taxtype" /> </td>
                    <td>税额：</td>
                    <td><input class="len150 readonly no_input easyui-numberbox" validType="intOrFloat" id="crm-tax-terminalOrderDetailAddPage" readonly="readonly" name="tax" data-options="precision:6,groupSeparator:','" /></td>
                </tr>
                <tr>
                    <td>单位：</td>
                    <td>
    ...
    <div data-options="region:'south',border:false">
        <div class="buttonDetailBG" style="height:30px;text-align:right;">
            ...
            <input type="button" name="savegoon" id="crm-save-terminalOrderDetailAddPage" value="保存"/>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#crm-save-terminalOrderDetailAddPage").click(function(){
            addSaveDetail(false);
        });
    ...
    function unitnumChange(type){ //数量改变方法
        var orderid = $("#crm-id-orderAddPage").val();
