...
<html>
  <head>
    <title>按品牌部门销售情况统计报表</title>
    <%@include file="/include.jsp" %>   
    <script type="text/javascript" src="js/reportDatagrid.js" charset="UTF-8"></script>  
  </head>
  
  <body>
    	<table id="report-datagrid-brandDept"></table>
    	<div id="report-toolbar-brandDept" style="padding: 0px">
            <div class="buttonBG">
                <security:authorize url="/report/sales/brandDeptReportExport.do">
                    <a href="javaScript:void(0);" id="report-autoExport-brandDeptPage" class="easyui-linkbutton" iconCls="button-export" plain="true" >全局导出</a>
                </security:authorize>
            </div>
    		<form action="" id="report-query-form-brandDept" method="post">
    		<table class="querytable">
    			...
    			<tr>
    				...
    				<td colspan="2">
    					<a href="javaScript:void(0);" id="report-query-brandDeptPage" class="button-qr">查询</a>
						<a href="javaScript:void(0);" id="report-reload-brandDeptPage" class="button-qr">重置</a>
    	...
    	<div id="report-dialog-salesBrandDeptDetail"></div>
    	<script type="text/javascript">
			var SR_footerobject  = null;
    		var initQueryJSON = $("#report-query-form-brandDept").serializeJSON();
    		$(function(){

                $("#report-autoExport-brandDeptPage").click(function(){
                    var queryJSON = $("#report-query-form-brandDept").serializeJSON();
                    //获取排序规则
                    var objecr  = $("#report-datagrid-brandDept").datagrid("options");
                    ...
                    exportByAnalyse(queryParam,"分品牌部门销售情况统计报表","report-datagrid-brandDept",url);
                });

    			var tableColumnDeptListJson = $("#report-datagrid-brandDept").createGridColumnLoad({
					name :'t_report_sales_goods',
					frozenCol : [[
									{field:'idok',checkbox:true,isShow:true}
				    			]],
					commonCol : [[
						  {field:'branddept',title:'品牌部门',width:80,isShow:true,
                ...
                $("#report-datagrid-brandDept").datagrid({
					...
					columns:tableColumnDeptListJson.common,
			 		...
			 		selectOnCheck:true,
		  	 		pageSize:100,
					toolbar:'#report-toolbar-brandDept',
					onDblClickRow:function(rowIndex, rowData){
						var deptid = rowData.branddept;
    					...
    					var url = 'report/sales/showSalesBrandDeptDetailPage.do?deptid='+deptid+'&businessdate1='+businessdate1+'&businessdate2='+businessdate2+'&branddeptname='+branddeptname;
						$("#report-dialog-salesBrandDeptDetail").dialog({
		  	 		...
		  	 		onLoadSuccess:function(){
						...
						if(null!=footerrows && footerrows.length>0){
							...
							baseSalesReportCountTotalAmount('branddeptname',this);
						}
			 		},
					onCheckAll:function(){
						baseSalesReportCountTotalAmount('branddeptname',this);
				...
				//回车事件
				controlQueryAndResetByKey("report-query-brandDeptPage","report-reload-brandDeptPage");
				
				//查询
				$("#report-query-brandDeptPage").click(function(){
				...
				//重置
				$("#report-reload-brandDeptPage").click(function(){
					$("#report-query-brandDept").widget("clear");
					$("#report-query-form-brandDept")[0].reset();
					var queryJSON = $("#report-query-form-brandDept").serializeJSON();
		       		$("#report-datagrid-brandDept").datagrid('loadData',{total:0,rows:[]});
				});
