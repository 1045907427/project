...
<html>
  <head>
    <title>按客户分品牌分商品统计页面</title>
    <%@include file="/include.jsp" %>   
    <script type="text/javascript" src="js/reportDatagrid.js" charset="UTF-8"></script>  
  </head>
  
  <body>
  	<form action="" id="report-query-form-salesCustomerDetail" method="post">
  	...
  	<div id="report-tab-salesCustomerDetail" class="buttonBG">
		<security:authorize url="/report/sales/salesCustomerReportExport.do">
			<a href="javaScript:void(0);" id="report-export-salesCustomerDetail" class="easyui-linkbutton" iconCls="button-export" plain="true" title="导出">导出</a>
		</security:authorize>
	</div>
	<div id="tt" class="easyui-tabs" data-options="fit:true">
	    <div title="分品牌统计" style="padding:2px;">
	       <table id="report-datagrid-brandDetail"></table>
	    </div>
	    <div title="分商品统计" style="padding:2px;">
	        <table id="report-datagrid-goodsDetail"></table>
	    </div>
	</div>
    	<script type="text/javascript">
    		$('#tt').tabs({
				tools:'#report-tab-salesCustomerDetail'
			});
    		var initQueryJSON = $("#report-query-form-salesCustomerDetail").serializeJSON();
    		$(function(){
    			var brandDetailtableColumnListJson = $("#report-datagrid-brandDetail").createGridColumnLoad({
					frozenCol : [[]],
					commonCol : [[
						  ...
						  {field:'branddept',title:'品牌部门',width:60,sortable:true,
						  	formatter:function(value,rowData,rowIndex){
				...
				var goodsDetailtableColumnListJson = $("#report-datagrid-goodsDetail").createGridColumnLoad({
					frozenCol : [[]],
					commonCol : [[
    			...
    			$("#report-datagrid-brandDetail").datagrid({ 
					authority:brandDetailtableColumnListJson,
			 		frozenColumns: brandDetailtableColumnListJson.frozen,
					columns:brandDetailtableColumnListJson.common,
			 		method:'post',
		  	 		fit:true,
		  	 		pageSize:100,
		  	 		rownumbers:true,
		  	 		...
		  	 		showFooter: true,
		  	 		singleSelect:true,
					toolbar:'#report-tab-salesCustomerDetail',
					url: 'report/sales/showBaseSalesReportData.do?groupcols=brandid',
					queryParams:initQueryJSON
				}).datagrid("columnMoving");
				$("#report-datagrid-goodsDetail").datagrid({ 
					authority:goodsDetailtableColumnListJson,
			 		frozenColumns: goodsDetailtableColumnListJson.frozen,
					columns:goodsDetailtableColumnListJson.common,
			 		method:'post',
		  	 		title:'',
		  	 		fit:true,
		  	 		pageSize:100,
				...
				$("#report-export-salesCustomerDetail").Excel('export',{
					queryForm: "#report-query-form-salesCustomerDetail", //查询条件的form表单，导出时只用通过查询的条件，将通用查询放在form表单里面。
