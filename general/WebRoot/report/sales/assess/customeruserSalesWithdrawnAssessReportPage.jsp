...
<html>
<head>
    <title>分客户业务员销售回笼考核报表</title>
    <%@include file="/include.jsp" %>
    <script type="text/javascript" src="js/reportDatagrid.js" charset="UTF-8"></script>
    <script type="text/javascript" src="js/jquery.report.js" charset="UTF-8"></script>
</head>

<body>
<table id="report-datagrid-customeruserSalesWithdrawnAssess"></table>
<div id="report-toolbar-customeruserSalesWithdrawnAssess" style="padding: 0px">
    <div class="buttonBG">
        <security:authorize url="/report/sales/customeruserSalesWithdrawnAssessReportExport.do">
...
<script type="text/javascript">
    ...
    function computeDataCaseField(){
        ...
        query["billtype"] = "SalesWithdrawnCustomerUser";
    ...
    $(function(){
        var tableColumnListJson = $("#report-datagrid-customeruserSalesWithdrawnAssess").createGridColumnLoad({
            ...
            commonCol : [[
                ...
                {field:'salesdept',title:'公司',width:80,sortable:true,
                    formatter:function(value,rowData,rowIndex){
        ...
        $("#report-datagrid-customeruserSalesWithdrawnAssess").datagrid({
            ...
            selectOnCheck:true,
            pageSize:100,
            toolbar:'#report-toolbar-customeruserSalesWithdrawnAssess',
            onDblClickRow:function(rowIndex, rowData){
                <security:authorize url="/report/sales/addSaleWithdrawnTargetBysalesuser.do">
        ...
        $("#report-queay-customeruserSalesWithdrawnAssess").click(function(){
            ...
            $("#report-datagrid-customeruserSalesWithdrawnAssess").datagrid({
                //user参数是为了加载没有报表数据的 salesuser表示客户业务员
                url: 'report/sales/getSalesWithdrawnAssessData.do?groupcols=salesuser&customer=1',
                pageNumber:1,
        ...
        $("#report-export-customeruserSalesWithdrawnAssess").Excel('export',{
            ...
            name:'分客户业务员销售回笼考核报表',
            url:'report/sales/exportSalesWithdrawnAssessData.do?groupcols=salesuser&customer=1'
        });
    });
</script>
</body>
