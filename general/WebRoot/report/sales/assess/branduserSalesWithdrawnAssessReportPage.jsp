...
<html>
  ...
  <body>
    ...
    <div id="report-toolbar-branduserSalesWithdrawnAssess" style="padding: 0px">
        <div class="buttonBG">
            <security:authorize url="/report/sales/branduserSalesWithdrawnAssessReportExport.do">
    ...
    <script type="text/javascript">
		...
		function computeDataCaseField(){
			...
			query["billtype"] = "SalesWithdrawnBranduser";
    	...
    	$(function(){
			...
			$("#report-datagrid-branduserSalesWithdrawnAssess").datagrid({ 
				...
				onDblClickRow:function(rowIndex, rowData){
					<security:authorize url="/report/sales/addSaleWithdrawnTargetByBranduser.do">
			...
			$("#report-queay-branduserSalesWithdrawnAssess").click(function(){
                ...
                $("#report-datagrid-branduserSalesWithdrawnAssess").datagrid({
                    //user参数加载没有数据的品牌业务员
	      			url: 'report/sales/getSalesWithdrawnAssessData.do?groupcols=branduser&user=1',
	      			pageNumber:1,
			...
			$("#report-export-branduserSalesWithdrawnAssess").Excel('export',{
				queryForm: "#report-query-form-branduserSalesWithdrawnAssess", //查询条件的form表单，导出时只用通过查询的条件，将通用查询放在form表单里面。
		 		...
		 		name:'分品牌业务员销售回笼考核报表',
		 		url:'report/sales/exportSalesWithdrawnAssessData.do?groupcols=branduser&user=1'
			});
    	});
    </script>
  </body>
