...
<html>
<head>
    <title>分品牌业务员品牌销售回笼考核报表</title>
    <%@include file="/include.jsp" %>
    <script type="text/javascript" src="js/reportDatagrid.js" charset="UTF-8"></script>
</head>

<body>
<table id="report-datagrid-branduserSalesWithdrawnAssess"></table>
<div id="report-toolbar-branduserSalesWithdrawnAssess" style="padding: 0px">
    <div class="buttonBG">
        <security:authorize url="/report/sales/branduserByBrandSalesWithdrawnAssessReportExport.do">
            <a href="javaScript:void(0);" id="report-export-branduserSalesWithdrawnAssess" class="easyui-linkbutton" iconCls="button-export" plain="true" title="导出">导出</a>
        </security:authorize>
    </div>
    <form action="" id="report-query-form-branduserSalesWithdrawnAssess" method="post">
        <table class="querytable">
            ...
            <tr>
                ...
                <td>品牌业务员:</td>
                <td><input type="text" name="branduser" id="report-branduser-branduserSalesWithdrawnAssess"/></td>
                <td>
                <td>品牌:</td>
                <td><input type="text" name="brandid" id="report-brand-branduserSalesWithdrawnAssess"/></td>
                <td>
                    <a href="javaScript:void(0);" id="report-queay-branduserSalesWithdrawnAssess" class="button-qr">查询</a>
                    <a href="javaScript:void(0);" id="report-reload-branduserSalesWithdrawnAssess" class="button-qr">重置</a>
                </td>
            </tr>
        </table>
    </form>
...
<script type="text/javascript">
    ...
    //结束行编辑
    var $branduserSWADatagrid = $('#report-datagrid-branduserSalesWithdrawnAssess');
    ...
    function computeDataCaseField(){
        ...
        var query = $("#report-query-form-branduserSalesWithdrawnAssess").serializeJSON();
        query["rowstr"] = JSON.stringify(row);
        query["billtype"] = "SalesWithdrawnBrandByBrand";
    ...
    $(function(){
        var tableColumnListJson = $("#report-datagrid-branduserSalesWithdrawnAssess").createGridColumnLoad({
            frozenCol : [[
...
//                },
        ...
        $("#report-datagrid-branduserSalesWithdrawnAssess").datagrid({
            ...
            selectOnCheck:true,
            pageSize:100,
            toolbar:'#report-toolbar-branduserSalesWithdrawnAssess',
            onDblClickRow:function(rowIndex, rowData){
                <security:authorize url="/report/sales/addSaleWithdrawnTargetByBranduserAndBrand.do">
                if(undefined != rowData && undefined != rowData.branduser){
                    if(endEditing()){
                        editIndex = rowIndex;
            ...
            onLoadSuccess:function(){
                ...
                if(null!=footerrows && footerrows.length>0){
                    ...
                    salesWithdrawnAssessCountTotalAmount("brandusername",this);
                }
            },
            onCheckAll:function(){
                salesWithdrawnAssessCountTotalAmount("brandusername",this);
        ...
        $("#report-branduser-branduserSalesWithdrawnAssess").widget({
            referwid:'RL_T_BASE_PERSONNEL_BRANDSELLER',
            width:130,
            singleSelect:true
        });
        $("#report-brand-branduserSalesWithdrawnAssess").widget({
        ...
        //查询
        $("#report-queay-branduserSalesWithdrawnAssess").click(function(){
            var queryJSON = $("#report-query-form-branduserSalesWithdrawnAssess").serializeJSON();
            editIndex = undefined;
            businessdate = $("#report-businessdate1").val();
            $("#report-datagrid-branduserSalesWithdrawnAssess").datagrid({
                //personbranduser 参数加载所有品牌业务所有品牌
                url: 'report/sales/getSalesWithdrawnAssessData.do?groupcols=branduser&personbranduser=2',
                pageNumber:1,
                queryParams:queryJSON
            });
        });
        //重置
        $("#report-reload-branduserSalesWithdrawnAssess").click(function(){
            $("#report-branduser-branduserSalesWithdrawnAssess").widget("clear");
            $("#report-query-form-branduserSalesWithdrawnAssess")[0].reset();
            $("#report-datagrid-branduserSalesWithdrawnAssess").datagrid('loadData',{total:0,rows:[]});
            $("#report-brand-branduserSalesWithdrawnAssess").widget("clear");
        });

        $("#report-export-branduserSalesWithdrawnAssess").Excel('export',{
            queryForm: "#report-query-form-branduserSalesWithdrawnAssess", //查询条件的form表单，导出时只用通过查询的条件，将通用查询放在form表单里面。
            type:'exportUserdefined',
            name:'分品牌业务员品牌销售回笼考核报表',
            url:'report/sales/exportSalesWithdrawnAssessData.do?groupcols=branduser&personbranduser=2'
        });
    });
</script>
</body>
