...
<html>
  ...
  <body>
  	<form action="" id="report-query-form-salesSupplieruserDetail" method="post">
  	...
  	<div id="report-tab-salesSupplieruserDetail" class="buttonBG">
		<security:authorize url="/report/sales/salesSupplieruserReportExport.do">
			<a href="javaScript:void(0);" id="report-export-salesSupplieruserDetail" class="easyui-linkbutton" iconCls="button-export" plain="true" title="导出">导出</a>
		</security:authorize>
	</div>
	<div id="tt" class="easyui-tabs" data-options="fit:true">
	    <div title="分品牌统计" style="padding:2px;">
	       <table id="report-datagrid-salesSupplieruserDetail-brand"></table>
	    </div>
	    <div title="分客户统计" style="padding:2px;">
	        <table id="report-datagrid-salesSupplieruserDetail-customer"></table>
	    </div>
	    <div title="分客户分品牌统计" style="padding:2px;">
	      <table id="report-datagrid-salesSupplieruserDetail-brandAndCustomer"></table>
	    </div>
	</div>
    	<script type="text/javascript">
    		$('#tt').tabs({
				tools:'#report-tab-salesSupplieruserDetail'
			});
    		var initQueryJSON = $("#report-query-form-salesSupplieruserDetail").serializeJSON();
    		$(function(){
    			var brandTableColumnListJson = $("#report-datagrid-salesSupplieruserDetail-brand").createGridColumnLoad({
					frozenCol : [[]],
					commonCol : [[
				...
				var customerTableColumnListJson = $("#report-datagrid-salesSupplieruserDetail-customer").createGridColumnLoad({
					frozenCol : [[]],
					commonCol : [[
				...
				var brandcustomerTableColumnListJson = $("#report-datagrid-salesSupplieruserDetail-brandAndCustomer").createGridColumnLoad({
					frozenCol : [[]],
					commonCol : [[
    			...
    			$("#report-datagrid-salesSupplieruserDetail-brand").datagrid({ 
				...
				$("#report-datagrid-salesSupplieruserDetail-customer").datagrid({ 
				...
				$("#report-datagrid-salesSupplieruserDetail-brandAndCustomer").datagrid({ 
				...
				$("#report-export-salesSupplieruserDetail").Excel('export',{
					queryForm: "#report-query-form-salesSupplieruserDetail", //查询条件的form表单，导出时只用通过查询的条件，将通用查询放在form表单里面。
