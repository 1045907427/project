...
<html>
  <head>
    <title>按厂家业务员销售情况统计报表</title>
    <%@include file="/include.jsp" %>
    <script type="text/javascript" src="js/reportDatagrid.js" charset="UTF-8"></script>     
  </head>
  
  <body>
    	<table id="report-datagrid-salesSupplieruser"></table>
    	<div id="report-toolbar-salesSupplieruser" style="padding: 0px">
            <div class="buttonBG">
                <security:authorize url="/report/sales/salesSupplieruserReportExport.do">
                    <a href="javaScript:void(0);" id="report-autoExport-salesSupplieruserPage" class="easyui-linkbutton" iconCls="button-export" plain="true" title="全局导出">全局导出</a>
                </security:authorize>
            </div>
    		<form action="" id="report-query-form-salesSupplieruser" method="post">
	    		<table class="querytable">
	    			...
	    			<tr>
	    				...
	    				<td>厂家业务员:</td>
	    				<td><input type="text" id="report-query-supplieruser" name="supplieruser"/></td>
	    				<td colspan="2">
	    					<a href="javaScript:void(0);" id="report-queay-salesSupplieruser" class="button-qr">查询</a>
							<a href="javaScript:void(0);" id="report-reload-salesSupplieruser" class="button-qr">重置</a>
    	...
    	<div id="report-dialog-salesSupplieruserDetail"></div>
    	<script type="text/javascript">
			var SR_footerobject  = null;
    		var initQueryJSON = $("#report-query-form-salesSupplieruser").serializeJSON();
    		$(function(){
                $("#report-autoExport-salesSupplieruserPage").click(function(){
                    var queryJSON = $("#report-query-form-salesSupplieruser").serializeJSON();
                    //获取排序规则
                    var objecr  = $("#report-datagrid-salesSupplieruser").datagrid("options");
                    if(null != objecr.sortName && null != objecr.sortOrder ){
                        queryJSON["sort"] = objecr.sortName;
                        queryJSON["order"] = objecr.sortOrder;
                    }
                    var queryParam = JSON.stringify(queryJSON);
                    var url = "report/sales/exportBaseSalesReportData.do?groupcols=supplieruser";
                    exportByAnalyse(queryParam,"分厂家业务员销售情况统计报表","report-datagrid-salesSupplieruser",url);

                });
                
    			var tableColumnListJson = $("#report-datagrid-salesSupplieruser").createGridColumnLoad({
					frozenCol : [[
    			...
    			$("#report-datagrid-salesSupplieruser").datagrid({ 
					...
					columns:tableColumnListJson.common,
			 		...
			 		selectOnCheck:true,
		  	 		pageSize:100,
					toolbar:'#report-toolbar-salesSupplieruser',
					onDblClickRow:function(rowIndex, rowData){
    					...
    					var url = 'report/sales/showSalesSupplieruserDetailPage.do?supplieruser='+supplieruser+'&businessdate1='+businessdate1+'&businessdate2='+businessdate2+'&supplierusername='+supplierusername;
						$("#report-dialog-salesSupplieruserDetail").dialog({
							title:'按厂家业务员:['+rowData.supplierusername+']统计',
				    		width:800,
				    		height:400,
				    		closed:true,
				    		modal:true,
						...
						$("#report-dialog-salesSupplieruserDetail").dialog("open");
					},
		  	 		onLoadSuccess:function(){
						var footerrows = $(this).datagrid('getFooterRows');
						if(null!=footerrows && footerrows.length>0){
							SR_footerobject = footerrows[0];
							baseSalesReportCountTotalAmount('supplierusername',this);
						}
			 		},
					onCheckAll:function(){
						baseSalesReportCountTotalAmount('supplierusername',this);
				...
				//回车事件
				controlQueryAndResetByKey("report-queay-salesSupplieruser","report-reload-salesSupplieruser");
				
				//查询
				$("#report-queay-salesSupplieruser").click(function(){
		      		var queryJSON = $("#report-query-form-salesSupplieruser").serializeJSON();
		      		$("#report-datagrid-salesSupplieruser").datagrid({
		      			url: 'report/sales/showBaseSalesReportData.do?groupcols=supplieruser',
		      			pageNumber:1,
						queryParams:queryJSON
		      		});
				});
				//重置
				$("#report-reload-salesSupplieruser").click(function(){
					$("#report-query-supplieruser").widget("clear");
					$("#report-query-form-salesSupplieruser")[0].reset();
					var queryJSON = $("#report-query-form-salesSupplieruser").serializeJSON();
					$("#report-datagrid-salesSupplieruser").datagrid('loadData',{total:0,rows:[]});
				});
    		});
