...
<html>
  ...
  <body>
    	<table id="report-datagrid-baseSalesReceipt"></table>
    	<div id="report-toolbar-baseSalesReceipt" class="buttonBG">
            <a href="javaScript:void(0);" id="report-advancedQueay-baseSalesReceiptPage" class="easyui-linkbutton" iconCls="button-commonquery" plain="true" title="查询">查询</a>
            <security:authorize url="/report/finance/baseSalesReceiptExport.do">
                <a href="javaScript:void(0);" id="report-buttons-baseSalesReceiptPage" class="easyui-linkbutton" iconCls="button-export" plain="true" title="全局导出">全局导出</a>
            </security:authorize>
        </div>
        <div style="display: none">
            <div id="report-dialog-baseSalesReceiptPage">
                <form action="" id="report-query-form-baseSalesReceipt" method="post">
    	...
    	<script type="text/javascript">
    		...
    		var initQueryJSON = $("#report-query-form-baseSalesReceipt").serializeJSON();
    		$(function(){
                //全局导出
                $("#report-buttons-baseSalesReceiptPage").click(function(){
                    var queryJSON = $("#report-query-form-baseSalesReceipt").serializeJSON();
                    //获取排序规则
                    var objecr  = $("#report-datagrid-baseSalesReceipt").datagrid("options");
                    ...
                    exportByAnalyse(queryParam,"资金应收款情况表","report-datagrid-baseSalesReceipt",url);
                });
    			...
    			var tableColumnListJson = $("#report-datagrid-baseSalesReceipt").createGridColumnLoad({
    			...
    			$("#report-datagrid-baseSalesReceipt").datagrid({ 
                    ...
                    selectOnCheck:true,
		  	 		pageSize:100,
		  	 		singleSelect:false,
					toolbar:'#report-toolbar-baseSalesReceipt',
				...
				//回车事件
				controlQueryAndResetByKey("report-queay-baseSalesReceipt","report-reload-baseSalesReceipt");

                //高级查询
                $("#report-advancedQueay-baseSalesReceiptPage").click(function(){
                    $("#report-dialog-baseSalesReceiptPage").dialog({
                        maximizable:true,
                        resizable:true,
                        title: '资金应收款情况表查询',
                        top:30,
                        ...
                        buttons:[
                            {
                                ...
                                handler:function(){
                                    ...
                                    var queryJSON = $("#report-query-form-baseSalesReceipt").serializeJSON();
                                    $("#report-datagrid-baseSalesReceipt").datagrid("load",queryJSON);
                                    $("#report-dialog-baseSalesReceiptPage").dialog('close');
                                }
                            },
                            {
                                text:'重置',
                                handler:function(){
                                    $("#report-query-form-baseSalesReceipt").form("reset");
                                    $(".groupcols").each(function(){
                                        if($(this).attr("checked")){
                                    ...
                                    $("#report-query-form-baseSalesReceipt").form("reset");
                                    $('#report-datagrid-baseSalesReceipt').datagrid('loadData',{total:0,rows:[]});
                                    $('#report-datagrid-baseSalesReceipt').datagrid('reloadFooter',[]);
                                    setColumn();
                                }
                            }
                        ],
    		...
    		var $datagrid = $("#report-datagrid-baseSalesReceipt");
    		function setColumn(){
            ...
            function countTotalAmount(){
                ...
                var rows =  $("#report-datagrid-baseSalesReceipt").datagrid('getChecked');
                ...
                $("#report-datagrid-baseSalesReceipt").datagrid("reloadFooter",foot);
            }
    	</script>
  </body>
</html>
