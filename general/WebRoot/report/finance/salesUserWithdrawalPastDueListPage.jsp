...
<html>
  ...
  <body>
    	...
    	<div id="report-toolbar-withdrawalPastDue" style="padding: 0px">
            <div class="buttonBG">
                <security:authorize url="/report/finance/salesUserWithdrawalPastDueExport.do">
                    <a href="javaScript:void(0);" id="report-buttons-salesUserWithdrawalPastDuePage" class="easyui-linkbutton" iconCls="button-export" plain="true" title="导出">导出</a>
                </security:authorize>
    		...
    		<table>
    			...
    			<tr>
                    <td>客户业务员:</td>
                    <td><input type="text" id="report-query-customerid" name="salesuser"/></td>
    				<td colspan="2">
    	...
    	<div id="report-salesUserWithdrawalPastDue-detail-dialog"></div>
    	<script type="text/javascript">
    		...
    		$(function(){
    			$("#report-datagrid-withdrawalPastDue").datagrid({ 
					...
					onDblClickRow:function(rowIndex, rowData){
    					...
    					var url = 'report/finance/showSalesUserWithdrawalPastDueDetailPage.do?salesuser='+salesuser+'&salesusername='+salesusername+'&businessdate1='+businessdate1+'&businessdate2='+businessdate2;
						$("#report-salesUserWithdrawalPastDue-detail-dialog").dialog({
						...
						$("#report-salesUserWithdrawalPastDue-detail-dialog").dialog("open");
					},
    		...
    		function showDetail(salesuserid,pastseq,iswrite){
    			...
    			var businessdate1 = $("#report-query-businessdate1").val();
    			var businessdate2 = $("#report-query-businessdate2").val();
    			var url = 'report/finance/showSalesUserPastDueListPage.do?salesuserid='+salesuserid+'&seq='+pastseq+"&iswrite="+iswrite+'&businessdate1='+businessdate1+'&businessdate2='+businessdate2;
    		...
    		function countTotalAmount(){
        		...
        		var foot=[{salesusername:'选中合计',taxamount:taxamount,costamount:costamount,marginamount:marginamount,
