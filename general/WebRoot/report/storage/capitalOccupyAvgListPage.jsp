...
<html>
  ...
  <body>
   	<div id="report-button-QueryFundStatistics" style="padding: 0px">
        <div class="buttonBG">
            <security:authorize url="/report/storage/fundStatisticsAvgExport.do">
   		...
   		<form action="" id="report-form-QueryFundStatistics" method="post">
   			<table>
   				...
   				<tr>
   					<td>供 应 商:</td>
   					<td colspan="2"><input id="report-widget-supplierquery" style="width: 225px;" name="supplierid" type="text"/></td>
   					<td>
		...
		$(function(){
			...
			$("#report-query-capitalOccupy").click(function(){
				//把form表单的name序列化成JSON对象
	      		...
	      		$("#report-table-capitalOccupy").datagrid({
	      			url:'report/storage/showCapitalOccupyAvgListData.do',
	      			pageNumber:1,
			...
			$("#report-buttons-fundStatisticsPage").Excel('export',{
				queryForm: "#report-form-QueryFundStatistics", //查询条件的form表单，导出时只用通过查询的条件，将通用查询放在form表单里面。
		 		...
		 		name:'资金占用统计报表',
		 		url:'report/storage/exportCapitalOccupyAvgListData.do'
			});
