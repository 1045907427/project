...
<html>
  ...
  <body>
	<table id="report-table-sendnumDetailPage"></table>
	<script type="text/javascript">
		$(function(){
			$("#report-table-sendnumDetailPage").datagrid({
				columns:[[	
					...
					{field:'sendnum', title:'数量',width:60,align:'right',
						formatter:function(value,row,index){
							return formatterBigNumNoLen(value);
    					}
					},
					{field:'sendnumdetail', title:'辅数量',width:60,align:'left'},
		 		...
		 		idField:'id',
		 		singleSelect:true,
				url: 'report/storage/showSendnumDetailPageList.do?goodsid=${goodsid}&storageid=${storageid}&businessdate1=${businessdate1}&businessdate2=${businessdate2}',
			});
		});
	</script>
  </body>
