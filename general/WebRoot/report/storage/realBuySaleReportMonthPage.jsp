...
<html>
  ...
  <body>
    	...
    	<div id="report-toolbar-buySaleReport" style="padding:0px;height:auto">
            <div class="buttonBG">
                <security:authorize url="/report/storage/realBuySaleReportMonthExport.do">
            ...
            <form action="" id="report-query-form-buySaleReport" method="post">
                <table class="querytable">
                    <tr>
                        <td>业务日期:</td>
                        <td><input type="text" id="report-query-businessdate1" name="businessdate1" value="${today }" style="width:80px;" class="Wdate" onclick="WdatePicker({'dateFmt':'yyyy-MM',maxDate:'${today }'})" />
                            到 <input id="report-query-businessdate2" type="text" name="businessdate2" value="${today }" style="width:80px;" class="Wdate" onclick="WdatePicker({'dateFmt':'yyyy-MM',maxDate:'${today }'})" />
                        </td>
                        <td>品牌:</td>
    		...
    		$(function(){
				...
				$("#report-queay-buySaleReport").click(function(){
					setColumn();
		      		...
		      		$("#report-datagrid-buySaleReport").datagrid({
		      			url: 'report/storage/showRealBuySaleReportMonthData.do',
		      			pageNumber:1,
				...
				$("#report-buttons-buySaleReportPage").Excel('export',{
					queryForm: "#report-query-form-buySaleReport", //查询条件的form表单，导出时只用通过查询的条件，将通用查询放在form表单里面。
			 		...
			 		name:'实际每月进销存汇总统计报表',
			 		url:'report/storage/exportBuySaleReportMonthData.do?type=real'
				});
    		});
