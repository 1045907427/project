...
<div id="ledger-layout-detail" class="easyui-layout" data-options="fit:true,border:false">
    <form id="ledger-form-AccountSetAddPage" method="post" action="thirdDb/editThirdDbParam.do">
        <div id="ledger-layout-detail-north" data-options="region:'north',border:false"style="height:270px">
            ...
            <table cellpadding="5px" cellspacing="5px" style="padding-top: 5px;padding-left: 5px;">
                <tr>
                    <td>接入系统版本</td>
                    <td>
                        <select name="erpDb.relatesystem" id="ledger-relatesystem-thirdDbParamEditPage" style="width: 150px" <c:if test="${relatechange == '1'}">disabled</c:if> >
                    ...
                    <td>帐套名称</td>
                    <td>
                        <input type="text"  name="erpDb.dbasename" class="easyui-validatebox" validType="validName" value="${erpDb.dbasename}"/>
                    </td>
                    <td>数据库版本</td>
                    <td>
                        <input type="text"  name="erpDb.dbversion"  value="${erpDb.dbversion}" />
                    </td>
                </tr>
                <tr>
                    <td>生成凭证方式</td>
                    <td>
                        <select name="erpDb.addvouchtype" style="width: 150px">
                ...
                <tr>
                    <td>接口方式</td>
                    <td>
                        <select name="erpDb.interfacetype" style="width: 150px" id="ledger-interfacetype-thirdDbParamEditPage">
                ...
                <tr id="ledger-dbsource">
                    <td>数据库ip</td>
                    <td>
                        <input type="text"  name="erpDb.dbIP" class="easyui-validatebox" value="${erpDb.dbIP}" id="ledger-dbIP-thirdDbParamEditPage"/>
                    </td>
                    <td>用户名</td>
                    <td>
                        <input type="text"  name="erpDb.dbusername" class="easyui-validatebox" value="${erpDb.dbusername}" id="ledger-dbusername-thirdDbParamEditPage"/>
                    </td>
                    <td>密码</td>
                    <td>
                        <input type="password"  name="erpDb.dbpassword" class="easyui-validatebox" value="${erpDb.dbpassword}" id="ledger-dbpassword-thirdDbParamEditPage"/>
                    </td>
                </tr>
                <tr id="ledger-openapi-tr1">
                    <td>用友调用方</td>
                    <td><input type="text" name="erpDb.from_account" value="${erpDb.from_account}" id="ledger-from_account-thirdDbParamEditPage" class="easyui-validatebox"  /></td>
                    <td>用友提供方</td>
                    <td><input type="text" name="erpDb.to_account" value="${erpDb.to_account}" id="ledger-to_account-thirdDbParamEditPage" class="easyui-validatebox"/></td>
                    <td>用友应用key</td>
                    <td><input type="text" name="erpDb.app_key" value="${erpDb.app_key}" id="ledger-app_key-thirdDbParamEditPage" class="easyui-validatebox"/></td>
                </tr>
                <tr id="ledger-openapi-tr2">
                    <td class="dbconnect">数据库名</td>
                    <td class="dbconnect">
                        <input type="text"  name="erpDb.dbname" class="easyui-validatebox" value="${erpDb.dbname}" id="ledger-dbname-thirdDbParamEditPage"/>
                    </td>
                    <td class="openapiconnect">用友应用密码</td>
                    <td class="openapiconnect"><input type="text" name="erpDb.app_secret" value="${erpDb.app_secret}" id="ledger-app_secret-thirdDbParamEditPage" class="easyui-validatebox"/></td>
                    <td class="openapiconnect">数据源序号</td>
                    <td class="openapiconnect"><input type="text"  name="erpDb.dbsourceseq"  value="${erpDb.dbsourceseq}" id="ledger-dbsourceseq-thirdDbParamEditPage" /></td>
                    <td>启用档案对应科目</td>
                    <td>
                        <select id="ledger-useRelation-thirdDbParamEditPage" onchange="changeRelation()" name="erpDb.useRelation" style="width: 150px;">
                ...
                <tr>
                    <td>是否取总店</td>
                    <td>
                       <select id="ledger-isusepid-thirdDbParamEditPage" style="width: 150px;" name="isusepid" >
                    ...
                    <td>生成凭证格式</td>
                    <td>
                        <select id="ledger-ledgerformat-thirdDbParamEditPage" style="width: 150px;" name="ledgerformat" >
            ...
            <ul class="tags">
                ...
                <security:authorize url="/basefiles/showSubjectGoodsTab.do">
            ...
            <div class="tagsDiv">
                ...
                <div class="tagsDiv_item">
                    <table>
                       <tr>
                           ...
                           <td>
                               <select id="erpparam-versionParam" onchange="changeVersion()" name="versionParam" style="width: 200px;">
                ...
                <div class="tagsDiv_item">
                    <div  style="float: left;width: 220px;height:500px;;">
                        <div id="thirdDb-table-subjectList" style="height:100%;margin:0;padding:0;"></div>
                        <div id="thirdDb-button-subjectList" class="buttonBG">
                            <security:authorize url="/thirdDb/firstSubjectAddBtn.do">
                            ...
                            <security:authorize url="/thirdDb/firstSubjectDelBtn.do">
                    ...
                    <div style="float: left;width: 70%;height: 500px;">
                        ...
                        <div id="thirdDb-button-goodsList" style="height:56px;">
                            <security:authorize url="/thirdDb/subjectGoodsAddBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-add-goodsList" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-add'" title="新增商品">新增商品</a>
                            </security:authorize>
                            <security:authorize url="/thirdDb/subjectGoodsAddBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-addbrand-goodsList" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-add'" title="新增品牌">新增品牌</a>
                            </security:authorize>
                            <security:authorize url="/thirdDb/subjectGoodsDelBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-delete-goodsList" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-delete'" title="删除">删除</a>
                            </security:authorize>
                            <security:authorize url="/thirdDb/subjectGoodsExportBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-export-goodsList" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-export'" title="导出">导出</a>
                            </security:authorize>
                            <security:authorize url="/thirdDb/subjectGoodsImportBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-import-goodsList" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-import'" title="导入">导入</a>
                            </security:authorize>
                ...
                <div class="tagsDiv_item">
                    <div  style="float: left;width: 220px;height:500px;;">
                        ...
                        <div id="thirdDb-button-taxSubjectList" class="buttonBG">
                            <security:authorize url="/thirdDb/firstSubjectAddBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-add-addTaxSubject" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-add'" title="新增">新增</a>
                            </security:authorize>
                            <security:authorize url="/thirdDb/firstSubjectDelBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-delete-taxSubjectList" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-delete'" title="删除">删除</a>
                            </security:authorize>
                        </div>
                    ...
                    <div style="float: left;width: 70%;height: 500px;">
                        ...
                        <div id="thirdDb-button-taxList" style="height:26px;" class="buttonBG">
                            <security:authorize url="/thirdDb/subjectGoodsAddBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-add-taxList" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-add'" title="新增税种">新增税种</a>
                            </security:authorize>
                            <security:authorize url="/thirdDb/subjectGoodsDelBtn.do">
                                <a href="javaScript:void(0);" id="thirdDb-delete-taxList" class="easyui-linkbutton" data-options="plain:true,iconCls:'button-delete'" title="删除">删除</a>
                            </security:authorize>
...
<div id="thidDbPage-addBrand-Dialog"></div>
<div id="thidDbPage-editSubjectGoods-Dialog"></div>
<div id="erp-dialog-chooseAccount"></div>
<div id="erp-dialog-supplierClass"></div>
<div id="erp-dialog-customerClass"></div>
<div id="thidDbPage-addTax-Dialog"></div>
<div id="thidDbPage-editSubjectTax-Dialog"></div>
...
//                param:[{field:'bproperty',op:'like',value:'0'}],
            ...
            $('#thirdDb-table-goodsList').datagrid({
                ...
                onDblClickRow: function(rowIndex, rowData){
                    ...
                    $("#thidDbPage-editSubjectGoods-Dialog").dialog({
                        title:'编辑商品科目关系',
                        maximizable:false,
                        width:450,
                        height:200,
                        ...
                        cache:false,
                        resizable:true,
                        href: 'thirdDb/showSubjectGoodsEditPage.do?id='+rowData.id,
                        queryParams:{
                    ...
                    $("#thidDbPage-editSubjectGoods-Dialog").dialog('open');
                }
            });
    ...
    function showBaseTable(basetype){
        ...
        $('#thirdDbParam-bank-table').datagrid({
            columns:[[
                ...
                {field:'subjectname',title:'会计科目名称',width:120,sortable:true},
                {field:'codetype',title:'编码类型',width:100,hidden:true}
            ]],
            fit:true,
            method:'post',
            rownumbers:true,
//                idField:'id',
            ...
            onDblClickRow:function(rowIndex, rowData){
                showDataRelationDialog(rowData.id,basetype,rowData.baseid,rowData.basename,rowData.codetype,'${erpDb.id}');
            }
        });

    }

    function showDataRelationDialog(id,basetype,baseid,basename,codetype,dbid){
    ...
    //数据源参数选择页面
    $("#ledger-dbsource-thirdDbParamEditPag").click(function () {
        $("#ledger-dbsourceset-dialog").dialog({
            title:'数据源参数选择',
            maximizable:false,
            width:450,
            height:200,
            ...
            cache:false,
            resizable:true,
            href:'thirdDb/showDbsourceSeq.do',
        })
    });
    ...
    function editAccountSet() {
        ...
        var relateversion = $("#ledger-relatesystem-thirdDbParamEditPage").val();
        var interfacetype = "0";
        if("T3" != relateversion && "T6" != relateversion){
            interfacetype = $("#ledger-interfacetype-thirdDbParamEditPage").val();
        }
        if("0" == interfacetype){
            ...
            if(dbIP != "" && dbusername != "" && dbpassword != ""){
                $("#ledger-form-AccountSetAddPage").submit();
            }else{
                $.messager.alert('提醒', '请填写数据库ip,用户名及密码');
            }
        }else{
            ...
            if(from_account != "" && to_account != "" && app_key != "" && app_secret != "" && dbsourceseq != "" ){
                 $("#ledger-form-AccountSetAddPage").submit();
            }else{
                 $.messager.alert('提醒', '请根据用友开发平台信息填写用友调用方，提供方，app_key，app_secret和数据源序号');
            }
        }
    ...
    $(function () {
        ...
        $("#thirdDb-addbrand-goodsList").click(function(){
            var row = $("#thirdDb-table-subjectList").datagrid('getSelected');
            if(row==null){
                $.messager.alert('提醒', '请选择一级科目！');
                return false;
            }
            $("#thidDbPage-addBrand-Dialog").dialog({
                title:'新增品牌',
                maximizable:false,
                width:650,
                height:500,
                ...
                cache:false,
                resizable:true,
                href: 'thirdDb/showThirdBrandSubjectAddPage.do',
                queryParams:{
                    dbid:'${erpDb.id}',subjectid:row.subjectid,pid:row.subjectid
                },
                buttons:[
                    {
                        text:'保存',
                        handler:function(){
                            var checkedRows = $("#ledger-datagrid-thirdBrandSubjectAddPage").datagrid('getChecked');
                            if(checkedRows.length==0){
                                $.messager.alert('提醒', '请选择品牌！');
                                return false;
                            }
                            var subjectid=$("#thirdBrandSubjectAddPage-widget-subjectid").widget('getValue');
                            if(subjectid==''){
                                $.messager.alert('提醒', '请选择科目！');
                                return false;
                            }
                            ...
                            loading('添加中');
                            $.ajax({
                                url:'thirdDb/addThirdBrandSubject.do',
                                data:{ids:ids,dbid:'${erpDb.id}',subjectid:subjectid,pid:row.subjectid},
                                cache: false,
                                type:'post',
                                async: true,
                                success:function(res){
                                    ...
                                    if(resjson.flag){
                                        $.messager.alert('提醒', '保存成功!');
                                        $("#thirdDb-table-goodsList").datagrid('reload');
                                        $("#thidDbPage-addBrand-Dialog").dialog('close');
                                    }else{
                                        $.messager.alert('提醒', '保存失败!');
                                        return false;
                                    }
            ...
            $("#thidDbPage-addBrand-Dialog").dialog('open');
        })
...
//            queryForm: "#report-query-form-customerSalesFlowDetail", //查询条件的form表单，导出时只用通过查询的条件，将通用查询放在form表单里面。
        ...
        var importparam="<a href=\"basefiles/exceltemplet/baseSubjectGoods.xls\">"+"点击下载导入模板样式</a><br/><br/>";

        $("#thirdDb-import-goodsList").Excel('import',{
            type:'importUserdefined',
            url:'thirdDb/importBaseSubjectGoods.do?dbid=${erpDb.id}',
//            importparam:'客户编码、品牌编码、结算方式必输',
        ...
        //切换系统版本
        $("#ledger-relatesystem-thirdDbParamEditPage").click(function(){
            var val = $(this).val();
            if("T3" == val || "T6" == val ){
                $("#ledger-interfacetype-thirdDbParamEditPage").val("0");
                $("#ledger-dbsource").show();
                $("#ledger-openapi-tr1").hide();
                $(".dbconnect").show();
                $(".openapiconnect").hide();
                $("#ledger-interfacetype-thirdDbParamEditPage").attr("disabled",true);
            }else{
                $("#ledger-interfacetype-thirdDbParamEditPage").attr("disabled",false);
            }

        });

        //切换对接方式
        $("#ledger-interfacetype-thirdDbParamEditPage").click(function(){
            var val = $(this).val();
            if("0" == val){
                $("#ledger-dbsource").show();
                $("#ledger-openapi-tr1").hide();
        ...
        $("#erpconnect-button-syncSupplier").click(function(){
            ...
            var supplierCode = $("#erpparam-supplierCode").val();
            var relstr = "编码";
            if(supplierCode=="id"){
                relstr = "编码";
            }else if(supplierCode=="spell"){
                relstr = "助记符";
            }
            var interfacetype = $("#ledger-interfacetype-thirdDbParamEditPage").val();
            if("0" == interfacetype){
                $.messager.confirm("提醒","是否以"+relstr+"关联，根据数据库连接同步供应商档案到ERP中？",function(r){
                    if(r){
                        loading("同步中..");
                        $.ajax({
                            url: 'erpconnect/syncSupplierToERPByDb.do',
                            type: 'post',
                            dataType: 'json',
                            data:{supplierCode:supplierCode,dbid:row.id},
                            success: function (json) {
                                loaded();
                                if (json.flag) {
                ...
                $.messager.confirm("提醒","是否以"+relstr+"关联，通过接口同步供应商档案到ERP中？？",function(r){
                    if(r){

                        $('<div id="erp-dialog-supplierClass-content"></div>').appendTo('#erp-dialog-supplierClass');
                        $("#erp-dialog-supplierClass-content").dialog({
                            title: '选择供应商分类',
                            width: 350,
                            height: 160,
                            closed: false,
                            ...
                            maximizable: true,
                            resizable: true,
                            href: 'erpconnect/showChooseSupplierClassPage.do',
                            queryParams:{
                                relstr:supplierCode,dbid:row.id
                            },
                            onClose:function () {
                                $("#erp-dialog-supplierClass-content").dialog("destroy");
                            },
                            buttons:[
                                {
                                    text:'保存',
                                    handler:function(){
                                        $("#chooseSupplierClass-form-add").submit();
                                    }
                                }
                            ]
                        });
        ...
        $("#erpconnect-button-syncCustomer").click(function(){
            var row = $('#ledger-VoucherSet-ledgerCommonSetPage').datagrid('getSelected');
            var interfacetype = $("#ledger-interfacetype-thirdDbParamEditPage").val();
            var customerCode = $("#erpparam-customerCode").val();
            var relstr = "编码";
            if(customerCode=="id"){
                relstr = "编码";
            }else if(customerCode=="spell"){
                relstr = "助记符";
            }
            if("0" == interfacetype){
                $.messager.confirm("提醒","是否以"+relstr+"关联，根据数据库连接同步客户档案到ERP中？",function(r){
                    if(r){
                        loading("同步中..");
                        $.ajax({
                            url: 'erpconnect/syncCustomerToERPByDb.do',
                            type: 'post',
                            dataType: 'json',
                            data:{customerCode:customerCode,dbid:row.id},
                            success: function (json) {
                                loaded();
                                if (json.flag) {
                                    $.messager.alert("提醒", "同步成功。");
                ...
                $.messager.confirm("提醒","是否以"+relstr+"关联，通过接口同步客户档案到ERP中？？",function(r){
                    if(r){
                        $('<div id="erp-dialog-customerClass-content"></div>').appendTo('#erp-dialog-customerClass');
                        $("#erp-dialog-customerClass-content").dialog({
                            title: '选择客户分类',
                            width: 350,
                            height: 160,
                            closed: false,
                            ...
                            maximizable: true,
                            resizable: true,
                            href: 'erpconnect/showChooseCustomerClassPage.do',
                            queryParams:{
                                relstr:customerCode,dbid:row.id
                            },
                            onClose:function () {
                            ...
                            buttons:[
                                {
                                    text:'保存',
                                    handler:function(){
                                        $("#chooseCustomerClass-form-add").submit();
                                    }
                                }
                            ]
                        });
...
//                }
    ...
    $("#thirdDb-add-addTaxSubject").click(function(){
        openFirstSubjectDialog(1);
    })

    function openFirstSubjectDialog(basetype){
        $("#thidDbPage-addSubject-Dialog").dialog({
            ...
            queryParams:{
                dbid:'${erpDb.id}',basetype:basetype
            },
            buttons:[
                {
                    text:'保存',
                    handler:function(){
                        ...
                        $.ajax({
                            ...
                            data:{ids:ids,dbid:'${erpDb.id}',basetype:basetype},
                            cache: false,
                            type:'post',
                            async: true,
                            success:function(res){
                                ...
                                if(resjson.flag){
                                    ...
                                    if(basetype=='0'){
                                        ...
                                        $("#thirdDb-table-taxSubjectList").datagrid('reload');
                                    }
    ...
    $("#thirdDb-delete-taxSubjectList").click(function(){
        deleteFirstSubject(1);
    })
    function deleteFirstSubject(basetype){
        var row=null;
        if(basetype=='0'){
            row = $("#thirdDb-table-subjectList").datagrid('getSelected');
        }else if(basetype=='1'){
            row = $("#thirdDb-table-taxSubjectList").datagrid('getSelected');
        }
        if(row==null){
            $.messager.alert('提醒', '请选择一级科目！');
            return false;
        ...
        $.ajax({
            ...
            data:{id:row.subjectid,dbid:'${erpDb.id}',basetype:basetype},
            cache: false,
            type:'post',
            async: true,
            success:function(res){
    ...
    $("#thirdDb-add-taxList").click(function(){
        var row = $("#thirdDb-table-taxSubjectList").datagrid('getSelected');
        if(row==null){
            $.messager.alert('提醒', '请选择一级科目！');
            return false;
        }
        $("#thidDbPage-addTax-Dialog").dialog({
            title:'新增税种科目',
            maximizable:false,
            width:650,
            height:500,
            ...
            cache:false,
            resizable:true,
            href: 'thirdDb/showThirdTaxSubjectAddPage.do',
            queryParams:{
                dbid:'${erpDb.id}',subjectid:row.subjectid,pid:row.subjectid
            },
            buttons:[
                {
                    ...
                    handler:function(){
                        ...
                        loading('添加中');
                        $.ajax({
                            url:'thirdDb/addThirdTaxSubject.do',
                            data:{ids:ids,dbid:'${erpDb.id}',subjectid:subjectid,pid:row.subjectid},
                            cache: false,
                            type:'post',
                            async: true,
                            success:function(res){
                                ...
                                if(resjson.flag){
                                    ...
                                    $("#thidDbPage-addTax-Dialog").dialog('close');
                                }else{
                                    $.messager.alert('提醒', '保存失败!');
                                    return false;
                                }
        ...
        $("#thidDbPage-addTax-Dialog").dialog('open');
    })

    $("#thirdDb-delete-taxList").click(function(){
        var row = $("#thirdDb-table-taxSubjectList").datagrid('getSelected');
        if(row==null){
            $.messager.alert('提醒', '请选择一级科目！');
            return false;
        }
        var checkedRows = $("#thirdDb-table-taxList").datagrid('getChecked');
        if(checkedRows.length==0){
            $.messager.alert('提醒', '请选择税种！');
            return false;
        }
        var ids='';
        for(var i=0;i<checkedRows.length;i++){
        ...
        loading('删除中');
        $.ajax({
            url:'thirdDb/deleteThirdTaxSubject.do',
            data:{ids:ids},
            cache: false,
            type:'post',
            async: true,
