	...
	<script type="text/javascript">
		$(function(){
			$("#activiti-datagrid-myWorkPage").datagrid({
				columns:[[
					...
					{field:'status',title:'状态', width:60,
						formatter: function(value,row,index){
							if(value == '2') {
								return "<font color='red' title='该工作已被管理员挂起，无法操作！\r\n如需操作，请联系管理员。'>挂起</font>";
							}
						}
					}
				]],
				queryParams:{type:'12', definitionkey: '${param.definitionkey }'},
				fit:true,
				border:false,
				method:'post',
				rownumbers:true,
			...
			$("#activiti-resetQueay-myWorkPage").click(function(){
				...
				$("#activiti-datagrid-myWorkPage").datagrid('load', {type:'12'});
			});
		});
