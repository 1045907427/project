		...
		$(function(){
			$("#activiti-datagrid-myWorkPage").datagrid({
				columns:[[
					...
					{field:'receivetime', title:'接收时间', width:110,/* sortable:true, sortable: true,*/
						formatter: function(value, row, index) {
				...
				queryParams:{type:'7', definitionkey: '${param.definitionkey }'},
				fit:true,
				border:false,
				method:'post',
				rownumbers:true,
			...
			$("#activiti-resetQueay-myWorkPage").click(function(){
				...
				$("#activiti-datagrid-myWorkPage").datagrid('load', {type:'7'});
			});
