	...
	<div class="easyui-panel" title="" data-options="fit:true,border:false">
	 ...
	 <div class="easyui-layout" data-options="fit:true">
	  	<form action="storage/deliveryout/deliveryOutEditSave.do" id="storage-form-deliveryOutAddPage" method="post">
	  		...
	  		<input  type="hidden" id="storage-deliveryout-status"  value="${storageDeliveryOut.status }"/>
	  			...
	  			<table style="border-collapse:collapse;" border="0" cellpadding="4" cellspacing="4">
				   ...
				   <c:if test="${billtype==2 }">
					  ...
					  <tr>
						  ...
						  <td>
							  <input type="text" style="width:150px;" id="storage-DeliveryOutAddPage-customerbill" name="storageDeliveryOut.customerbill"  value="${storageDeliveryOut.customerbill }" readonly="readonly"/>
						  </td>
					  </tr>
					   <tr>
						   <td style="width:60px;">备注：</td>
						   <td colspan="5">
							   <input type="text" style="width:670px;" id="storage-DeliveryOutAddPage-remark" name="storageDeliveryOut.remark"  value="${storageDeliveryOut.remark }" readonly="readonly"/>
						   </td>
					   </tr>
				   </c:if>
...
<script type="text/javascript">
    ...
    $(function(){
		...
		$("#storage-DeliveryOutEditPage-billtype option").eq(parseInt("${storageDeliveryOut.billtype}")-1).attr("selected","selected");
		$("#storage-DeliveryOutEditPage-sourcetype option").eq(parseInt("${storageDeliveryOut.sourcetype}")).attr("selected", "selected");
    	
    	$("#storage-buttons-deliveryOutPage").buttonWidget("enableButton", 'button-add');
    	$("#storage-buttons-deliveryOutPage").buttonWidget("disableButton", 'button-save');
    	$("#storage-buttons-deliveryOutPage").buttonWidget("disableButton", 'button-saveaudit');
    	...
    	if("${storageDeliveryOut.status}"=='4'){
