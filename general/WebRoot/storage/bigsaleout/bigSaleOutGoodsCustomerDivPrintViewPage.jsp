                ...
                <td colspan="6">
                  <table cellpadding="0" cellspacing="0" border="1" style="width: 1070px;">
                    <tr>
                      ...
                      <td style="width: 300px;" align="left"><label class="font15">货品名称</label></td>
                      ...
                      <td style="width: 240px;" align="left"><label class="font15">客户名称</label></td>
                      <td style="width: 80px;" align="right"><label class="font15">箱装量</label></td>
                      <td style="width: 120px;" align="right"><label class="font15">描述</label></td>
                    </tr>
                    <c:forEach var="list" items="${item.value}" varStatus="liststatus">
                      <tr>
                        ...
                        <td style="width: 200px;" align="left"><label class="font15">${list.goodsInfo.name}</label></td>
                        ...
                        <td style="width: 80px;" align="right"><label class="font15"><c:if test="${list.goodsInfo.boxnum!=null && list.goodsInfo.boxnum >0}"><fmt:formatNumber value="${list.goodsInfo.boxnum}" pattern="${pattern}"/></c:if></label></td>
