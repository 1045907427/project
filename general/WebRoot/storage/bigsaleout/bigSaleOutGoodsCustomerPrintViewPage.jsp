          ...
          <div>
            <table cellpadding="0" cellspacing="0" border="1" style="width: 1070px;">
              <tr>
                ...
                <td class="style1" style="width: 80px;" align="left"><label class="style">箱装量</label></td>
                <td class="style1" style="width: 150px;" align="right"><label class="style">描述</label></td>
              </tr>
            </table>
            <table cellpadding="0" cellspacing="0" border="1" style="width: 1070px;border-top-style: none">
              <c:if test="${null != list.goodsid and '' != list.goodsid}">
                <tr>
                  ...
                  <td class="style1" style="width: 80px;" align="right"><label class="font15"><c:if test="${list.goodsInfo.boxnum!=null && list.goodsInfo.boxnum >0}"><fmt:formatNumber value="${list.goodsInfo.boxnum}" pattern="${pattern}"/>*1</c:if></label></td>
                  <td class="style1" style="width: 150px;" align="right">
                    <label class="font15">
                        ${list.auxnumdetail}
                    </label>
                  </td>
