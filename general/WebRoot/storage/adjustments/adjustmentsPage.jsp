...
<script type="text/javascript">
    ...
    var tableColJson = $("#storage-datagrid-checkListAddPage").createGridColumnLoad({
        ...
        commonCol: [[
            ...
            {field: 'deadline', title: '截止日期', width: 80, hidden: true},
            {field: 'remark', title: '备注', width: 100}
        ]]
    });
    var page_url = "storage/adjustmentsAddPage.do";
    var page_type = '${type}';
    ...
    var pageListUrl = "/storage/showAdjustmentsListPage.do";
    $(function () {
        ...
        $("#storage-buttons-adjustmentsPage").buttonWidget({
            initButton: [
                ...
                <security:authorize url="/storage/adjustmentsAddPage.do">
                {
                    ...
                    handler: function () {
                        $("#storage-panel-adjustmentsPage").panel({
                            href: 'storage/adjustmentsAddPage.do',
                            title: '',
                            cache: false,
                            maximized: true,
                            border: false
            ...
            type: 'view',
            tab: '调账单列表',
            taburl: '/storage/showAdjustmentsListPage.do',
            id: '${id}',
    ...
    $(function () {
        ...
        AgReportPrint.init({
            ...
            printAfterHandler: function (option, printParam) {
                tabsWindowURL(pageListUrl).$("#storage-datagrid-adjustmentsPage").datagrid('reload');
            }
        });
    });
</script>
