	   	...
	   	<form action="" method="post" id="storage-form-storageOtherEnterDetailAddPage">
	   		<table  border="0" class="box_table">
	   			...
	   			<tr>
	   				<td>数量:</td>
	   				<td style="text-align: left;">
	   					<input type="text" id="storage-storageOtherEnter-unitnum" name="unitnum" class="easyui-validatebox" data-options="required:true,validType:'intOrFloatNum[${decimallen}]'"/>
	   				</td>
	   				<td>辅数量:</td>
	   				<td style="text-align: left;">
	   					<input type="text" id="storage-storageOtherEnter-unitnum-aux" name="auxnum" style="width:70px;" class="easyui-validatebox" data-options="required:true,validType:'integer'"/>
	   					<span id="storage-storageOtherEnter-auxunitname1" style="float: left;"></span>
	   					<input type="text" id="storage-storageOtherEnter-unitnum-unit" name="auxremainder" style="width:70px;" class="easyui-validatebox" data-options="required:true,validType:'intOrFloatNum[${decimallen}]'"/>
				...
				<tr class="hiddenclass">
	   				<td>含税单价:</td>
	   				<td style="text-align: left;">
	   					<input type="text" id="storage-storageOtherEnter-taxprice" name="taxprice" class="easyui-validatebox" data-options="required:true,validType:'intOrFloat'">
	   				</td>
	   				<td>含税金额:</td>
	   				<td style="text-align: left;">
