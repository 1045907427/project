	   	...
	   	<form action="" method="post" id="storage-form-storageOtherOutDetailAddPage">
	   		<table  border="0" class="box_table">
	   			...
	   			<tr>
	   				<td>数量:</td>
	   				<td style="text-align: left;">
	   					<input type="text" id="storage-storageOtherOut-unitnum" name="unitnum" class="easyui-validatebox" data-options="required:true,validType:['intOrFloatNum[${decimallen}]','max']"/>
	   				</td>
	   				<td width="120">辅数量:</td>
	   				<td style="text-align: left;">
	   					<input type="text" id="storage-storageOtherOut-unitnum-aux" name="auxnum" style="width:70px;" class="easyui-validatebox" data-options="required:true,validType:'integer'"/>
	   					<span id="storage-storageOtherOut-auxunitname1" style="float: left;"></span>
	   					<input type="text" id="storage-storageOtherOut-unitnum-unit" name="auxremainder" style="width:70px;" class="easyui-validatebox" data-options="required:true,validType:'intOrFloatNum[${decimallen}]'"/>
                ...
                <%--<security:authorize url="/storage/storageOtherOutShowAmount.do">--%>
	   			<tr class="hiddenclass">
	   				<td>含税单价:</td>
	   				<td style="text-align: left;">
	   					<input type="text" id="storage-storageOtherOut-taxprice" name="taxprice" class="easyui-validatebox" data-options="required:true,validType:'intOrFloat'">
	   				</td>
	   				<td>含税金额:</td>
	   				<td style="text-align: left;">
