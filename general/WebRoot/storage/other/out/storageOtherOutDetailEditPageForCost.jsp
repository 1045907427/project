        ...
        <form action="" method="post" id="storage-form-storageOtherOutDetailAddPage">
            <table  border="0" class="box_table">
                ...
                <tr>
                    <td>数量:</td>
                    <td style="text-align: left;">
                        <input type="text" id="storage-storageOtherOut-unitnum" readonly="readonly" name="unitnum" class="formaterNum easyui-validatebox" data-options="required:true,validType:['intOrFloatNum[${decimallen}]','max']"/>
                    </td>
                    <td width="120">辅数量:</td>
                    <td style="text-align: left;">
                        <input type="text" id="storage-storageOtherOut-unitnum-aux" name="auxnum" readonly="readonly" style="width:70px;" class="formaterNum easyui-validatebox" data-options="required:true,validType:'integer'"/>
                        <span id="storage-storageOtherOut-auxunitname1" style="float: left;"></span>
                        <input type="text" id="storage-storageOtherOut-unitnum-unit" name="auxremainder" readonly="readonly" style="width:70px;" class="formaterNum easyui-validatebox" data-options="required:true,validType:'intOrFloatNum[${decimallen}]'"/>
                ...
                <tr>
                    <td>含税单价:</td>
                    <td style="text-align: left;">
                        <input type="text" id="storage-storageOtherOut-taxprice" readonly="readonly" name="taxprice">
                    </td>
                    <td>含税金额:</td>
                    <td style="text-align: left;">
                ...
                <tr>
                    ...
                    <td>税额:</td>
                    <td style="text-align: left;">
                        <input type="text" id="storage-storageOtherOut-tax" name="tax" class="no_input" class="easyui-validatebox"   data-options="required:true,validType:'intOrFloat',validType:'intOrFloatNum[6]'" readonly="readonly"/>
                    </td>
                </tr>
                <tr>
                    <td>所属库位:</td>
