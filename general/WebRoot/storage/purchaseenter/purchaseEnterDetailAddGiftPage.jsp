...
<html>
  ...
  <div class="easyui-layout" data-options="fit:true">
   ...
   <script type="text/javascript">
	   ...
	   if('1'==sourcetype){
           $("#storage-purchaseEnter-hidden-goodstype").val("1");
           $("#storage-purchaseEnter-goodstype").val("1");
           $("#storage-purchaseEnter-goodstype").attr("disabled", true);
