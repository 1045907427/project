			...
			$(function(){
				...
				storageSummaryLogJson = $("#storage-storageSummaryLog-table").createGridColumnLoad({
					...
					commonCol : [[   {field:'goodsInfo.name',title:'商品编码',width:60,aliascol:'goodsid',
							        ...
							        {field:'beginnum',title:'期初数量',width:80,align:'right',
							        	formatter:function(value,rowData,rowIndex){
							        		if(value!=null){
							        ...
							        {field:'endnum',title:'期末数量',width:80,align:'right',
							        	formatter:function(value,rowData,rowIndex){
							        		if(value!=null){
												return formatterBigNumNoLen(value);
							        		}else{
							        ...
							        {field:'auxbeginstoragenumdetail',title:'辅单位期初数量',width:90,align:'right'},
							        ...
							        {field:'auxendstoragenumdetail',title:'辅单位期末数量',width:90,align:'right'},
				...
				$('#storage-storageSummaryLog-table').datagrid({ 
					...
					columns:storageSummaryLogJson.common,
		  	 		...
		  	 		url:'storage/showStorageSummaryLogListByStorage.do',
