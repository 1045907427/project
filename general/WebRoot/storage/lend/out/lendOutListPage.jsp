    ...
    <form action="" id="storage-form-query-lendPage" method="post">
        ...
        <table class="querytable">
            ...
            <tr>
                <td>借货仓库:</td>
                <td>
                    <input type="text" id="storage-storageid-lendPage" name="storageid"/>
            ...
            <tr>
                <td>相关部门:</td>
                <td>
                    <input id="storage-lend-deptid" name="deptid" style="width:225px;"/>
                </td>
                <td>打印状态:</td>
                <td>
    ...
    $(function () {
        ...
        $("#storage-buttons-lendPage").buttonWidget({
            initButton: [
                ...
                <security:authorize url="/storage/lendAddPage.do">
                {
                    type: 'button-add',
                    handler: function () {
                        top.addTab('storage/showLendAddPage.do?billtype=1', "借货单新增");
                    },
                ...
                <!--								return false;-->
                <!--							}	-->
                <!--							top.addTab('storage/showLendEditPage.do?id='+ con.id, "借货单修改");-->
                <!--						},-->
                ...
                <security:authorize url="/storage/showLendViewPage.do">
                {
                    ...
                    handler: function () {
                        ...
                        top.addOrUpdateTab('storage/showLendEditPage.do?billtype=1&id=' + con.id, "借货单查看");
                    },
                ...
                <security:authorize url="/storage/lendImport.do">
                {
                    ...
                    attr: {
                        ...
                        url: 'storage/lendImport.do?billtype=1',
                        importparam: '必填项：出货仓编码，借货人类型，借货人编号，商品编码，数量。<br/>选填项：单价，金额',
        ...
        var tableColumnListJson = $("#storage-datagrid-lendPage").createGridColumnLoad({
            ...
            commonCol: [[
                ...
                {
                    field: 'storageid', title: '借货仓库', width: 80, sortable: true,
                    formatter: function (value, rowData, rowIndex) {
                        return rowData.storagename;
                    }
                },
                {
                    field: 'lendtype', title: '借货类型', width: 80, sortable: true,
                    formatter: function (value, rowData, rowIndex) {
                ...
                {
                    field: 'lendid', title: '借货人', width: 100, sortable: true,
                    formatter: function (value, rowData, rowIndex) {
        ...
        $("#storage-datagrid-lendPage").datagrid({
            ...
            onDblClickRow: function (rowIndex, rowData) {
                top.addOrUpdateTab('storage/showLendEditPage.do?billtype=1&id=' + rowData.id, "借货单查看");
            }
        }).datagrid("columnMoving");

        //出库仓库
        $("#storage-storageid-lendPage").widget({
            width: 225,
...
//			});
        ...
        $("#storage-reload-lend").click(function () {
            $("#storage-storageid-lendPage").widget('clear');
            $("#storage-lend-deptid").widget('clear');
