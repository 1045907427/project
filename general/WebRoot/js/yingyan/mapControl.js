...
window.mapControl = {
    ...
    initMap: function() {
        ...
        canvasScript.src = 'js/yingyan/CanvasLayer.js';
        ...
        map.centerAndZoom(new BMap.Point(121.365591, 28.568531), 13);  // 初始化地图,设置中心点坐标和地图级别
    ...
    */
    ...
    initMapPointOverlay: function(){
        this._zIndex = 1;
        this.mapPointOverlay = function(point, text, mouseoverText){
            this._point = point;
            this._text = text;
            this._overText = mouseoverText;
        };
        this.mapPointOverlay.prototype = new BMap.Overlay();
        this.mapPointOverlay.prototype.initialize = function(map){
            this._map = map;
            var div = this._div = document.createElement("div");
        ...
        this.mapPointOverlay.prototype.draw = function(){
            var map = this._map;
            var pixel = map.pointToOverlayPixel(this._point);
    ...
    */
     ...
     */
    setMonitorInfoBox:function(data) {
        ...
        this.monitorInfoBox = new BMapLib.InfoBox(
            ...
            infoContentFrontArr.concat(infoContentNextArr).join(''),
            {
                ...
                alignBottom: false,
                closeIconUrl: 'images/closeinfowindow.png'
            }
        );
     ...
     */
    setEntityMarker:function(data, service_type) {
        var that = this;
        ...
        if (service_type === 1) {
            ...
            switch (status.substring(0, 2)) {
                case '离线':
                    iconUrl = 'images/caroffnorth.png';
                    break;
                case '静止':
                    iconUrl = 'images/carstaticnorth.png';
                    break;
                default:
                    iconUrl = 'images/carrunnorth.png';
                    break;
            }
        } else {
            ...
            switch (status.substring(0, 2)) {
                case '离线':
                    iconUrl = 'images/othertypeoffline.png';
                    break;
                case '静止':
                    iconUrl = 'images/othertypestatic.png';
                    break;
                default:
                    iconUrl = 'images/othertype.png';
                    break;
            }
        }
     ...
     */
    getEntityIcon:function(type, data) {
        var img = new Image();
        var iconUrl = '';
        var height = 0;
        var width = 0;
     ...
     */
    setBoundSearch:function(markerArr, MarkerOption) {
        var overlays = map.getOverlays();
