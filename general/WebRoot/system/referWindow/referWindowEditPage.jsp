...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <div class="easyui-layout" data-options="fit:true">
  	<div title="参照窗口修改" data-options="region:'center'" style="overflow: auto;">
	<div style="padding: 20px 20px 20px 20px;">
		...
		<table style="width: 98%">
			<tr>
				<td>编号</td>
				<td>
					<input type="text"  name="referWindow.id" value="${referWindow.id }" style="width:200px;" maxlength="50" readonly="readonly"/>
				</td>
				<td>名称:</td>
				<td>
				...
				<td>
					...
					<input type="hidden" name="referWindow.state" value="${referWindow.state}"/>
				</td>
			</tr>
			<tr>
				<td>操作SQL:</td>
...
//				$("#referWindow-hidden-tables").attr("value",tablesStr);
				...
				$.ajax({
					type: 'POST',
					url: 'system/referWindow/editReferWindow.do',
					data: base,
					dataType: 'json',
					success: function(json){
						loaded();
						if(json.flag){
							top.$.messager.alert("提醒",'修改成功');
