			...
			<form action="" method="post" id="sysNumber-form-billInfo">
                ...
                <div id="sysNumber-button-billDetail">
					<table cellpadding="2" cellspacing="2" border="0">
						<tr>
							<td width="80px">表名:</td>
							<td><input type="text" name="sysNumber.tablename" style="width: 180px;" id="system-tablename-sysNumber"/>
						...
						<tr>
							...
							<td>当前流水号:</td>
							<td><input type="text" id="system-serialNumber-sysNumber" name="sysNumber.serialnumber" style="width: 180px;" readonly="readonly" maxlength="11"/></td>
