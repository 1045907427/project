  ...
  <div class="easyui-layout" data-options="fit:true">
      <div data-options="region:'center',border:false">
          <form id="ebshop-form-ebtradeDetailAddPage">
              <table cellpadding="5" cellspacing="5">
                  ...
                  <tr>
                      <td>未税单价：</td>
                      <td><input class="len150 easyui-validatebox <c:if test="${colMap.notaxprice == null }">readonly</c:if>" name="notaxprice" id="ebshop-notaxprice-ebtradeDetailAddPage" required="required" validType="intOrFloat" <c:if test="${colMap.notaxprice == null }">readonly="readonly"</c:if>/> </td>
                      <td>未税金额：</td>
      ...
      <div data-options="region:'south',border:false">
          <div class="buttonDetailBG" style="height:30px;text-align:right;">
              ...
              <input type="button" value="确定" name="savegoon" id="ebshop-savegoon-ebtradeDetailAddPage" />
          </div>
      </div>
  </div>
    <script type="text/javascript">
    	$(function(){
    		...
    		$("input[name=auxremainder]").change(function(){
    			unitnumChange(2);
    		});
