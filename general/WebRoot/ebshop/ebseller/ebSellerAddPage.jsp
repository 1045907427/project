        ...
        <div data-options="region:'center',split:true,border:true" align="center">
            <form id="ebshop-form-ebSellerAddPage" action="ebseller/addEbSeller.do" method="post">
                <table cellpadding="3" cellspacing="3" border="0" >
                    ...
                    <tr>
                        <td>所属公司：</td>
                        <td><input type="text" name="ebSeller.company" class="len180 easyui-validatebox" validType="illegalChar"/></td>
                    </tr>
                    <tr>
                        <td>联系方式：</td>
                        <td><input type="text" name="ebSeller.phone" class="len180"/></td>
                    </tr>
                    <tr>
                        <td>备注：</td>
                    ...
                    <tr>
                        <td>状态：</td>
                        <td><select name="ebSeller.state" class="len180">
