...
<html>
<head>
    <title>电商商品新增页面</title>
</head>
<body>
    <div class="easyui-layout" data-options="fit:true,border:false">
        <form id="ebshop-form-ebgoodsAddPage" action="ebgoods/addEbGoods.do" method="post">
            <div data-options="region:'north',border:false" style="height:140px;">
                <table style="border-collapse:collapse;" border="0" cellpadding="3px" cellspacing="3px">
                    <tr>
                        <td class="len110 left">编号：</td>
                        <td class="len165"><input type="text" id="ebshop-id-ebgoodsAddPage" class="len150 easyui-validatebox" validType="validId[20]" name="ebGoods.id" data-options="required:true"/></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><input type="text" class="easyui-validatebox" style="width: 437px;" name="ebGoods.name" data-options="required:true"/></td>
                        <td class="len110 left">卖家昵称：</td>
                        <td><input type="text" id="ebshop-sellernick-ebgoodsAddPage" name="ebGoods.seller_nick"/></td>
                    </tr>
                    <tr>
                        <td class="len110 left">电商商品数字编号：</td>
                        <td><input type="text" class="len150" name="ebGoods.num_iid" /></td>
                        <td class="len110 left">sku编号：</td>
                        <td><input type="text" class="len150" name="ebGoods.sku_id" /></td>
                        <td class="len110 left">sku属性：</td>
                        <td><input type="text" class="len150" name="ebGoods.properties" /></td>
                    </tr>
                    <tr>
                        <td class="len110 left">金额：</td>
                        <td><input type="text" id="ebshop-amount-ebgoodsAddPage" class="len150 easyui-numberbox" data-options="min:0,precision:2" name="ebGoods.price" /></td>
                    ...
                    <tr>
                        ...
                        <td colspan="5"><input type="text" style="width: 724px;" name="ebGoods.remark" /></td>
                    </tr>
                </table>
            </div>
            ...
            <div data-options="region:'south'">
                <div class="buttonDetailBG" style="text-align:right;">
                    <input type="button" id="ebshop-savegoon-ebgoodsAddPage" value="继续添加"/>
                </div>
            </div>
        </form>
    </div>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#ebshop-savegoon-ebgoodsAddPage").click(function(){
                $.messager.confirm("提醒","确定添加该电商商品?",function(r) {
                    if(r){
            ...
            $("#ebshop-form-ebgoodsAddPage").form({
                ...
                success:function(data){
                    ...
                    if(json.flag){
                        ...
                        $("#ebshop-buttons-ebgoodsListPage").buttonWidget("addNewDataId", $("#ebshop-id-ebgoodsAddPage").val());
                        $('#ebshop-dialog-ebgoodsListPage1').dialog('refresh');
