...
<div class="easyui-layout" data-options="fit:true">
    <div data-options="region:'center',border:false">
        <form id="ebshop-form-ebgoodsDetailAddPage">
            <table cellpadding="3" cellspacing="3">
                ...
                <tr>
                    <td>数量：</td>
                    <td><input class="len150 easyui-validatebox" name="unitnum" id="ebshop-unitnum-ebgoodsDetailAddPage" required="required" validType="intOrFloat" /></td>
                    <td>是否主商品：</td>
                    <td>
    ...
    <div data-options="region:'south',border:false">
        <div class="buttonDetailBG" style="text-align:right;">
            ...
            <input type="button" id="ebshop-savegoon-ebgoodsDetailAddPage" value="继续添加"/>
        </div>
    </div>
</div>
