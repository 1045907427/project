...
<body>
	    	...
	    	<div data-options="region:'north',border:false" style="height: 100px;">
	    		<table style="border-collapse:collapse;" border="0" cellpadding="5px" cellspacing="5px">
	    			<tr>
	    				...
	    				<td class="len165"><input type="text" id="delivery-deliveryAogreturn-businessdate" style="width:160px;" onfocus="WdatePicker({'dateFmt':'yyyy-MM-dd'})"  name="deliveryAogreturn.businessdate" value="${deliveryAogreturn.businessdate }" /></td>
	    			...
	    			<tr>
	    				...
	    				<td>
	    					<input type="text" id="delivery-deliveryAogreturn-storageid" name="deliveryAogreturn.storageid" value="${deliveryAogreturn.storageid }" style="width:160px;"/>
	    				</td>
	    		    <tr>
	    				<td class="len80 left">备注：</td>
	    				<td colspan="5" style="text-align: left">
	    					<input type="text" id="delivery-deliveryAogreturn-remark" name="deliveryAogreturn.remark"  value="${deliveryAogreturn.remark }" style="width: 690px;" onfocus="frm_focus('deliveryAogreturn.remark');" onblur="frm_blur('deliveryAogreturn.remark');"/>
	    				</td>
	    			</tr>
	    			<tr>
	    		</table>
    ...
    <script type="text/javascript">
    	...
    	//控制按钮状态
    	$("#delivery-buttons-deliveryAogreturnPage").buttonWidget("setDataID",{id:'${deliveryAogreturn.id}',state:'${deliveryAogreturn.status}',type:'edit'});
