...
public class BuyOrderDetail implements Serializable {
     ...
     *
     */
    private static final long serialVersionUID = -2395489270463008498L;
     ...
     * 已入库主单位数量
     */
    private BigDecimal stockunitnum;

    /**
     * 已入库辅单位数量
     */
    private BigDecimal stockauxnum;

    /**
     * 未入库主单位数量
     */
    private BigDecimal unstockunitnum;

    /**
     * 未入库辅单位数量
     */
    private BigDecimal unstockauxnum;

    /**
     * 已入库数量的无税金额
     */
    private BigDecimal stocknotaxamount;

    /**
     * 已入库数量含税金额
     */
    private BigDecimal stocktaxamount;

    /**
     * 未入库数量无税金额
     */
    private BigDecimal unstocknotaxamount;

    /**
     * 未入库数量含税金额
     */
    private BigDecimal unstocktaxamount;
    /**
     * 实现入库量
     */
     ...
     * 实现未入库量
     */
    private BigDecimal realunstocknum;
     ...
     * @return 已入库主单位数量
     */
    public BigDecimal getStockunitnum() {
        return stockunitnum;
    }
     ...
     *            已入库主单位数量
     */
    public void setStockunitnum(BigDecimal stockunitnum) {
        this.stockunitnum = stockunitnum;
    }

    /**
     * @return 已入库辅单位数量
     */
    public BigDecimal getStockauxnum() {
        return stockauxnum;
    }
     ...
     *            已入库辅单位数量
     */
    public void setStockauxnum(BigDecimal stockauxnum) {
        this.stockauxnum = stockauxnum;
    }

    /**
     * @return 未入库主单位数量
     */
    public BigDecimal getUnstockunitnum() {
        return unstockunitnum;
    }

    /**
     * @param unstockunitnum
     *            未入库主单位数量
     */
    public void setUnstockunitnum(BigDecimal unstockunitnum) {
        this.unstockunitnum = unstockunitnum;
    }

    /**
     * @return 未入库辅单位数量
     */
    public BigDecimal getUnstockauxnum() {
        return unstockauxnum;
    }
     ...
     *            未入库辅单位数量
     */
    public void setUnstockauxnum(BigDecimal unstockauxnum) {
        this.unstockauxnum = unstockauxnum;
    }

    /**
     * @return 已入库数量的无税金额
     */
    public BigDecimal getStocknotaxamount() {
        return stocknotaxamount;
    }

    /**
     * @param stocknotaxamount
     *            已入库数量的无税金额
     */
    public void setStocknotaxamount(BigDecimal stocknotaxamount) {
        this.stocknotaxamount = stocknotaxamount;
    }

    /**
     * @return 已入库数量含税金额
     */
    public BigDecimal getStocktaxamount() {
        return stocktaxamount;
    }

    /**
     * @param stocktaxamount
     *            已入库数量含税金额
     */
    public void setStocktaxamount(BigDecimal stocktaxamount) {
        this.stocktaxamount = stocktaxamount;
    }

    /**
     * @return 未入库数量无税金额
     */
    public BigDecimal getUnstocknotaxamount() {
        return unstocknotaxamount;
    }

    /**
     * @param unstocknotaxamount
     *            未入库数量无税金额
     */
    public void setUnstocknotaxamount(BigDecimal unstocknotaxamount) {
        this.unstocknotaxamount = unstocknotaxamount;
    }

    /**
     * @return 未入库数量含税金额
     */
    public BigDecimal getUnstocktaxamount() {
        return unstocktaxamount;
    }

    /**
     * @param unstocktaxamount
     *            未入库数量含税金额
     */
    public void setUnstocktaxamount(BigDecimal unstocktaxamount) {
        this.unstocktaxamount = unstocktaxamount;
    }
    ...
    public void setRealstocknum(BigDecimal realstocknum) {
        this.realstocknum = realstocknum;
    }

    public BigDecimal getRealunstocknum() {
        return realunstocknum;
    }

    public void setRealunstocknum(BigDecimal realunstocknum) {
        this.realunstocknum = realunstocknum;
    }
