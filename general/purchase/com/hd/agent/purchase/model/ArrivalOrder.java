 ...
 * @author zhanghonghui
 */
public class ArrivalOrder implements Serializable {
     ...
     * 采购到货单明细列表
     */
    private List<ArrivalOrderDetail> arrivalOrderDetailList;
    /**
     * 采购订单编号
     */
	...
	public List<ArrivalOrderDetail> getArrivalOrderDetailList() {
		return arrivalOrderDetailList;
	}

	public void setArrivalOrderDetailList(List<ArrivalOrderDetail> arrivalOrderDetailList) {
		this.arrivalOrderDetailList = arrivalOrderDetailList;
	}
    ...
    public String getOldnotaxamount() {
        return oldnotaxamount;
    }

    public void setOldnotaxamount(String oldnotaxamount) {
